...
#define MMC_STATE_HIGHSPEED_400	(1<<11)		/*                       */
#ifdef CONFIG_MTK_EMMC_CACHE
#define MMC_STATE_DOING_flush	(1<<10)		/*                         */
#define MMC_STATE_NEED_flush	(1<<11)		/*                           */
#endif
	unsigned int		quirks; 	/*             */
...
#ifdef CONFIG_MTK_EMMC_CACHE
#define MMC_QUIRK_DISABLE_CACHE     (1<<12) /*                    */
#endif
#define MMC_QUIRK_KSI_V03_SKIP_TRIM (1<<13)	        /*                            */
#define MMC_QUIRK_TRIM_UNSTABLE (1<<28)	        /*           */
						/*           */
