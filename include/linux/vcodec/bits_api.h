...
typedef struct __VBITS_HANDLE_T
{
    ...
    VAL_UINT32_T    nReadingMode;                           //                                             
    VAL_ULONG_T     StartAddr;                              //                                     
    VAL_ULONG_T     nSize;                                  //       
    VAL_UINT32_T    nBitCnt;                                //             
    VAL_UINT32_T    nZeroCnt;                               //             
    VAL_UINT32_T    Cur32Bits;                              //                  
    VAL_UINT32_T    CurBitCnt;                              //                     
    VAL_UINT32_T    n03RemoveCount;                         //                  
    VAL_UINT32_T    n03CountBit;                            //               
    VAL_INT32_T     n03FirstIndex;                          //                 
    VAL_INT32_T     n03SecondIndex;                         //                  
    VAL_UINT32_T    n03RemoveIgnore;                        //                   
    VAL_BOOL_T      bFirstCheck;                            //              
    VAL_BOOL_T      bEverRemove;                            //              
    VAL_BOOL_T      bIgnoreByBS;                            //               
    VAL_BOOL_T      bEOF;                                   //      
