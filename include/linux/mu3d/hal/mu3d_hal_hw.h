...
#define VBUS_RISE_BIT (1<<11) //   
#define VBUS_FALL_BIT (1<<12) //   
...
//          
#define CSR0_SETUPEND					(0x00200000) //                         
#define CSR0_FLUSHFIFO					(0x01000000) //        
#define CSR0_SERVICESETUPEND			(0x08000000) //                         
#define EP0_W1C_BITS 					(~(EP0_RXPKTRDY | EP0_SETUPPKTRDY | EP0_SENTSTALL))
//           
#define USB_TXCSR_FLUSHFIFO				(0x00100000) //       
#define TX_W1C_BITS 				(~(TX_SENTSTALL))
/*           */
#define USB_RXCSR_FLUSHFIFO		    	(0x00100000)   //       
