...
//                     
#define SSUSB_AHB_SLV_AUTO_RSP                    (0x1<<17) //     
#define SSUSB_IP_SW_RST_CK_GATE_EN                (0x1<<16) //     
#define SSUSB_IP_U2_ENTER_SLEEP_CNT               (0xff<<8) //    
#define SSUSB_IP_SW_RST                           (0x1<<0) //   

//                     
#define SSUSB_IP_HOST_PDN                         (0x1<<0) //   

//                     
#define SSUSB_IP_DEV_PDN                          (0x1<<0) //   

//                     
#define SSUSB_IP_PCIE_PDN                         (0x1<<0) //   

//                    
#define SSUSB_IP_REF_CK_DIS_STS                   (0x1<<31) //     
#define SSUSB_IP_SLEEP_STS                        (0x1<<30) //     
#define SSUSB_U2_MAC_RST_B_STS_5P                 (0x1<<29) //     
#define SSUSB_U2_MAC_RST_B_STS_4P                 (0x1<<28) //     
#define SSUSB_U2_MAC_RST_B_STS_3P                 (0x1<<27) //     
#define SSUSB_U2_MAC_RST_B_STS_2P                 (0x1<<26) //     
#define SSUSB_U2_MAC_RST_B_STS_1P                 (0x1<<25) //     
#define SSUSB_U2_MAC_RST_B_STS                    (0x1<<24) //     
#define SSUSB_U3_MAC_RST_B_STS_3P                 (0x1<<19) //     
#define SSUSB_U3_MAC_RST_B_STS_2P                 (0x1<<18) //     
#define SSUSB_U3_MAC_RST_B_STS_1P                 (0x1<<17) //     
#define SSUSB_U3_MAC_RST_B_STS                    (0x1<<16) //     
#define SSUSB_DEV_DRAM_RST_B_STS                  (0x1<<13) //     
#define SSUSB_XHCI_DRAM_RST_B_STS                 (0x1<<12) //     
#define SSUSB_XHCI_RST_B_STS                      (0x1<<11) //     
#define SSUSB_SYS125_RST_B_STS                    (0x1<<10) //     
#define SSUSB_SYS60_RST_B_STS                     (0x1<<9) //   
#define SSUSB_REF_RST_B_STS                       (0x1<<8) //   
#define SSUSB_DEV_RST_B_STS                       (0x1<<3) //   
#define SSUSB_DEV_BMU_RST_B_STS                   (0x1<<2) //   
#define SSUSB_DEV_QMU_RST_B_STS                   (0x1<<1) //   
#define SSUSB_SYSPLL_STABLE                       (0x1<<0) //   

//                    
#define SSUSB_U2_MAC_SYS_RST_B_STS_5P             (0x1<<5) //   
#define SSUSB_U2_MAC_SYS_RST_B_STS_4P             (0x1<<4) //   
#define SSUSB_U2_MAC_SYS_RST_B_STS_3P             (0x1<<3) //   
#define SSUSB_U2_MAC_SYS_RST_B_STS_2P             (0x1<<2) //   
#define SSUSB_U2_MAC_SYS_RST_B_STS_1P             (0x1<<1) //   
#define SSUSB_U2_MAC_SYS_RST_B_STS                (0x1<<0) //   

//                 
#define SSUSB_XHCI_MAS_DMA_REQ                    (0x1<<14) //     
#define SSUSB_DEV_DMA_REQ                         (0x1<<13) //     
#define SSUSB_AVALID_STS                          (0x1<<12) //     
#define SSUSB_SRP_REQ_INTR                        (0x1<<11) //     
#define SSUSB_IDDIG                               (0x1<<10) //     
#define SSUSB_VBUS_VALID                          (0x1<<9) //   
#define SSUSB_HOST_DEV_MODE                       (0x1<<8) //   
#define SSUSB_DEV_USBRST_INTR                     (0x1<<7) //   
#define VBUS_CHG_INTR                             (0x1<<6) //   
#define SSUSB_CHG_B_ROLE_B                        (0x1<<5) //   
#define SSUSB_CHG_A_ROLE_B                        (0x1<<4) //   
#define SSUSB_ATTACH_B_ROLE                       (0x1<<3) //   
#define SSUSB_CHG_B_ROLE_A                        (0x1<<2) //   
#define SSUSB_CHG_A_ROLE_A                        (0x1<<1) //   
#define SSUSB_ATTACH_A_ROLE                       (0x1<<0) //   

//                     
#define SSUSB_SRP_REQ_INTR_CLR                    (0x1<<11) //     
#define SSUSB_DEV_USBRST_INTR_CLR                 (0x1<<7) //   
#define SSUSB_VBUS_INTR_CLR                       (0x1<<6) //   
#define SSUSB_CHG_B_ROLE_B_CLR                    (0x1<<5) //   
#define SSUSB_CHG_A_ROLE_B_CLR                    (0x1<<4) //   
#define SSUSB_ATTACH_B_ROLE_CLR                   (0x1<<3) //   
#define SSUSB_CHG_B_ROLE_A_CLR                    (0x1<<2) //   
#define SSUSB_CHG_A_ROLE_A_CLR                    (0x1<<1) //   
#define SSUSB_ATTACH_A_ROLE_CLR                   (0x1<<0) //   

//                    
#define SSUSB_IP_MAC_U2_PORT_NO                   (0xff<<8) //    
#define SSUSB_IP_MAC_U3_PORT_NO                   (0xff<<0) //   

//                     
#define SSUSB_IP_XHCI_U2_PORT_NO                  (0xff<<8) //    
#define SSUSB_IP_XHCI_U3_PORT_NO                  (0xff<<0) //   

//                    
#define SSUSB_IP_DEV_U2_PORT_NO                   (0xff<<8) //    
#define SSUSB_IP_DEV_U3_PORT_NO                   (0xff<<0) //   

//                    
#define SSUSB_DEV_USBRST_INT_EN                   (0x1<<8) //   
#define SSUSB_VBUS_CHG_INT_A_EN                   (0x1<<7) //   
#define SSUSB_VBUS_CHG_INT_B_EN                   (0x1<<6) //   
#define SSUSB_CHG_B_ROLE_B_INT_EN                 (0x1<<5) //   
#define SSUSB_CHG_A_ROLE_B_INT_EN                 (0x1<<4) //   
#define SSUSB_ATTACH_B_ROLE_INT_EN                (0x1<<3) //   
#define SSUSB_CHG_B_ROLE_A_INT_EN                 (0x1<<2) //   
#define SSUSB_CHG_A_ROLE_A_INT_EN                 (0x1<<1) //   
#define SSUSB_ATTACH_A_ROLE_INT_EN                (0x1<<0) //   

//                    
#define SSUSB_U3_PORT_PHYD_RST                    (0x1<<5) //   
#define SSUSB_U3_PORT_MAC_RST                     (0x1<<4) //   
#define SSUSB_U3_PORT_U2_CG_EN                    (0x1<<3) //   
#define SSUSB_U3_PORT_HOST_SEL                    (0x1<<2) //   
#define SSUSB_U3_PORT_PDN                         (0x1<<1) //   
#define SSUSB_U3_PORT_DIS                         (0x1<<0) //   

//                    
#define SSUSB_U3_PORT_PHYD_RST_1P                 (0x1<<5) //   
#define SSUSB_U3_PORT_MAC_RST_1P                  (0x1<<4) //   
#define SSUSB_U3_PORT_U2_CG_EN_1P                 (0x1<<3) //   
#define SSUSB_U3_PORT_HOST_SEL_1P                 (0x1<<2) //   
#define SSUSB_U3_PORT_PDN_1P                      (0x1<<1) //   
#define SSUSB_U3_PORT_DIS_1P                      (0x1<<0) //   

//                    
#define SSUSB_U3_PORT_PHYD_RST_2P                 (0x1<<5) //   
#define SSUSB_U3_PORT_MAC_RST_2P                  (0x1<<4) //   
#define SSUSB_U3_PORT_U2_CG_EN_2P                 (0x1<<3) //   
#define SSUSB_U3_PORT_HOST_SEL_2P                 (0x1<<2) //   
#define SSUSB_U3_PORT_PDN_2P                      (0x1<<1) //   
#define SSUSB_U3_PORT_DIS_2P                      (0x1<<0) //   

//                    
#define SSUSB_U3_PORT_PHYD_RST_3P                 (0x1<<5) //   
#define SSUSB_U3_PORT_MAC_RST_3P                  (0x1<<4) //   
#define SSUSB_U3_PORT_U2_CG_EN_3P                 (0x1<<3) //   
#define SSUSB_U3_PORT_HOST_SEL_3P                 (0x1<<2) //   
#define SSUSB_U3_PORT_PDN_3P                      (0x1<<1) //   
#define SSUSB_U3_PORT_DIS_3P                      (0x1<<0) //   

//                    
#define SSUSB_U2_PORT_OTG_HOST_VBUSVALID_SEL      (0x1<<9) //   
#define SSUSB_U2_PORT_OTG_MAC_AUTO_SEL            (0x1<<8) //   
#define SSUSB_U2_PORT_OTG_SEL                     (0x1<<7) //   
#define SSUSB_U2_PORT_PLL_STABLE_SEL              (0x1<<6) //   
#define SSUSB_U2_PORT_PHYD_RST                    (0x1<<5) //   
#define SSUSB_U2_PORT_MAC_RST                     (0x1<<4) //   
#define SSUSB_U2_PORT_U2_CG_EN                    (0x1<<3) //   
#define SSUSB_U2_PORT_HOST_SEL                    (0x1<<2) //   
#define SSUSB_U2_PORT_PDN                         (0x1<<1) //   
#define SSUSB_U2_PORT_DIS                         (0x1<<0) //   

//                    
#define SSUSB_U2_PORT_PLL_STABLE_SEL_1P           (0x1<<6) //   
#define SSUSB_U2_PORT_PHYD_RST_1P                 (0x1<<5) //   
#define SSUSB_U2_PORT_MAC_RST_1P                  (0x1<<4) //   
#define SSUSB_U2_PORT_U2_CG_EN_1P                 (0x1<<3) //   
#define SSUSB_U2_PORT_HOST_SEL_1P                 (0x1<<2) //   
#define SSUSB_U2_PORT_PDN_1P                      (0x1<<1) //   
#define SSUSB_U2_PORT_DIS_1P                      (0x1<<0) //   

//                    
#define SSUSB_U2_PORT_PLL_STABLE_SEL_2P           (0x1<<6) //   
#define SSUSB_U2_PORT_PHYD_RST_2P                 (0x1<<5) //   
#define SSUSB_U2_PORT_MAC_RST_2P                  (0x1<<4) //   
#define SSUSB_U2_PORT_U2_CG_EN_2P                 (0x1<<3) //   
#define SSUSB_U2_PORT_HOST_SEL_2P                 (0x1<<2) //   
#define SSUSB_U2_PORT_PDN_2P                      (0x1<<1) //   
#define SSUSB_U2_PORT_DIS_2P                      (0x1<<0) //   

//                    
#define SSUSB_U2_PORT_PLL_STABLE_SEL_3P           (0x1<<6) //   
#define SSUSB_U2_PORT_PHYD_RST_3P                 (0x1<<5) //   
#define SSUSB_U2_PORT_MAC_RST_3P                  (0x1<<4) //   
#define SSUSB_U2_PORT_U2_CG_EN_3P                 (0x1<<3) //   
#define SSUSB_U2_PORT_HOST_SEL_3P                 (0x1<<2) //   
#define SSUSB_U2_PORT_PDN_3P                      (0x1<<1) //   
#define SSUSB_U2_PORT_DIS_3P                      (0x1<<0) //   

//                    
#define SSUSB_U2_PORT_PLL_STABLE_SEL_4P           (0x1<<6) //   
#define SSUSB_U2_PORT_PHYD_RST_4P                 (0x1<<5) //   
#define SSUSB_U2_PORT_MAC_RST_4P                  (0x1<<4) //   
#define SSUSB_U2_PORT_U2_CG_EN_4P                 (0x1<<3) //   
#define SSUSB_U2_PORT_HOST_SEL_4P                 (0x1<<2) //   
#define SSUSB_U2_PORT_PDN_4P                      (0x1<<1) //   
#define SSUSB_U2_PORT_DIS_4P                      (0x1<<0) //   

//                    
#define SSUSB_U2_PORT_PLL_STABLE_SEL_5P           (0x1<<6) //   
#define SSUSB_U2_PORT_PHYD_RST_5P                 (0x1<<5) //   
#define SSUSB_U2_PORT_MAC_RST_5P                  (0x1<<4) //   
#define SSUSB_U2_PORT_U2_CG_EN_5P                 (0x1<<3) //   
#define SSUSB_U2_PORT_HOST_SEL_5P                 (0x1<<2) //   
#define SSUSB_U2_PORT_PDN_5P                      (0x1<<1) //   
#define SSUSB_U2_PORT_DIS_5P                      (0x1<<0) //   

//                    
#define SSUSB_SYSPLL_USE                          (0x1<<30) //     
#define RG_SSUSB_U2_PLL_STB                       (0x1<<29) //     
#define SSUSB_U2_FORCE_PLL_STB                    (0x1<<28) //     
#define SSUSB_U2_PORT_PHY_CK_DEB_TIMER            (0xf<<24) //     
#define SSUSB_U2_PORT_LPM_PLL_STABLE_TIMER        (0xff<<16) //     
#define SSUSB_U2_PORT_PLL_STABLE_TIMER            (0xff<<8) //    
#define SSUSB_U2_PORT_1US_TIMER                   (0xff<<0) //   

//                  
#define SSUSB_IP_DMA_BUS_CK_GATE_DIS              (0x1<<0) //   

//                     
#define SSUSB_MAC3_SYS_CK_GATE_MASK_TIME          (0xff<<16) //     
#define SSUSB_MAC2_SYS_CK_GATE_MASK_TIME          (0xff<<8) //    
#define SSUSB_PHY_REF_CK_DIV2                     (0x1<<4) //   
#define SSUSB_MAC3_SYS_CK_GATE_MODE               (0x3<<2) //   
#define SSUSB_MAC2_SYS_CK_GATE_MODE               (0x3<<0) //   

//                     
#define SSUSB_SIFSLV_MCU_BUS_CK_GATE_EN           (0x1<<1) //   
#define SSUSB_CSR_MCU_BUS_CK_GATE_EN              (0x1<<0) //   

//                     
#define SSUSB_REF_MAC2_CK_GATE_EN                 (0x1<<4) //   
#define SSUSB_REF_MAC3_CK_GATE_EN                 (0x1<<3) //   
#define SSUSB_REF_CK_GATE_EN                      (0x1<<2) //   
#define SSUSB_REF_PHY_CK_GATE_EN                  (0x1<<1) //   
#define SSUSB_REF_MAC_CK_GATE_EN                  (0x1<<0) //   

//                      
#define SSUSB_XACT3_XHCI_CK_GATE_MASK_TIME        (0xff<<8) //    
#define SSUSB_XACT3_XHCI_CK_GATE_MODE             (0x3<<4) //   
#define SSUSB_XHCI_CK_DIV2_EN                     (0x1<<0) //   

//                       
#define SSUSB_XHCI_SW_DRAM_RST                    (0x1<<4) //   
#define SSUSB_XHCI_SW_SYS60_RST                   (0x1<<3) //   
#define SSUSB_XHCI_SW_SYS125_RST                  (0x1<<2) //   
#define SSUSB_XHCI_SW_XHCI_RST                    (0x1<<1) //   
#define SSUSB_XHCI_SW_RST                         (0x1<<0) //   

//                      
#define SSUSB_DEV_SW_DRAM_RST                     (0x1<<3) //   
#define SSUSB_DEV_SW_QMU_RST                      (0x1<<2) //   
#define SSUSB_DEV_SW_BMU_RST                      (0x1<<1) //   
#define SSUSB_DEV_SW_RST                          (0x1<<0) //   

//                     
#define SSUSB_SYS60_CK_EXT_SEL                    (0x1<<2) //   
#define SSUSB_SYS_CK_EXT_SEL                      (0x1<<1) //   
#define SSUSB_SYS_CK_DIV2_EN                      (0x1<<0) //   

//               
#define SSUSB_HW_ID                               (0xffffffff<<0) //    

//                   
#define SSUSB_HW_SUB_ID                           (0xffffffff<<0) //    

//                   
#define PRB_BYTE3_EN                              (0x1<<3) //   
#define PRB_BYTE2_EN                              (0x1<<2) //   
#define PRB_BYTE1_EN                              (0x1<<1) //   
#define PRB_BYTE0_EN                              (0x1<<0) //   

//                   
#define PRB_BYTE1_SEL                             (0xffff<<16) //     
#define PRB_BYTE0_SEL                             (0xffff<<0) //    

//                   
#define PRB_BYTE3_SEL                             (0xffff<<16) //     
#define PRB_BYTE2_SEL                             (0xffff<<0) //    

//                   
#define PRB_BYTE3_MODULE_SEL                      (0xff<<24) //     
#define PRB_BYTE2_MODULE_SEL                      (0xff<<16) //     
#define PRB_BYTE1_MODULE_SEL                      (0xff<<8) //    
#define PRB_BYTE0_MODULE_SEL                      (0xff<<0) //   

//                   
#define SW_PRB_OUT                                (0xffffffff<<0) //    

//                   
#define PRB_RD_DATA                               (0xffffffff<<0) //    

//                   
#define SSUSB_IP_SPARE0                           (0xffffffff<<0) //    

//                   
#define SSUSB_IP_SPARE1                           (0xffffffff<<0) //    

//                         
#define SSUSB_FPGA_I2C_SCL_OEN_0P                 (0x1<<3) //   
#define SSUSB_FPGA_I2C_SCL_OUT_0P                 (0x1<<2) //   
#define SSUSB_FPGA_I2C_SDA_OEN_0P                 (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_OUT_0P                 (0x1<<0) //   

//                        
#define SSUSB_FPGA_I2C_SCL_IN_0P                  (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_IN_0P                  (0x1<<0) //   

//                         
#define SSUSB_FPGA_I2C_SCL_OEN_1P                 (0x1<<3) //   
#define SSUSB_FPGA_I2C_SCL_OUT_1P                 (0x1<<2) //   
#define SSUSB_FPGA_I2C_SDA_OEN_1P                 (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_OUT_1P                 (0x1<<0) //   

//                        
#define SSUSB_FPGA_I2C_SCL_IN_1P                  (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_IN_1P                  (0x1<<0) //   

//                         
#define SSUSB_FPGA_I2C_SCL_OEN_2P                 (0x1<<3) //   
#define SSUSB_FPGA_I2C_SCL_OUT_2P                 (0x1<<2) //   
#define SSUSB_FPGA_I2C_SDA_OEN_2P                 (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_OUT_2P                 (0x1<<0) //   

//                        
#define SSUSB_FPGA_I2C_SCL_IN_2P                  (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_IN_2P                  (0x1<<0) //   

//                         
#define SSUSB_FPGA_I2C_SCL_OEN_3P                 (0x1<<3) //   
#define SSUSB_FPGA_I2C_SCL_OUT_3P                 (0x1<<2) //   
#define SSUSB_FPGA_I2C_SDA_OEN_3P                 (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_OUT_3P                 (0x1<<0) //   

//                        
#define SSUSB_FPGA_I2C_SCL_IN_3P                  (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_IN_3P                  (0x1<<0) //   

//                         
#define SSUSB_FPGA_I2C_SCL_OEN_4P                 (0x1<<3) //   
#define SSUSB_FPGA_I2C_SCL_OUT_4P                 (0x1<<2) //   
#define SSUSB_FPGA_I2C_SDA_OEN_4P                 (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_OUT_4P                 (0x1<<0) //   

//                        
#define SSUSB_FPGA_I2C_SCL_IN_4P                  (0x1<<1) //   
#define SSUSB_FPGA_I2C_SDA_IN_4P                  (0x1<<0) //   

//                      
#define SSUSB_IP_SLV_TMOUT                        (0xffffffff<<0) //    
