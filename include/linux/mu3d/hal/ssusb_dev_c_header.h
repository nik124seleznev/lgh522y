...
//          
#define EP_CTRL_INTR                              (0x1<<5) //   
#define MAC2_INTR                                 (0x1<<4) //   
#define DMA_INTR                                  (0x1<<3) //   
#define MAC3_INTR                                 (0x1<<2) //   
#define QMU_INTR                                  (0x1<<1) //   
#define BMU_INTR                                  (0x1<<0) //   

//          
#define LV1IER                                    (0xffffffff<<0) //    

//           
#define LV1IESR                                   (0xffffffff<<0) //    

//           
#define LV1IECR                                   (0xffffffff<<0) //    

//                  
#define AXI_WR_ULTRA_NUM                          (0xff<<24) //     
#define AXI_WR_PRE_ULTRA_NUM                      (0xff<<16) //     
#define AXI_WR_ULTRA_EN                           (0x1<<0) //   

//                  
#define AXI_RD_ULTRA_NUM                          (0xff<<24) //     
#define AXI_RD_PRE_ULTRA_NUM                      (0xff<<16) //     
#define AXI_RD_ULTRA_EN                           (0x1<<0) //   

//                  
#define EXIT_BY_ERDY_DIS                          (0x1<<31) //     
#define ACCEPT_BMU_RX_EMPTY_CHK                   (0x1<<20) //     
#define ACCEPT_BMU_TX_EMPTY_CHK                   (0x1<<19) //     
#define ACCEPT_RXQ_INACTIVE_CHK                   (0x1<<18) //     
#define ACCEPT_TXQ_INACTIVE_CHK                   (0x1<<17) //     
#define ACCEPT_EP0_INACTIVE_CHK                   (0x1<<16) //     
#define REQUEST_BMU_RX_EMPTY_CHK                  (0x1<<4) //   
#define REQUEST_BMU_TX_EMPTY_CHK                  (0x1<<3) //   
#define REQUEST_RXQ_INACTIVE_CHK                  (0x1<<2) //   
#define REQUEST_TXQ_INACTIVE_CHK                  (0x1<<1) //   
#define REQUEST_EP0_INACTIVE_CHK                  (0x1<<0) //   
...
//                 
#define EPNRX_SRAM_DEBUG_MODE                     (0x1<<2) //   
#define EPNTX_SRAM_DEBUG_MODE                     (0x1<<1) //   
#define EP0_SRAM_DEBUG_MODE                       (0x1<<0) //   

//                   
#define SRAM_DEBUG_FIFOSEGSIZE                    (0xf<<24) //     
#define SRAM_DEBUG_SLOT                           (0x3f<<16) //     
#define SRAM_DEBUG_DP_COUNT                       (0x7ff<<0) //    

//             
#define RISC_SIZE                                 (0x3<<0) //   

//                 
#define RX_RDBUF_ERR_STS                          (0x7fff<<17) //     
#define TX_WRBUF_ERR_STS                          (0x7fff<<1) //    

//              
#define RX_RDBUF_ERR_EN                           (0x7fff<<17) //     
#define TX_WRBUF_ERR_EN                           (0x7fff<<1) //    

//         
#define EPRISR                                    (0x7fff<<17) //     
#define SETUPENDISR                               (0x1<<16) //     
#define EPTISR                                    (0x7fff<<1) //    
#define EP0ISR                                    (0x1<<0) //   

//         
#define EPRIER                                    (0x7fff<<17) //     
#define SETUPENDIER                               (0x1<<16) //     
#define EPTIER                                    (0x7fff<<1) //    
#define EP0IER                                    (0x1<<0) //   

//          
#define EPRIESR                                   (0x7fff<<17) //     
#define SETUPENDIESR                              (0x1<<16) //     
#define EPTIESR                                   (0x7fff<<1) //    
#define EP0IESR                                   (0x1<<0) //   

//          
#define EPRISR                                    (0x7fff<<17) //     
#define SETUPENDIECR                              (0x1<<16) //     
#define EPTIECR                                   (0x7fff<<1) //    
#define EP0IECR                                   (0x1<<0) //   

//          
#define RXDMAISR                                  (0x1<<2) //   
#define TXDMAISR                                  (0x1<<1) //   
#define EP0DMAISR                                 (0x1<<0) //   

//          
#define RXDMAIER                                  (0x1<<2) //   
#define TXDMAIER                                  (0x1<<1) //   
#define EP0DMAER                                  (0x1<<0) //   

//           
#define RXDMAIESR                                 (0x1<<2) //   
#define TXDMAIESR                                 (0x1<<1) //   
#define EP0DMAIESR                                (0x1<<0) //   

//           
#define RXDMAIECR                                 (0x1<<2) //   
#define TXDMAIECR                                 (0x1<<1) //   
#define EP0DMAIECR                                (0x1<<0) //   

//              
#define FFSTRADDR0                                (0xffff<<16) //     
#define ENDPNT                                    (0xf<<4) //   
#define INTEN                                     (0x1<<3) //   
#define DMA_DIR                                   (0x1<<1) //   
#define DMA_EN                                    (0x1<<0) //   

//                 
#define DMASTRADDR0                               (0xffffffff<<0) //    

//                  
#define DMATFRCNT0                                (0x7ff<<0) //    

//                 
#define EP0_DMALIMITER                            (0x7<<28) //     
#define DMA_FAKE                                  (0x1<<27) //     
#define DMA_BURST                                 (0x3<<24) //     
#define AXI_DMA_OUTSTAND_NUM                      (0xf<<20) //     
#define AXI_DMA_COHERENCE                         (0x1<<19) //     
#define AXI_DMA_IOMMU                             (0x1<<18) //     
#define AXI_DMA_CACHEABLE                         (0x1<<17) //     
#define AXI_DMA_ULTRA_EN                          (0x1<<16) //     
#define AXI_DMA_ULTRA_NUM                         (0xff<<8) //    
#define AXI_DMA_PRE_ULTRA_NUM                     (0xff<<0) //   

//             
#define FFSTRADDR                                 (0xffff<<16) //     
#define ENDPNT                                    (0xf<<4) //   
#define INTEN                                     (0x1<<3) //   
#define DMA_DIR                                   (0x1<<1) //   
#define DMA_EN                                    (0x1<<0) //   
...
//                
#define DMASTRADDR                                (0xffffffff<<0) //    

//               
#define DMATFRCNT                                 (0x7ff<<0) //    

//                
#define DMALIMITER                                (0x7<<28) //     
#define DMA_FAKE                                  (0x1<<27) //     
#define DMA_BURST                                 (0x3<<24) //     
#define AXI_DMA_OUTSTAND_NUM                      (0xf<<20) //     
#define AXI_DMA_COHERENCE                         (0x1<<19) //     
...
//          
#define EP0_EP_RESET                              (0x1<<31) //     
#define EP0_AUTOCLEAR                             (0x1<<30) //     
#define EP0_AUTOSET                               (0x1<<29) //     
#define EP0_DMAREQEN                              (0x1<<28) //     
#define EP0_SENDSTALL                             (0x1<<25) //     
#define EP0_FIFOFULL                              (0x1<<23) //     
#define EP0_SENTSTALL                             (0x1<<22) //     
#define EP0_DPHTX                                 (0x1<<20) //     
#define EP0_DATAEND                               (0x1<<19) //     
#define EP0_TXPKTRDY                              (0x1<<18) //     
#define EP0_SETUPPKTRDY                           (0x1<<17) //     
#define EP0_RXPKTRDY                              (0x1<<16) //     
#define EP0_MAXPKTSZ0                             (0x3ff<<0) //   

//            
#define EP0_RX_COUNT                              (0x3ff<<0) //   

//            

//           
#define TX_EP_RESET                               (0x1<<31) //     
#define TX_AUTOSET                                (0x1<<30) //     
#define TX_DMAREQEN                               (0x1<<29) //     
#define TX_FIFOFULL                               (0x1<<25) //     
#define TX_FIFOEMPTY                              (0x1<<24) //     
#define TX_SENTSTALL                              (0x1<<22) //     
#define TX_SENDSTALL                              (0x1<<21) //     
#define TX_TXPKTRDY                               (0x1<<16) //     
#define TX_TXMAXPKTSZ                             (0x7ff<<0) //    

//           
#define TX_MULT                                   (0x3<<22) //     
#define TX_MAX_PKT                                (0x3f<<16) //     
#define TX_SLOT                                   (0x3f<<8) //    
#define TXTYPE                                    (0x3<<4) //   
#define SS_TX_BURST                               (0xf<<0) //   

//           
#define TXBINTERVAL                               (0xff<<24) //     
#define TXFIFOSEGSIZE                             (0xf<<16) //     
#define TXFIFOADDR                                (0x1fff<<0) //    
...
//           
#define RX_EP_RESET                               (0x1<<31) //     
#define RX_AUTOCLEAR                              (0x1<<30) //     
#define RX_DMAREQEN                               (0x1<<29) //     
#define RX_SENTSTALL                              (0x1<<22) //     
#define RX_SENDSTALL                              (0x1<<21) //     
#define RX_FIFOFULL                               (0x1<<18) //     
#define RX_FIFOEMPTY                              (0x1<<17) //     
#define RX_RXPKTRDY                               (0x1<<16) //     
#define RX_RXMAXPKTSZ                             (0x7ff<<0) //    

//           
#define RX_MULT                                   (0x3<<22) //     
#define RX_MAX_PKT                                (0x3f<<16) //     
#define RX_SLOT                                   (0x3f<<8) //    
#define RX_TYPE                                   (0x3<<4) //   
#define SS_RX_BURST                               (0xf<<0) //   

//           
#define RXBINTERVAL                               (0xff<<24) //     
#define RXFIFOSEGSIZE                             (0xf<<16) //     
#define RXFIFOADDR                                (0x1fff<<0) //    

//           
#define EP_RX_COUNT                               (0x7ff<<16) //     
...
//         
#define BYTE3                                     (0xff<<24) //     
#define BYTE2                                     (0xff<<16) //     
#define BYTE1                                     (0xff<<8) //    
#define BYTE0                                     (0xff<<0) //   
...
//        
#define RXQ_CS_EN                                 (0x7fff<<17) //     
#define TXQ_CS_EN                                 (0x7fff<<1) //    
#define CS16B_EN                                  (0x1<<0) //   

//        
#define CFG_TX_ZLP_GPD                            (0x7fff<<1) //    

//        
#define CFG_TX_ZLP                                (0x7fff<<1) //    

//        
#define CFG_RX_COZ                                (0x7fff<<17) //     
#define CFG_RX_ZLP                                (0x7fff<<1) //    

//         
#define RXQ_EN                                    (0x7fff<<17) //     
#define TXQ_EN                                    (0x7fff<<1) //    

//           
#define TXQ_DMGR_DMSM_CS                          (0xf<<16) //     
#define TXQ_ACTIVE                                (0x1<<15) //     
#define TXQ_EPQ_STATE                             (0xf<<8) //    
#define TXQ_STOP                                  (0x1<<2) //   
#define TXQ_RESUME                                (0x1<<1) //   
#define TXQ_START                                 (0x1<<0) //   

//           
#define TXQ_START_ADDR                            (0x3fffffff<<2) //    

//           
#define TXQ_CUR_GPD_ADDR                          (0x3fffffff<<2) //    
...
//           
#define RXQ_DMGR_DMSM_CS                          (0xf<<16) //     
#define RXQ_ACTIVE                                (0x1<<15) //     
#define RXQ_EPQ_STATE                             (0x1f<<8) //    
#define RXQ_STOP                                  (0x1<<2) //   
#define RXQ_RESUME                                (0x1<<1) //   
#define RXQ_START                                 (0x1<<0) //   

//           
#define RXQ_START_ADDR                            (0x3fffffff<<2) //    

//           
#define RXQ_CUR_GPD_ADDR                          (0x3fffffff<<2) //    

//            
#define RXQ_LAST_DONE_PTR                         (0x3fffffff<<2) //    
...
//          
#define RXQ_DONE_INT                              (0x7fff<<17) //     
#define TXQ_DONE_INT                              (0x7fff<<1) //    

//         
#define RXQ_DONE_IER                              (0x7fff<<17) //     
#define TXQ_DONE_IER                              (0x7fff<<1) //    

//          
#define RXQ_DONE_IESR                             (0x7fff<<17) //     
#define TXQ_DONE_IESR                             (0x7fff<<1) //    

//          
#define RXQ_DONE_IECR                             (0x7fff<<17) //     
#define TXQ_DONE_IECR                             (0x7fff<<1) //    

//          
#define RXQ_ZLPERR_INT                            (0x1<<20) //     
#define RXQ_LENERR_INT                            (0x1<<18) //     
#define RXQ_CSERR_INT                             (0x1<<17) //     
#define RXQ_EMPTY_INT                             (0x1<<16) //     
#define TXQ_LENERR_INT                            (0x1<<2) //   
#define TXQ_CSERR_INT                             (0x1<<1) //   
#define TXQ_EMPTY_INT                             (0x1<<0) //   

//         
#define RXQ_ZLPERR_IER                            (0x1<<20) //     
#define RXQ_LENERR_IER                            (0x1<<18) //     
#define RXQ_CSERR_IER                             (0x1<<17) //     
#define RXQ_EMPTY_IER                             (0x1<<16) //     
#define TXQ_LENERR_IER                            (0x1<<2) //   
#define TXQ_CSERR_IER                             (0x1<<1) //   
#define TXQ_EMPTY_IER                             (0x1<<0) //   

//          
#define RXQ_ZLPERR_IESR                           (0x1<<20) //     
#define RXQ_LENERR_IESR                           (0x1<<18) //     
#define RXQ_CSERR_IESR                            (0x1<<17) //     
#define RXQ_EMPTY_IESR                            (0x1<<16) //     
#define TXQ_LENERR_IESR                           (0x1<<2) //   
#define TXQ_CSERR_IESR                            (0x1<<1) //   
#define TXQ_EMPTY_IESR                            (0x1<<0) //   

//          
#define RXQ_ZLPERR_IECR                           (0x1<<20) //     
#define RXQ_LENERR_IECR                           (0x1<<18) //     
#define RXQ_CSERR_IECR                            (0x1<<17) //     
#define RXQ_EMPTY_IECR                            (0x1<<16) //     
#define TXQ_LENERR_IECR                           (0x1<<2) //   
#define TXQ_CSERR_IECR                            (0x1<<1) //   
#define TXQ_EMPTY_IECR                            (0x1<<0) //   

//         
#define RXQ_EMPTY_MASK                            (0x7fff<<17) //     
#define TXQ_EMPTY_MASK                            (0x7fff<<1) //    

//          
#define RXQ_EMPTY_IER_MASK                        (0x7fff<<17) //     
#define TXQ_EMPTY_IER_MASK                        (0x7fff<<1) //    

//           
#define RXQ_EMPTY_IESR_MASK                       (0x7fff<<17) //     
#define TXQ_EMPTY_IESR_MASK                       (0x7fff<<1) //    

//           
#define RXQ_EMPTY_IECR_MASK                       (0x7fff<<17) //     
#define TXQ_EMPTY_IECR_MASK                       (0x7fff<<1) //    

//            
#define TXQ_LENERR_MASK                           (0x7fff<<17) //     
#define TXQ_CSERR_MASK                            (0x7fff<<1) //    

//             
#define TXQ_LENERR_IER_MASK                       (0x7fff<<17) //     
#define TXQ_CSERR_IER_MASK                        (0x7fff<<1) //    

//              
#define TXQ_LENERR_IESR_MASK                      (0x7fff<<17) //     
#define TXQ_CSERR_IESR_MASK                       (0x7fff<<1) //    

//              
#define TXQ_LENERR_IECR_MASK                      (0x7fff<<17) //     
#define TXQ_CSERR_IECR_MASK                       (0x7fff<<1) //    

//            
#define RXQ_LENERR_MASK                           (0x7fff<<17) //     
#define RXQ_CSERR_MASK                            (0x7fff<<1) //    

//             
#define RXQ_LENERR_IER_MASK                       (0x7fff<<17) //     
#define RXQ_CSERR_IER_MASK                        (0x7fff<<1) //    

//              
#define RXQ_LENERR_IESR_MASK                      (0x7fff<<17) //     
#define RXQ_CSERR_IESR_MASK                       (0x7fff<<1) //    

//              
#define RXQ_LENERR_IECR_MASK                      (0x7fff<<17) //     
#define RXQ_CSERR_IECR_MASK                       (0x7fff<<1) //    

//            
#define RXQ_ZLPERR_MASK                           (0x7fff<<17) //     

//             
#define RXQ_ZLPERR_IER_MASK                       (0x7fff<<17) //     

//              
#define RXQ_ZLPERR_IESR_MASK                      (0x7fff<<17) //     

//              
#define RXQ_ZLPERR_IECR_MASK                      (0x7fff<<17) //     

//               
#define CAP_EP0FFSZ                               (0xffffffff<<0) //    

//                 
#define CAP_EPNTXFFSZ                             (0xffffffff<<0) //    

//                 
#define CAP_EPNRXFFSZ                             (0xffffffff<<0) //    

//              
#define CAP_RX_EP_NUM                             (0x1f<<8) //    
#define CAP_TX_EP_NUM                             (0x1f<<0) //   

//                
#define CAP_TX_SLOT3                              (0x3f<<24) //     
#define CAP_TX_SLOT2                              (0x3f<<16) //     
#define CAP_TX_SLOT1                              (0x3f<<8) //    
#define RSV                                       (0x3f<<0) //   

//                
#define CAP_TX_SLOT7                              (0x3f<<24) //     
#define CAP_TX_SLOT6                              (0x3f<<16) //     
#define CAP_TX_SLOT5                              (0x3f<<8) //    
#define CAP_TX_SLOT4                              (0x3f<<0) //   

//                
#define CAP_TX_SLOT11                             (0x3f<<24) //     
#define CAP_TX_SLOT10                             (0x3f<<16) //     
#define CAP_TX_SLOT9                              (0x3f<<8) //    
#define CAP_TX_SLOT8                              (0x3f<<0) //   

//                
#define CAP_TX_SLOT15                             (0x3f<<24) //     
#define CAP_TX_SLOT14                             (0x3f<<16) //     
#define CAP_TX_SLOT13                             (0x3f<<8) //    
#define CAP_TX_SLOT12                             (0x3f<<0) //   

//                
#define CAP_RX_SLOT3                              (0x3f<<24) //     
#define CAP_RX_SLOT2                              (0x3f<<16) //     
#define CAP_RX_SLOT1                              (0x3f<<8) //    
#define RSV                                       (0x3f<<0) //   

//                
#define CAP_RX_SLOT7                              (0x3f<<24) //     
#define CAP_RX_SLOT6                              (0x3f<<16) //     
#define CAP_RX_SLOT5                              (0x3f<<8) //    
#define CAP_RX_SLOT4                              (0x3f<<0) //   

//                
#define CAP_RX_SLOT11                             (0x3f<<24) //     
#define CAP_RX_SLOT10                             (0x3f<<16) //     
#define CAP_RX_SLOT9                              (0x3f<<8) //    
#define CAP_RX_SLOT8                              (0x3f<<0) //   

//                
#define CAP_RX_SLOT15                             (0x3f<<24) //     
#define CAP_RX_SLOT14                             (0x3f<<16) //     
#define CAP_RX_SLOT13                             (0x3f<<8) //    
#define CAP_RX_SLOT12                             (0x3f<<0) //   

//             
#define DMA_BUS_CK_GATE_DIS                       (0x1<<2) //   
#define VBUS_ON                                   (0x1<<1) //   
#define VBUS_FRC_EN                               (0x1<<0) //   
