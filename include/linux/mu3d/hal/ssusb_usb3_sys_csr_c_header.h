...
//                 
#define CHP_TIMEOUT_VALUE                         (0x7f<<8) //    
#define PHP_TIMEOUT_VALUE                         (0xf<<0) //   

//                  
#define NO_LC_TIMEOUT_VALUE                       (0xf<<8) //    
#define LDN_TIMEOUT_VALUE                         (0xf<<4) //   
#define LUP_TIMEOUT_VALUE                         (0xf<<0) //   

//                 
#define LPMA_SENT_CNT_VALUE                       (0xf<<16) //     
#define PM_ENTRY_TIMEOUT_VALUE                    (0xf<<8) //    
#define PM_LC_TIMEOUT_VALUE                       (0xf<<0) //   

//                       
#define DEV_U2_INACT_TIMEOUT_VALUE                (0xff<<16) //     
#define U2_INACT_TIMEOUT_VALUE                    (0xff<<8) //    
#define U1_INACT_TIMEOUT_VALUE                    (0xff<<0) //   

//                      
#define SW_U2_ACCEPT_ENABLE                       (0x1<<9) //   
#define SW_U1_ACCEPT_ENABLE                       (0x1<<8) //   
#define UX_EXIT                                   (0x1<<5) //   
#define LGO_U3                                    (0x1<<4) //   
#define LGO_U2                                    (0x1<<3) //   
#define LGO_U1                                    (0x1<<2) //   
#define SW_U2_REQUEST_ENABLE                      (0x1<<1) //   
#define SW_U1_REQUEST_ENABLE                      (0x1<<0) //   

//                  
#define CLR_LINK_ERR_CNT                          (0x1<<16) //     
#define LINK_ERROR_COUNT                          (0xffff<<0) //    

//                    
#define GO_HOT_RESET                              (0x1<<3) //   
#define GO_WARM_RESET                             (0x1<<2) //   
#define GO_RXDETECT                               (0x1<<1) //   
#define GO_SS_DISABLE                             (0x1<<0) //   

//                   
#define TX_LRTY_DPP_EN                            (0x1<<0) //   

//                        
#define SYS_SPEED_MS_TO_US                        (0x1<<0) //   

//                        
#define INSERT_CRC32_ERR_DP_NUM                   (0xff<<16) //     
#define INSERT_CRC32_ERR_EN                       (0x1<<8) //   
#define ZLP_CRC32_CHK_DIS                         (0x1<<0) //   

//                   
#define CLR_TX_DATALEN_OVER_1024                  (0x1<<1) //   
#define TX_DATALEN_OVER_1024                      (0x1<<0) //   

//                  
#define CLR_USB3_U1_REJECT_CNT                    (0x1<<16) //     
#define USB3_U1_REJECT_CNT                        (0xffff<<0) //    

//                  
#define CLR_USB3_U2_REJECT_CNT                    (0x1<<16) //     
#define USB3_U2_REJECT_CNT                        (0xffff<<0) //    

//               
#define DEV_NOTIF_TYPE_SPECIFIC_LOW               (0xffffff<<8) //    
#define DEV_NOTIF_TYPE                            (0xf<<4) //   
#define SEND_DEV_NOTIF                            (0x1<<0) //   

//               
#define DEV_NOTIF_TYPE_SPECIFIC_HIGH              (0xffffffff<<0) //    

//                   
#define VENDOR_DEV_TEST_VALUE                     (0xff<<16) //     
#define SEND_VENDOR_DEV_TEST                      (0x1<<0) //   

//                       
#define VENDOR_DEF_DATA_LOW                       (0xffffffff<<0) //    

//                        
#define VENDOR_DEF_DATA_HIGH                      (0xffffffff<<0) //    

//                      
#define SEND_U2_INACT_TIMEOUT                     (0x1<<2) //   
#define FORCE_LINK_PM_ACPT                        (0x1<<1) //   
#define SEND_SET_LINK_FUNC                        (0x1<<0) //   

//                    
#define TIEBREAKER                                (0xf<<16) //     
#define NUM_HP_BUF                                (0xff<<8) //    
#define LINK_SPEED                                (0xff<<0) //   

//                     
#define TPORT_CONF_TIMEOUT_VALUE                  (0x1f<<0) //   

//                     
#define CNT_1MS_VALUE                             (0xf<<28) //     
#define CNT_100US_VALUE                           (0xf<<24) //     
#define CNT_10US_VALUE                            (0xf<<20) //     
#define CNT_1US_VALUE                             (0xff<<0) //   

//                 
#define ISO_TIMESTAMP                             (0x7ffffff<<0) //    

//                       
#define RECV_SET_LINK_FUNC_INTR_EN                (0x1<<2) //   
#define RECV_U2_INACT_INTR_EN                     (0x1<<1) //   
#define RECV_ITP_INTR_EN                          (0x1<<0) //   

//                    
#define RECV_SET_LINK_FUNC_INTR                   (0x1<<2) //   
#define RECV_U2_INACT_INTR                        (0x1<<1) //   
#define RECV_ITP_INTR                             (0x1<<0) //   

//                   
#define CRC16_ERR_INTR_EN                         (0x1<<2) //   
#define CRC5_ERR_INTR_EN                          (0x1<<1) //   
#define CRC32_ERR_INTR_EN                         (0x1<<0) //   

//                
#define CRC16_ERR_INTR                            (0x1<<2) //   
#define CRC5_ERR_INTR                             (0x1<<1) //   
#define CRC32_ERR_INTR                            (0x1<<0) //   

//                       
#define LMP_ADV_ERR_INTR_EN                       (0x1<<2) //   
#define LMP_ADV_DONE_INTR_EN                      (0x1<<1) //   
#define LINK_ADV_DONE_INTR_EN                     (0x1<<0) //   

//                    
#define LMP_ADV_ERR_INTR                          (0x1<<2) //   
#define LMP_ADV_DONE_INTR                         (0x1<<1) //   
#define LINK_ADV_DONE_INTR                        (0x1<<0) //   

//                  
#define CLR_RECOV_CNT                             (0x1<<16) //     
#define RECOV_CNT                                 (0xffff<<0) //    

//                     
#define T2R_LOOPBACK                              (0x1<<0) //   
