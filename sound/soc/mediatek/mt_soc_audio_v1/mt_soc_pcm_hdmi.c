...
static int Audio_hdmi_SideGen_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
    ...
    if (mHdmi_sidegen_control)
    {
        ...
        Afe_Set_Reg(AFE_TDM_CON2, 0, 0x0000000f); //                                       
        Afe_Set_Reg(AFE_TDM_CON2, 1 << 4, 0x000000f0); //                                       
        Afe_Set_Reg(AFE_TDM_CON2, 2 << 8, 0x00000f00); //                                       
        Afe_Set_Reg(AFE_TDM_CON2, 3 << 12, 0x0000f000); //                                       
        Afe_Set_Reg(AUDIO_TOP_CON3, 1<<3,  1 << 3); //                   

        SetTDMEnable(true); //          
        Afe_Set_Reg(AUDIO_AUDIO_TOP_CON0, 0 << 20,  1 << 20); //                
...
//                                    
        ...
        Afe_Set_Reg(AFE_TDM_CON2, 0, 0x0000000f); //                                       
        Afe_Set_Reg(AFE_TDM_CON2, 4 << 4, 0x000000f0); //                    
        Afe_Set_Reg(AFE_TDM_CON2, 4 << 8, 0x00000f00); //                     
        Afe_Set_Reg(AFE_TDM_CON2, 4 << 12, 0x0000f000); //                     
        Afe_Set_Reg(AUDIO_TOP_CON3, 1<<3,  1 << 3); //                   
//                                                                                    
//                                                                                       
...
//                     
        ...
        SetHDMIConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I30, Soc_Aud_InterConnectionOutput_O30);
        SetHDMIConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I31, Soc_Aud_InterConnectionOutput_O31);
        SetHDMIConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I32, Soc_Aud_InterConnectionOutput_O33);  //              
        SetHDMIConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I33, Soc_Aud_InterConnectionOutput_O32);  //       
        ...
        Afe_Set_Reg(AFE_TDM_CON2, 0, 0x00600000); //                        
        Afe_Set_Reg(AFE_TDM_CON2, 1 << 20, 0x00100000); //                       
#endif 
#endif
//                              
