...
static const struct pinmux_irq pinmux_irqs[] = {
	PINMUX_IRQ(irq_pin(0), GPIO_PORT2,   GPIO_PORT13),	/*       */
	PINMUX_IRQ(irq_pin(1), GPIO_PORT20),		/*       */
	PINMUX_IRQ(irq_pin(2), GPIO_PORT11,  GPIO_PORT12),	/*       */
	PINMUX_IRQ(irq_pin(3), GPIO_PORT10,  GPIO_PORT14),	/*       */
	PINMUX_IRQ(irq_pin(4), GPIO_PORT15,  GPIO_PORT172),/*       */
	PINMUX_IRQ(irq_pin(5), GPIO_PORT0,   GPIO_PORT1),	/*       */
	PINMUX_IRQ(irq_pin(6), GPIO_PORT121, GPIO_PORT173),/*       */
	PINMUX_IRQ(irq_pin(7), GPIO_PORT120, GPIO_PORT209),/*       */
	PINMUX_IRQ(irq_pin(8), GPIO_PORT119),		/*       */
	PINMUX_IRQ(irq_pin(9), GPIO_PORT118, GPIO_PORT210),/*       */
	PINMUX_IRQ(irq_pin(10), GPIO_PORT19),		/*        */
	PINMUX_IRQ(irq_pin(11), GPIO_PORT104),		/*        */
	PINMUX_IRQ(irq_pin(12), GPIO_PORT42,  GPIO_PORT97),	/*        */
	PINMUX_IRQ(irq_pin(13), GPIO_PORT64,  GPIO_PORT98),	/*        */
	PINMUX_IRQ(irq_pin(14), GPIO_PORT63,  GPIO_PORT99),	/*        */
	PINMUX_IRQ(irq_pin(15), GPIO_PORT62,  GPIO_PORT100),/*        */
	PINMUX_IRQ(irq_pin(16), GPIO_PORT68,  GPIO_PORT211),/*        */
	PINMUX_IRQ(irq_pin(17), GPIO_PORT69),		/*        */
	PINMUX_IRQ(irq_pin(18), GPIO_PORT70),		/*        */
	PINMUX_IRQ(irq_pin(19), GPIO_PORT71),		/*        */
	PINMUX_IRQ(irq_pin(20), GPIO_PORT67),		/*        */
	PINMUX_IRQ(irq_pin(21), GPIO_PORT202),		/*        */
	PINMUX_IRQ(irq_pin(22), GPIO_PORT95),		/*        */
	PINMUX_IRQ(irq_pin(23), GPIO_PORT96),		/*        */
	PINMUX_IRQ(irq_pin(24), GPIO_PORT180),		/*        */
	PINMUX_IRQ(irq_pin(25), GPIO_PORT38),		/*        */
	PINMUX_IRQ(irq_pin(26), GPIO_PORT58,  GPIO_PORT81),	/*        */
	PINMUX_IRQ(irq_pin(27), GPIO_PORT57,  GPIO_PORT168),/*        */
	PINMUX_IRQ(irq_pin(28), GPIO_PORT56,  GPIO_PORT169),/*        */
	PINMUX_IRQ(irq_pin(29), GPIO_PORT50,  GPIO_PORT170),/*        */
	PINMUX_IRQ(irq_pin(30), GPIO_PORT49,  GPIO_PORT171),/*        */
	PINMUX_IRQ(irq_pin(31), GPIO_PORT41,  GPIO_PORT167),/*        */
};
