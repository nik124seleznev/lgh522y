...
#define BYPASS_SUPPORT_MASK    0x01	/*       */
#define TAP_SUPPORT_MASK       0x02	/*       */
#define NORMAL_UNSUPPORT_MASK  0x04	/*       */
#define DISC_SUPPORT_MASK      0x08	/*       */
#define TPL2_SUPPORT_MASK      0x10	/*       */
#define DISC_PORT_SUPPORT_MASK 0x20	/*       */

#define STATUS_TAP_REG_ADDR    0x6
#define WDTE_TAP_BPN_MASK      0x01	/*                                                */
#define DIS_TAP_CAP_MASK       0x04	/*                            */
#define DFLT_PWRON_TAP_MASK    0x08	/*          */
#define TAP_OFF_MASK           0x10	/*          */
#define TAP_FLAG_MASK          0x20	/*          */
...
#define BYPASS_CAP_DELAY           21	/*      */
#define DFLT_PWRON_DELAY           10	/*      */
#define LATCH_DELAY                13	/*      */
#define EEPROM_WR_DELAY             8	/*      */
