...
{
    (iw_handler) unifi_siwcommit,           /*               */
    (iw_handler) unifi_giwname,             /*             */
    (iw_handler) NULL,                      /*             */
    (iw_handler) NULL,                      /*             */
    (iw_handler) unifi_siwfreq,             /*             */
    (iw_handler) unifi_giwfreq,             /*             */
    (iw_handler) unifi_siwmode,             /*             */
    (iw_handler) unifi_giwmode,             /*             */
    (iw_handler) NULL,                      /*             */
    (iw_handler) NULL,                      /*             */
    (iw_handler) NULL,                      /*              */
    (iw_handler) unifi_giwrange,            /*              */
    (iw_handler) NULL,                      /*             */
    (iw_handler) NULL,                      /*             */
    (iw_handler) NULL,                      /*              */
    (iw_handler) NULL,                      /*              */
    ...
    (iw_handler) NULL,                      /*               */
    (iw_handler) NULL,                      /*               */
    (iw_handler) unifi_siwap,               /*           */
    (iw_handler) unifi_giwap,               /*           */
#if WIRELESS_EXT > 17
    /*                                 */
    unifi_siwmlme,              /*                                     */
#else
...
#endif
    (iw_handler) NULL,                      /*               */
    (iw_handler) unifi_siwscan,             /*             */
    (iw_handler) unifi_giwscan,             /*             */
    (iw_handler) unifi_siwessid,            /*              */
    (iw_handler) unifi_giwessid,            /*              */
    (iw_handler) NULL,                      /*              */
    (iw_handler) NULL,                      /*              */
    (iw_handler) NULL,                      /*            */
    (iw_handler) NULL,                      /*            */
