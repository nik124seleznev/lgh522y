...
#define STREAM_CHECKSUM 0x6d34        /*                                     */

/*                                   
 */
#define PTDL_MAX_SIZE 2048            /*                            */
#define PTDL_HDR_SIZE (4 + 2 + 6 + 2) /*                                         */
...
#define PTDL_RESET_DATA_SIZE  20  /*                            */
...
#define SEC_CMD_LEN         ((4 + 2) * 2) /*                             */
#define PTDL_VEC_HDR_SIZE   (4 + 2 + 2)   /*                              */
#define UF_MAC_START_VEC    0x00c00000    /*                               */
#define UF_PHY_START_VEC    0x00c00000    /*                               */
#define UF_MAC_START_CMD    0x6000        /*                                 */
#define UF_PHY_START_CMD    0x7000        /*                                 */
