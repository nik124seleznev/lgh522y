...
/*                                          */
#define HIP_CDUMP_FIRST_CPUREG      (0xFFE0) /*                    */
#define HIP_CDUMP_FIRST_LO          (0)      /*                            */
#define HIP_CDUMP_FIRST_HI_MAC      (0x3C00) /*                        */
#define HIP_CDUMP_FIRST_HI_PHY      (0x1C00) /*                        */
#define HIP_CDUMP_FIRST_SH          (0)      /*                             */

#define HIP_CDUMP_NCPUREGS    (10)           /*                             */
#define HIP_CDUMP_NWORDS_LO   (0x0100)       /*                               */
#define HIP_CDUMP_NWORDS_HI   (0x0400)       /*                                */
#define HIP_CDUMP_NWORDS_SH   (0x0500)       /*                                       */

#define HIP_CDUMP_NUM_ZONES 7                /*                                         */
...
typedef struct coredump_buf
{
    ...
    struct coredump_buf *next;              /*               */
    struct coredump_buf *prev;              /*               */
} coredump_buffer;
...
struct coredump_zone
{
    ...
    enum unifi_dbg_processors_select cpu;    /*                       */
    u32                        gp;     /*                                       */
    u16                        offset; /*                                                */
    u16                        length; /*                             */
};
