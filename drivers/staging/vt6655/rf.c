...
bool s_bAL7230Init(unsigned long dwIoBase)
{
	...
	bResult &= IFRFbWriteEmbedded(dwIoBase, (0x3ABA8F00+(BY_AL7230_REG_LEN<<3)+IFREGCTL_REGW)); //                          
	MACvTimer0MicroSDelay(dwIoBase, 30);//    
	bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[CB_AL7230_INIT_SEQ-1]); //                           
...
bool s_bAL7230SelectChannel(unsigned long dwIoBase, unsigned char byChannel)
{
	...
	bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230ChannelTable0[byChannel - 1]); //    
	bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230ChannelTable1[byChannel - 1]); //    
	bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230ChannelTable2[byChannel - 1]); //    
...
bool RFbAL7230SelectChannelPostProcess(unsigned long dwIoBase, unsigned char byOldChannel, unsigned char byNewChannel)
{
	...
	if ((byOldChannel <= CB_MAX_CHANNEL_24G) && (byNewChannel > CB_MAX_CHANNEL_24G)) {
		//                       
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTableAMode[2]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTableAMode[3]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTableAMode[5]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTableAMode[7]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTableAMode[10]);//     
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTableAMode[12]);//     
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTableAMode[15]);//     
	} else if ((byOldChannel > CB_MAX_CHANNEL_24G) && (byNewChannel <= CB_MAX_CHANNEL_24G)) {
		//                       
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[2]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[3]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[5]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[7]); //    
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[10]);//     
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[12]);//     
		bResult &= IFRFbWriteEmbedded(dwIoBase, dwAL7230InitTable[15]);//     
	}
