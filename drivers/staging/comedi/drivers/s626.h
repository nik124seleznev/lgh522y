...
/*                       */
#define LP_RDDIN(x)		(0x0040 + (x) * 0x10)	/*                  */
#define LP_WRINTSEL(x)		(0x0042 + (x) * 0x10)	/*               */
#define LP_WREDGSEL(x)		(0x0044 + (x) * 0x10)	/*                   */
#define LP_WRCAPSEL(x)		(0x0046 + (x) * 0x10)	/*                   */
#define LP_RDCAPFLG(x)		(0x0048 + (x) * 0x10)	/*                   */
#define LP_WRDOUT(x)		(0x0048 + (x) * 0x10)	/*                   */
#define LP_RDINTSEL(x)		(0x004a + (x) * 0x10)	/*               */
#define LP_RDEDGSEL(x)		(0x004c + (x) * 0x10)	/*                   */
#define LP_RDCAPSEL(x)		(0x004e + (x) * 0x10)	/*                   */
