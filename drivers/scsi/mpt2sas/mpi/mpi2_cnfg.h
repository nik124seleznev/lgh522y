...
typedef struct _MPI2_CONFIG_PAGE_SASIOUNIT16 {
	...
	U32                         FastPathUnPendedRequests;      /*      */
	U32                         FastPathHostRequestStarts;     /*      */
	U32                         FastPathFirmwareRequestStarts; /*      */
	U32                         FastPathHostCompletions;       /*      */
	U32                         FastPathFirmwareCompletions;   /*      */
	U32                         NonFastPathRequestStarts;      /*      */
	U32			    NonFastPathHostCompletions;    /*      */
