...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	...
	&act_len);
	usb_stor_dbg(us, "usb_stor_huawei_scsi_init performing result is %d, transfer the actual length=%d\n", result, act_len);
	return result;
}
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	...
	result = usb_stor_bulk_transfer_buf (us, us->send_bulk_pipe, cmd, 31,
	&act_len);
	usb_stor_dbg(us, "usb_stor_dlink_scsi_init performing result is %d, transfer the actual length=%d\n", result, act_len);
		}
	return result;
}
