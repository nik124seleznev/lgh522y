...
#endif
	volatile u32 *lge_boot_reason 		 	= lge_boot_magic_number + 1; //            
	volatile u32 *lge_boot_reason_extra1 	= lge_boot_reason + 1; 			//            
	volatile u32 *lge_boot_reason_extra2 	= lge_boot_reason_extra1 + 1; 	//            
