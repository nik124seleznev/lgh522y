...
static struct pcm_desc suspend_pcm_1pll = {
	...
	.vec1		= EVENT_VEC(12, 1, 0, 57),	/*                */
	.vec2		= EVENT_VEC(30, 1, 0, 129),	/*                   */
	.vec3		= EVENT_VEC(31, 1, 0, 266),	/*                  */
};
...
#define WAKE_SRC_FOR_SUSPEND                                                          \
    (WAKE_SRC_MD32_WDT | WAKE_SRC_KP | WAKE_SRC_CONN2AP | WAKE_SRC_EINT | WAKE_SRC_CONN_WDT | WAKE_SRC_CCIF0_MD | WAKE_SRC_CCIF1_MD |                 \
     ...
     /*                   */ WAKE_SRC_MD_WDT | WAKE_SRC_MD2_WDT | WAKE_SRC_CLDMA_MD |        \
...
#endif
#endif
        spm_write(base + OFFSET_CONTROL,     0x0);    /*                  */
        spm_write(base + OFFSET_TRANSAC_LEN, 0x1);    /*                      */
        spm_write(base + OFFSET_EXT_CONF,    0x0);    /*                   */
        spm_write(base + OFFSET_IO_CONFIG,   0x0);    /*                    */
        spm_write(base + OFFSET_HS,          0x102);  /*             */
    }
    else
