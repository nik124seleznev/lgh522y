...
typedef struct
{
    ...
    KAL_UINT32 	txq_id;
    KAL_UINT32 	rxq_id;
    KAL_UINT32  rx_flow_ctrl_limit; //                                                                                 
    KAL_UINT32  rx_flow_ctrl_thresh;//                                  
...
#define SDIO_TX_Q_NUM (TX_Q_MAX - TX_Q_MIN) //        
#define SDIO_RX_Q_NUM (RX_Q_MAX - RX_Q_MIN) //        
#define SDIO_TXQ(x)   (x - TX_Q_0)          //              
#define SDIO_RXQ(x)   (x - RX_Q_0)          //              
...
enum CCCI_PORT{
    ...
    CCCI_PORT_CTRL = START_OF_BOOT_PORT,/*      */
    END_OF_BOOT_PORT,
    START_OF_NORMAL_PORT = END_OF_BOOT_PORT,
    CCCI_PORT_SYS = START_OF_NORMAL_PORT,/*      */
    CCCI_PORT_AUD,        /*      */
    CCCI_PORT_META,       /*      */
    CCCI_PORT_MUX,     	  /*      */
    CCCI_PORT_FS,     	  /*      */
...
//           
#define CCCI_IOC_BOOT_MD				_IO(CCCI_IOC_MAGIC,  100)				/*      */
#define CCCI_IOC_GATE_MD				_IO(CCCI_IOC_MAGIC,  101)				/*      */
#define CCCI_IOC_ASSERT_MD				_IO(CCCI_IOC_MAGIC,  102)				/*      */
#define CCCI_IOC_CHECK_STATE			_IOR(CCCI_IOC_MAGIC, 103, unsigned int)	/*      */
#define CCCI_IOC_SET_STATE				_IOW(CCCI_IOC_MAGIC, 104, unsigned int)	/*      */
#define CCCI_IOC_GET_MD_BOOT_INFO		_IOR(CCCI_IOC_MAGIC, 105, unsigned int)	/*      */
#define CCCI_IOC_START_BOOT				_IO(CCCI_IOC_MAGIC,  106)				/*      */
#define CCCI_IOC_BOOT_DONE				_IO(CCCI_IOC_MAGIC,  107)				/*      */
#define CCCI_IOC_REBOOT					_IO(CCCI_IOC_MAGIC,  108)				/*      */
#define CCCI_IOC_MD_EXCEPTION			_IO(CCCI_IOC_MAGIC,  109)				/*      */
#define CCCI_IOC_MD_EX_REC_OK			_IO(CCCI_IOC_MAGIC,  110)				/*      */
#define CCCI_IOC_GET_RUNTIME_DATA		_IOR(CCCI_IOC_MAGIC, 111, char[1024])	/*      */
#define CCCI_IOC_SET_HEADER				_IO(CCCI_IOC_MAGIC,  112)				/*      */
#define CCCI_IOC_CLR_HEADER				_IO(CCCI_IOC_MAGIC,  113)				/*      */
#define CCCI_IOC_SET_EXCEPTION_DATA		_IOW(CCCI_IOC_MAGIC, 114, char[1024])	/*      */
#define CCCI_IOC_GET_EXCEPTION_LENGTH	_IOR(CCCI_IOC_MAGIC, 115, unsigned int)	/*      */
#define CCCI_IOC_SET_BOOT_STATE			_IOW(CCCI_IOC_MAGIC, 116, unsigned int)	/*       */
#define CCCI_IOC_GET_BOOT_STATE			_IOR(CCCI_IOC_MAGIC, 117, unsigned int)	/*       */
