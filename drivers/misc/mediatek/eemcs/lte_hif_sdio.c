...
static sdio_proc_queue_handle proc_normal_queue_handle[] = {
	{TXQ_Q0,		1,	mtlte_hif_sdio_tx_chk_pkt_num, 		mtlte_hif_sdio_tx},	//                                                        
	{RXQ_Q0,		0,	mtlte_hif_sdio_rx_chk_pkt_num,		mtlte_hif_sdio_rx},	//                                                           
	{TXQ_Q1,		1,	mtlte_hif_sdio_tx_chk_pkt_num, 		mtlte_hif_sdio_tx},	//                                                                       
	{RXQ_Q1,		0,	mtlte_hif_sdio_rx_chk_pkt_num,		mtlte_hif_sdio_rx},	//                                                  
	{TXQ_Q2,		1,	mtlte_hif_sdio_tx_chk_pkt_num, 		mtlte_hif_sdio_tx},	//                                                  
	{TXQ_Q3,		1,	mtlte_hif_sdio_tx_chk_pkt_num, 		mtlte_hif_sdio_tx},	//                                                  
	{TXQ_Q4,		1,	mtlte_hif_sdio_tx_chk_pkt_num, 		mtlte_hif_sdio_tx},	//                                                  
	{RXQ_Q3,		0,	mtlte_hif_sdio_rx_chk_pkt_num,		mtlte_hif_sdio_rx},	//                                                   
	{RXQ_Q2,		0,	mtlte_hif_sdio_rx_chk_pkt_num,		mtlte_hif_sdio_rx},	//                                         
};
...
static sdio_proc_queue_handle proc_normal_queue_handle[] = {
    ...
    {TXQ_Q5,		1,	mtlte_hif_sdio_tx_chk_pkt_num, 		mtlte_hif_sdio_tx},	//                                
    {TXQ_Q6,		1,	mtlte_hif_sdio_tx_chk_pkt_num, 		mtlte_hif_sdio_tx},	//                                
};
...
static inline void mtlte_hif_test_drv_whisr_handle(sdio_whisr_enhance *p_enh_wxhisr)
{
    ...
    //                           
    if(attest_setting_param.testing_ulq_count == 1){ //                        
...
KAL_INT32 mtlte_hif_test_drv_hw_setting(void){
	...
	value = RX_ENHANC_MODE | W_INT_CLR_CTRL;  //                 
...
/*                                                       
	...
	if (hif_sdio_handler.data_buf_offset){  //                                    
    ...
    while(continue_check){
        ...
        if(0xFF != rxque_num_thistime){
			...
			if (cur_time >= monitor_time) {
				...
				if (rxq_workq_callback_user_time > 50) { //      
