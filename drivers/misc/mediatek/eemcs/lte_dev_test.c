...
int mtlte_dev_test_drvinit(void)
{
	...
	lte_testdev_tty_driver->major = 0; //           
	/*                                                           */	
    ...
    tst_idx = arg[0];
        ...
        for (q_num = 0 ; q_num < HIF_MAX_DLQ_NUM ; q_num ++) {
            ...
            switch (tst_idx) {
				case 0:	  //                                 
					p_tgpd_cfg->tgpd_format.tgpd_ext_len = 0;
					p_tgpd_cfg->tgpd_format.tgpd_buf_len = 0; //                                 
					p_tgpd_cfg->tgpd_format.tbd_num = 0;
					normal_pkt_cnt = 0;
					err_pkt = 1;
					break; 
				...
				case 3:	//                                                
					p_tgpd_cfg->tgpd_format.tgpd_ext_len = 10;
					p_tgpd_cfg->tgpd_format.tgpd_buf_len = 10; //                                 
					p_tgpd_cfg->tgpd_format.tbd_num = 1;
...
#define SDIOMB_BOOT_REQ_MAGIC 0x53444254 //       
#define SDIOMB_BOOT_ACK_MAGIC 0x53425400 //       
#define SDIOMB_DOWNLOAD_REQ_MAGIC 0x5344444C //       
#define SDIOMB_DOWNLOAD_ACK_MAGIC 0x53444C00 //       
#define SDIOMB_REQ_REFUSE_MAGIC 0x52454655 //       
