...
#define MT_LTE_SDIO_DEVICE_ID           (0x6290) //                 

//              
#define WHISR_INT_MASK					(0xFFFFFFDE)  //                            
...
//                                                                       
/*                       */
#define MT_LTE_SDIO_BLOCK_SIZE		(0x100)//     

#define MT_LTE_SDIO_ALIGN_BLOCK_SIZE_A		(MT_LTE_SDIO_BLOCK_SIZE-1)//      
