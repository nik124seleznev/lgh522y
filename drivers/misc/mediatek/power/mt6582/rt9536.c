...
#define MSET_UDELAY_L 2000	/*                                   */
#define MSET_UDELAY_H 2100

#define START_UDELAY_L 100	/*                                        */
#define START_UDELAY_H 150

#define ISET_UDELAY 150		/*                                            */

#define HVSET_UDELAY 760	/*                                           */
...
struct rt9536_platform_data pdata_rev_c = {
	.en_set = (GPIO40 | 0x80000000),	/*                 */
	.chgsb = GPIO_EINT_CHG_STAT_PIN,	/*                */
	.hv_enable = 1,				/*               */
};
#endif

struct rt9536_platform_data pdata_default = {
	.en_set = GPIO_CHR_CE_PIN,		/*                 */
	.chgsb = GPIO_EINT_CHG_STAT_PIN,	/*                */
	.hv_enable = 1,				/*               */
};
