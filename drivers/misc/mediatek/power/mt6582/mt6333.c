...
void read_adc_value(int index)
{
    ...
    {   
        printk("Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n", 
                ...
                0x6E, mt6333_get_reg_value(0x6E), //             
                0x75, mt6333_get_reg_value(0x75),
                0x70, mt6333_get_reg_value(0x70), //           
                0x71, mt6333_get_reg_value(0x71), //             
                0x6F, mt6333_get_reg_value(0x6F), //                             
    ...
    else if(index == 1) //    
    {
        printk("Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n", 
                ...
                0x84, mt6333_get_reg_value(0x84), //             
                0x87, mt6333_get_reg_value(0x87), //           
                0x88, mt6333_get_reg_value(0x88), //             
                0x85, mt6333_get_reg_value(0x85), //                             
                0xA0, mt6333_get_reg_value(0xA0)
                );
    }
    else if(index == 2) //     
    {
        printk("Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n", 
                ...
                0x99, mt6333_get_reg_value(0x99), //             
                0x9C, mt6333_get_reg_value(0x9C), //           
                0x9D, mt6333_get_reg_value(0x9D), //             
                0xA0, mt6333_get_reg_value(0xA0)
                );
    }
    else 
...
{
    mt6333_config_interface(MT6333_TEST_OMUX_CON0, 1, 0x1, 7); //        
...
{
    mt6333_config_interface(MT6333_TEST_OMUX_CON2, 1, 0x1, 0); //                
...
{        
    ...
    mt6333_set_rg_chrwdt_wr(1); //                        
    mt6333_set_rg_chrwdt_td(0); //     
...
static DEVICE_ATTR(mt6333_dvt, 0664, show_mt6333_dvt, store_mt6333_dvt); //   
...
static DEVICE_ATTR(mt6333_access, 0664, show_mt6333_access, store_mt6333_access); //   
