...
#define UNIT_FGTIME        (16)         //      
#define UNIT_FGCHARGE      (21961412)     //                       
...
//                                     
    ...
    oam_car_1 = (oam_i_1*10/3600) + oam_car_1; //      
    oam_car_2 = (oam_i_2*10/3600) + oam_car_2; //      
...
/*                                                                              
                                                                              ...
                                                                              */
#define FG_VBAT_AVERAGE_SIZE 36 //                 
...
kal_int32 fgauge_precharge_compensated_voltage(kal_int32 recursion_time)
{
    ...
    for(i=0 ; i < recursion_time ; i++)
    {
        bat_res = fgauge_read_r_bat_by_v(temp_voltage_2); //    
...
kal_int32 get_dynamic_period(int first_use, int first_wakeup_time, int battery_capacity_level)
{
    ...
    else
    {
        ...
        I_sleep = ((g_car_wakeup-g_car_sleep)*3600)/g_last_time; //             
