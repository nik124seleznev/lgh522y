...
void DpEngine_COLORonInit(DISP_MODULE_ENUM module, void* __cmdq)
{
    ...
    if (g_color_bypass == 0)
    {
        DISP_REG_SET(cmdq, DISP_COLOR_CFG_MAIN + offset,(1<<29)); //            
        DISP_REG_SET(cmdq, DISP_COLOR_START + offset, 0x00000001); //           
    }
    else
    {
...
void DpEngine_COLORonConfig(DISP_MODULE_ENUM module, unsigned int srcWidth,unsigned int srcHeight, void* __cmdq)
{
    ...
    DISP_REG_SET(cmdq, DISP_COLOR_INTERNAL_IP_WIDTH + offset, srcWidth);  //             
    DISP_REG_SET(cmdq, DISP_COLOR_INTERNAL_IP_HEIGHT + offset, srcHeight); //              
...
static void ddp_color_bypass_color(int bypass, void* __cmdq)
{
    ...
    if (bypass)
    {
        DISP_REG_MASK(cmdq, DISP_COLOR_CFG_MAIN + offset, (1<<7), 0x00000080); //          
    }
    else
    {
        DISP_REG_MASK(cmdq, DISP_COLOR_CFG_MAIN + offset, (0<<7), 0x00000080); //          
    }
}
...
static int _color_bypass(DISP_MODULE_ENUM module, int bypass)
{
    ...
    if (bypass)
    {
        ...
        DISP_REG_SET(NULL, DISP_COLOR_CFG_MAIN + offset,(1<<7)); //           
        DISP_REG_SET(NULL, DISP_COLOR_START + offset, 0x00000003); //           
    }
    else
    {
        DISP_REG_SET(NULL, DISP_COLOR_CFG_MAIN + offset,(0<<7)); //            
        DISP_REG_SET(NULL, DISP_COLOR_START + offset, 0x00000001); //           

        //                                
        DISP_REG_SET(NULL, DISP_COLOR_CM1_EN + offset, 0x01);
        DISP_REG_SET(NULL, DISP_COLOR_CM2_EN + offset, 0x11);   //                            
    }
