...
int RDMAReset(unsigned idx) {
    ...
    DISP_REG_SET(idx * DISP_INDEX_OFFSET + DISP_REG_RDMA_MEM_GMC_SETTING_1 , 0x20);     //                 
    //                                                                                                       
#endif
                    ...
                    bool isRGBSwap)  //               
{
    ...
    unsigned int ultra_low_time = 6;      //              
    unsigned int pre_ultra_low_time = 8;  //              
    unsigned int pre_ultra_high_time = 9; //              
    ...
    if ((DISP_IsDecoupleMode()==0) || (gEnableUltra==1)) {
    	...
    	{
    		ultra_low_time = 4;      //              
    		pre_ultra_low_time = 6;  //              
    		pre_ultra_high_time = 7; //              
    	}
    	else if(gUltraLevel==1)
    	{
    		ultra_low_time = 5;      //              
    		pre_ultra_low_time = 7;  //              
    		pre_ultra_high_time = 8; //              
    	}
    	else if(gUltraLevel==2)
    	{
    		ultra_low_time = 6;      //              
    		pre_ultra_low_time = 8;  //              
    		pre_ultra_high_time = 9; //              
    	}
    }
