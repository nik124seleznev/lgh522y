...
enum WDMA_OUTPUT_FORMAT {
    WDMA_OUTPUT_FORMAT_RGB565  = 0x00,   //             
    ...
    WDMA_OUTPUT_FORMAT_BGR888  = 0xa0,   //                       
...
int WDMAReset(unsigned idx) {
    ...
    //                
    DISP_REG_SET(idx*DISP_INDEX_OFFSET+DISP_REG_WDMA_RST , 0x01);            //           
    ...
    DISP_REG_SET(idx*DISP_INDEX_OFFSET+DISP_REG_WDMA_ALPHA , 0x00);          //           
               ...
               unsigned char alpha) 
{
    ...
    if(WDMA_COLOR_SPACE_RGB == input_color_space &&
       WDMA_COLOR_SPACE_YUV == output_color_space) {        //                           
        mode = RGB2YUV_601;
    }
