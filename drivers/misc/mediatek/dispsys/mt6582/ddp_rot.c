...
unsigned g_src_mf_pitch;  //              
unsigned g_src_sf_pitch;  //             
                           ...
                           unsigned idx) //                       
{
    ...
    switch(src_format)
    {
    case ROT_SRC_FORMAT_YCBCR_420_3P_SW_SCAN:            //  
        mf_bkgd_wb = src_pitch;
        sf_bkgd_wb = mf_bkgd_wb / 2;
        break;

    case ROT_SRC_FORMAT_YCBCR_420_2P_SW_SCAN:            //  
        mf_bkgd_wb = src_pitch;
        sf_bkgd_wb = mf_bkgd_wb;
        break;

    case ROT_SRC_FORMAT_YCBCR_420_2P_HW_ISP_BLOCK:        //  
        mf_bkgd_wb = src_pitch * 32;
        sf_bkgd_wb = mf_bkgd_wb / 2;
        break;

    case ROT_SRC_FORMAT_YCBCR_420_2P_HW_VDO_BLOCK:        //  
        mf_bkgd_wb = src_pitch * 32;
        sf_bkgd_wb = mf_bkgd_wb / 2;
        break;

    case ROT_SRC_FORMAT_YCBCR_422_3P_SW_SCAN:            //  
        mf_bkgd_wb = src_pitch;
        sf_bkgd_wb = mf_bkgd_wb / 2;
        break;

    case ROT_SRC_FORMAT_YCBCR_422_2P_SW_SCAN:            //  
        mf_bkgd_wb = src_pitch;
        sf_bkgd_wb = mf_bkgd_wb;
        break;

    case ROT_SRC_FORMAT_YCBCR_422_I_SW_SCAN:            //  
        mf_bkgd_wb = src_pitch * 2;
        sf_bkgd_wb = 0;
        break;

    case ROT_SRC_FORMAT_YCBCR_422_I_HW_ISP_BLOCK:        //  
        mf_bkgd_wb = src_pitch * 64;
        sf_bkgd_wb = 0;
        break;

    case ROT_SRC_FORMAT_YCBCR_444_3P_SW_SCAN:            //  
        mf_bkgd_wb = src_pitch;
        sf_bkgd_wb = mf_bkgd_wb;
        break;

    case ROT_SRC_FORMAT_YCBCR_444_2P_SW_SCAN:            //  
        mf_bkgd_wb = src_pitch;
        sf_bkgd_wb = mf_bkgd_wb;
        break;

    case ROT_SRC_FORMAT_RGB565:                        //   
        mf_bkgd_wb = src_pitch * 2;
        sf_bkgd_wb = 0;
        break;

    case ROT_SRC_FORMAT_RGB888:                        //   
        mf_bkgd_wb = src_pitch * 3;
        sf_bkgd_wb = 0;
        break;

    case ROT_SRC_FORMAT_XRGB8888:                        //   
    case ROT_SRC_FORMAT_RGBX8888:                        //   
...
/*                                                               
    ...
    {
        int align_width = src_width;   //              
        int align_height = src_height; //              
        ...
        g_src_width = align_width; //              
        g_src_height = align_height;  //              
    }
    ...
    if (src_format >= ROT_SRC_FORMAT_RGB565 && src_format <= ROT_SRC_FORMAT_RGBX8888)
    {
        ...
        DISP_REG_SET(DISP_REG_ROT_TRANSFORM_3, 0x02590132); //       
        DISP_REG_SET(DISP_REG_ROT_TRANSFORM_4, 0x1f530075); //       
        DISP_REG_SET(DISP_REG_ROT_TRANSFORM_5, 0x02001ead); //       
        DISP_REG_SET(DISP_REG_ROT_TRANSFORM_6, 0x1e530200); //       
        DISP_REG_SET(DISP_REG_ROT_TRANSFORM_7, 0x00001fad); //   
