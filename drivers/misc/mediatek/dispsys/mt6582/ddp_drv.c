...
static int disp_probe(struct platform_device *pdev)
{
    ...
    for(i = 0 ; i < CMDQ_THREAD_NUM ; i++)
    {
        ...
        //                      
        DISP_REG_SET(DISP_REG_CMDQ_THRx_IRQ_FLAG_EN(i),0x13); //                     
    }
