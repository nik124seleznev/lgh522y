...
//                                     
	{0xA5, 3, {0x00,0x13,0x01}},		//    
	{0x01, 2, {0x65,0x02}},		//    
	{0x1F, 3, {0x07,0x6A,0x01}},		//         
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0X0001, 1, {0x0000}},	//        
	{0X0113, 2, {0x00A5,0x0000}},		//    
	{0X0265, 1, {0x0001}},		//    
	{0X016A, 2, {0x001F,0x0007}},		//         
...
static LCM_setting_table_V3 lcm_initialization_setting_V3[] = {	
	...
	{0x29,0x01, 3, {0x00,0x65,0x02}}, //     
	{0x29,0xA5, 3, {0x00,0x13,0x01}}, //    
	{0x29,0x03, 4, {0x07,0x6A,0x01}}, //         
...
static struct pwm_spec_config pwm_setting = {
		...
		.PWM_MODE_OLD_REGS.WAVE_NUM = 0,                /*                                         */    
           /*                                                             */
		.clk_div = CLK_DIV4,            
		.PWM_MODE_OLD_REGS.DATA_WIDTH = 138,//                       
