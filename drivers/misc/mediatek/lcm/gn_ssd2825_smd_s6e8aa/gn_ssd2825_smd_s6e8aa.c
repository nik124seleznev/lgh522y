...
#define LSDI_GPIO_PIN                 (GPIO_DISP_LSA0_PIN) //        

#define SSD2825_SHUT_GPIO_PIN         (GPIO_SSD2825_SHUT_PIN)   //         
#define SSD2825_POWER_GPIO_PIN        (GPIO_SSD2825_POWER_PIN)  //         
#define SSD2825_MIPI_CLK_GPIO_PIN     (GPIO_SSD2825_CLK_PIN)      //        
#define LCD_POWER_GPIO_PIN            (GPIO_LCD_POWER_PIN)         //          
...
struct __gamma_backlight {
    ...
    unsigned char gammaValue[GAMMABACKLIGHT_NUM]; //                         
};
