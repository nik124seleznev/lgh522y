...
void IT6151_DPTX_init(void)
	...
	it6151_i2c_write_byte(DP_I2C_ADDR,0x09,INT_MASK);//                                 
	...
	it6151_i2c_write_byte(DP_I2C_ADDR,0x06,0xFF);//                    
	it6151_i2c_write_byte(DP_I2C_ADDR,0x07,0xFF);//                    
	it6151_i2c_write_byte(DP_I2C_ADDR,0x08,0xFF);//                    
...
#endif
		it6151_i2c_write_byte(DP_I2C_ADDR,0x05,0x04);//            
