...
static void init_lcm_registers(void)
{
    ...
    MDELAY(POWER_ON_SEQ_DELAY);
    set_lcm_register(0x12, 0x01B9);     //                 
    MDELAY(POWER_ON_SEQ_DELAY);
    set_lcm_register(0x13, 0x0A00);     //                            
    MDELAY(POWER_ON_SEQ_DELAY);
    set_lcm_register(0x29, 0x0006);     //                   
    MDELAY(POWER_ON_SEQ_DELAY);
