...
static void init_lcm_registers(void)
{
    ...
    set_lcm_register(0xB600,0x30);//         
    set_lcm_register(0xB602,0x30);
    set_lcm_register(0xB100,0xA7);//              
    set_lcm_register(0xC700,0x8F);//    
    set_lcm_register(0x3A00,0x06);//                         


    set_lcm_register(0xE000,0x0E);//               
