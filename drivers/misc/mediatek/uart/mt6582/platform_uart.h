...
/*                                                                           */
#define UART_RBR             (base+0x00) /*           */
#define UART_THR             (base+0x00) /*            */
#define UART_IER             (base+0x04)
#define UART_IIR             (base+0x08) /*           */
#define UART_FCR             (base+0x08) /*            */
...
#define UART_DLL             (base+0x00) /*                        */
#define UART_DLH             (base+0x04) /*                        */
#define UART_EFR             (base+0x08) /*                      */
#define UART_XON1            (base+0x10) /*                      */
#define UART_XON2            (base+0x14) /*                      */
#define UART_XOFF1           (base+0x18) /*                      */
#define UART_XOFF2           (base+0x1c) /*                      */
