...
void AudDrv_Clk_On(void)
{
    ...
    if (Aud_AFE_Clk_cntr == 0)
    {
        ...
        Afe_Set_Reg(AUDIOAFE_TOP_CON0, 0x60004000, 0xffffffff);  //                   
#else
        Afe_Set_Reg(AUDIOAFE_TOP_CON0, 0x60004000, 0xffffffff);  //                   
#endif
    }
...
void AudDrv_Suspend_Clk_On(void)
{
    ...
    if (Aud_AFE_Clk_cntr > 0)
    {
        ...
        //                                                                                                 
#else
        Afe_Set_Reg(AUDIOAFE_TOP_CON0, 0x00004000, 0x00004044); //                                       
#endif
    }
    spin_unlock_irqrestore(&auddrv_Clk_lock, flags);
...
#else
        Afe_Set_Reg(AUDIOAFE_TOP_CON0, 0x00000040, 0x00000040);  //                  
#endif
    }
    Aud_I2S_Clk_cntr++;
    spin_unlock_irqrestore(&auddrv_Clk_lock, flags);
...
#else
        Afe_Set_Reg(AUDIOAFE_TOP_CON0, 0x00000000, 0x00000040);  //                   
#endif
    }
