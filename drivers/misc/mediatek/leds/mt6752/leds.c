...
int mt_led_blink_pmic(enum mt65xx_led_pmic pmic_type, struct nled_setting *led)
{
	...
	switch(pmic_type){
		case MT65XX_LED_PMIC_NLED_ISINK0:
			...
			mt6325_upmu_set_isink_ch0_step(ISINK_1);//   
...
static ISINK0_LED_Breathmode_set_table led_scene_setting[] = {
	/*                                        */
	{0x01, 31, 999, 4, 10, 4, 10, 3, 0},//           
	{0x01, 31, 999,  1, 5, 1, 5, 3, 0},//           
	{0x01, 31, 999,  1, 5, 1, 5, 3, 0},//            
	{0x01, 31, 999,  0, 0, 0, 0, 0, 0},//        
	{0x01, 31, 999,  0, 1, 0, 1, 0, 0},//                 
	{0x01, 31, 999,  0, 0, 0, 0, 0, 0},//                        
	{0x01, 31, 999,  1, 2, 1, 2, 3, 2},//          
	{0x01, 31, 999,  0, 0, 0, 0, 4, 0},//                                                                        
	{0x01, 31, 999,  0, 0, 0, 0, 0, 4},//                                   
	{0x01, 31, 999,  1, 5, 1, 5, 3, 0},//          
};
