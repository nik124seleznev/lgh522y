...
static struct ssw_sys_entry mode_entry = {
    { .name = "mode", .mode = S_IRUGO | S_IWUSR }, //                         
    ssw_mode_show,
    ssw_mode_store,
};
...
static int extern_ssw_init(void) 
{
    ...
    mt_set_gpio_out(GPIO_EXT_SSW_EN, GPIO_OUT_ONE); //          
...
static int set_ext_sim_gpio(unsigned int mode)
{
    ...
    {
        case SINGLE_TALK_MDSYS:
            mt_set_gpio_out(GPIO_EXT_SSW_S1, GPIO_OUT_ONE);    //           
            mt_set_gpio_out(GPIO_EXT_SSW_S2, GPIO_OUT_ONE);    //           
            break;
        case SINGLE_TALK_MDSYS_LITE:
            mt_set_gpio_out(GPIO_EXT_SSW_S1, GPIO_OUT_ZERO);    //           
            mt_set_gpio_out(GPIO_EXT_SSW_S2, GPIO_OUT_ZERO);    //           
            break;
        case DUAL_TALK:
            mt_set_gpio_out(GPIO_EXT_SSW_S1, GPIO_OUT_ONE);   //           
            mt_set_gpio_out(GPIO_EXT_SSW_S2, GPIO_OUT_ZERO);   //           
