...
#define HI544_TEST_PATTERN_CHECKSUM (0xfc8d8b88)//                                
...
void HI544_write_shutter(kal_uint32 shutter)
{
    ...
    if(HI544.HI544AutoFlickerMode == KAL_TRUE)
    {
        ...
        if ( SENSOR_MODE_PREVIEW == HI544.sensorMode )  //                                                           
        {
        ...
        ASSERT(line_length < HI544_MAX_LINE_LENGTH);        //      
        ASSERT(frame_length < HI544_MAX_FRAME_LENGTH);     //      
...
void HI544PreviewSetting(void)
{
    ...
    HI544_write_cmos_sensor(0x0118, 0x0000); //        

    //              
    HI544_write_cmos_sensor(0x0B02, 0x0014); //      
    HI544_write_cmos_sensor(0x0B16, 0x4A8B); //                  
    ...
    HI544_write_cmos_sensor(0x090A, 0x01E4); //                    
    HI544_write_cmos_sensor(0x090C, 0x0005); //                          
    HI544_write_cmos_sensor(0x090E, 0x0100); //                         
    HI544_write_cmos_sensor(0x0910, 0x5D04); //           
    HI544_write_cmos_sensor(0x0912, 0x030f); //                   
    HI544_write_cmos_sensor(0x0914, 0x0204); //               
    HI544_write_cmos_sensor(0x0916, 0x0707); //                 
    HI544_write_cmos_sensor(0x0918, 0x0f04); //                

    //                                  
    HI544_write_cmos_sensor(0x0012, 0x00AA); //                        
    HI544_write_cmos_sensor(0x0018, 0x0ACB); //                                         
    HI544_write_cmos_sensor(0x0026, 0x0018); //                       
    HI544_write_cmos_sensor(0x002C, 0x07AF); //                                         

    //                                  
    HI544_write_cmos_sensor(0x0128, 0x0002); //                        
    HI544_write_cmos_sensor(0x012A, 0x0000); //                        
    HI544_write_cmos_sensor(0x012C, 0x0A20); //                         
    HI544_write_cmos_sensor(0x012E, 0x0798); //                          

    //                                     
    HI544_write_cmos_sensor(0x0110, 0x0510); //               
    HI544_write_cmos_sensor(0x0112, 0x03CC); //               

    //                               
    HI544_write_cmos_sensor(0x0006, 0x07e1); //                   
    HI544_write_cmos_sensor(0x0008, 0x0B40); //                  
    HI544_write_cmos_sensor(0x000A, 0x0DB0);

    //                               
    HI544_write_cmos_sensor(0x0000, 0x0100); //                                    
    HI544_write_cmos_sensor(0x0700, 0xA0A8); //                 
    HI544_write_cmos_sensor(0x001E, 0x0101); //      
    HI544_write_cmos_sensor(0x0032, 0x0101); //      
    HI544_write_cmos_sensor(0x0A02, 0x0100); //                        
    HI544_write_cmos_sensor(0x0A04, 0x0133); //            

    HI544_write_cmos_sensor(0x0118, 0x0100); //         
...
void HI544VideoSetting(void)
{
    ...
    //                                  
    HI544_write_cmos_sensor(0x0012, 0x00BA); //   
    HI544_write_cmos_sensor(0x0018, 0x0ABB); //                     
    HI544_write_cmos_sensor(0x0026, 0x0114); //   
    HI544_write_cmos_sensor(0x002C, 0x06b3); //                   

    //                                  
    HI544_write_cmos_sensor(0x0128, 0x0002); //                        
    HI544_write_cmos_sensor(0x012A, 0x0000); //                        
    HI544_write_cmos_sensor(0x012C, 0x0A00); //                         
    HI544_write_cmos_sensor(0x012E, 0x05A0); //                          

    //                                      
    HI544_write_cmos_sensor(0x0110, 0x0780); //               
    HI544_write_cmos_sensor(0x0112, 0x0438); //               

    //                               
    HI544_write_cmos_sensor(0x0006, 0x07C0); //                                      
    HI544_write_cmos_sensor(0x0008, 0x0B40); //                  
    HI544_write_cmos_sensor(0x000A, 0x0DB0); //                            
    //                                         

    //                               
    HI544_write_cmos_sensor(0x0700, 0x5090); //      
    HI544_write_cmos_sensor(0x001E, 0x0101); //      
    HI544_write_cmos_sensor(0x0032, 0x0101); //      
    HI544_write_cmos_sensor(0x0A02, 0x0100); //                        
    HI544_write_cmos_sensor(0x0A04, 0x0133); //                                                                                                               
...
void HI544CaptureSetting(void)
{
    ...
    //                                      
    HI544_write_cmos_sensor(0x0110, 0x0A20); //               
    HI544_write_cmos_sensor(0x0112, 0x0798); //               
    ...
    //                               
    HI544_write_cmos_sensor(0x0000, 0x0100); //                                    
    HI544_write_cmos_sensor(0x0700, 0x0590); //      
    HI544_write_cmos_sensor(0x001E, 0x0101); //      
    HI544_write_cmos_sensor(0x0032, 0x0101); //      
    HI544_write_cmos_sensor(0x0A02, 0x0100); //                        
    HI544_write_cmos_sensor(0x0A04, 0x011B); //                   
...
UINT32 HI544Open(void)
{
    ...
    HI544.ispBaseGain = BASEGAIN;//    
    HI544.sensorGlobalGain = 0x1f;//                                                   
    HI544.pvGain = 0x1f;
    HI544.realGain = 0x1f;//                 
    spin_unlock(&HI544mipiraw_drv_lock);
...
void HI544SetFlipMirror(kal_int32 imgMirror)
{
    ...
    {
        case IMAGE_NORMAL://            
            HI544_write_cmos_sensor(0x0000, 0x0000);//          
            break;
        case IMAGE_V_MIRROR://               
            HI544_write_cmos_sensor(0x0000, 0x0200);    //        
            break;
        case IMAGE_H_MIRROR://               
            HI544_write_cmos_sensor(0x0000, 0x0100);//          
            break;
        case IMAGE_HV_MIRROR://               
            HI544_write_cmos_sensor(0x0000, 0x0300);    //                 
            break;
    }
#endif
}
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch (ScenarioId)
    {
        ...
        case MSDK_SCENARIO_ID_CAMERA_ZSD:
            ...
            pSensorInfo->SensorGrabStartX = HI544_FULL_X_START;    //                               
            pSensorInfo->SensorGrabStartY = HI544_FULL_Y_START;    //                               
         ...
         case SENSOR_FEATURE_GET_SENSOR_VIEWANGLE:
             {
                 ...
                 *pHorFOV = (0x37)<<16 | (0x37); //                                       
                 *pVerFOV = (0x31)<<16 | (0x31); //                                       
                 *pFeatureParaLen = 8;
                 break;
             }
        //                                                                           
