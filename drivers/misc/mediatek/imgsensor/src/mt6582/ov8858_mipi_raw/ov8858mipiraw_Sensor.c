...
#define OV8858_write_cmos_sensor(addr, para) iWriteReg((u16) addr , (u32) para , 1, ov8858.write_id) //                                                                                                 
//                                                        
...
kal_uint16 OV8858_read_cmos_sensor(kal_uint32 addr)
{
    ...
    iReadReg((u16) addr ,(u8*)&get_byte,ov8858.write_id);   //                                                                                                 
    return get_byte;
}
...
void OV8858_Init_Para(void)
{
    ...
    ov8858.ispBaseGain = BASEGAIN;        //  
    ov8858.sensorGlobalGain = 0x0200;  //   
...
UINT32 OV8858_read_shutter(void)
{
    ...
    UINT32 shutter =0;
    temp_reg1 = OV8858_read_cmos_sensor(0x3500);    //             
    temp_reg2 = OV8858_read_cmos_sensor(0x3501);    //            
    temp_reg3 = OV8858_read_cmos_sensor(0x3502);    //           
...
void OV8858SetFlipMirror(kal_int32 imgMirror)
{
    ...
    {
        case IMAGE_H_MIRROR://             
            OV8858_write_cmos_sensor(0x3820, (mirror & (0xF9)));//          
            OV8858_write_cmos_sensor(0x3821, (flip & (0xF9)));    //          
            break;
        case IMAGE_NORMAL://               
            OV8858_write_cmos_sensor(0x3820, (mirror & (0xF9)));//        
            OV8858_write_cmos_sensor(0x3821, (flip | (0x06)));    //        
            break;
        case IMAGE_HV_MIRROR://               
            OV8858_write_cmos_sensor(0x3820, (mirror |(0x06)));    //          
            OV8858_write_cmos_sensor(0x3821, (flip & (0xF9)));    //          
            break;
        case IMAGE_V_MIRROR://                
            OV8858_write_cmos_sensor(0x3820, (mirror |(0x06)));    //                 
...
UINT32 OV8858SetVideoMode(UINT16 u2FrameRate)
{
    ...
    if(ov8858.sensorMode == SENSOR_MODE_VIDEO)//                          
    {
