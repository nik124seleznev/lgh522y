...
#define s5k3l2xx_master_clock                                24   //   

#define s5k3l2xx_max_analog_gain                            16
#define s5k3l2xx_min_analog_gain                            1

#define s5k3l2xx_preview_frame_length                       1844 //    
...
#define s5k3l2xx_capture_line_length                         8850 //           
#define s5k3l2xx_capture_pixelclock                          432000000


#define s5k3l2xx_video_frame_length                          1844 //    
