...
void S5K3L2XXInitSetting(void)
{
    ...
    S5K3L2XX_write_cmos_sensor1(0x602A,0x6010);//          
    ...
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x00BC); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x00BC); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x00BE); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x00BE); //                                    
    ...
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x5176); //                                 
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x2F76); //                                 
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x2F76); //                                 
    ...
    S5K3L2XX_write_cmos_sensor(0x6F12,0x48);    //                 
    ...
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x1106); //                     
    S5K3L2XX_write_cmos_sensor1(0x6028,0x7000);
    ...
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x4700); //                                     
    ...
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x03DA); //                                                
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x01D6); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x01BF); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0001); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0003); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x000A); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0022); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x000A); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0022); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x000A); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0022); //                                    
    ...
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0F00); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x4B00); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x8700); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0xC300); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0xFF00); //                                    
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0032); //                                    
    S5K3L2XX_write_cmos_sensor(0x6F12,0x42);    //                                    
    S5K3L2XX_write_cmos_sensor1(0x602A,0x3DAB);
    S5K3L2XX_write_cmos_sensor(0x6F12,0xFF);    //        
    S5K3L2XX_write_cmos_sensor1(0x602A,0x3DAC);
    S5K3L2XX_write_cmos_sensor(0x6F12,0x08);    //                                    
    ...
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x00FF); //                                    
    S5K3L2XX_write_cmos_sensor(0x6F12,0x00);    //                                    
...
#endif
    S5K3L2XX_write_cmos_sensor1(0x602A,0x3BCE);        //                        
    S5K3L2XX_write_cmos_sensor(0x6F12,0x30);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x3BCF);   //                        
    S5K3L2XX_write_cmos_sensor(0x6F12,0x10);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x304F);    //                           
    S5K3L2XX_write_cmos_sensor(0x6F12,0x01);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0342);      //           
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x1e80);            //           
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0340);    //                  
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0734);            //                        
    S5K3L2XX_write_cmos_sensor1(0x602A,0x034C);    //                                               
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0838);
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0618);    //                                               
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0114);
    S5K3L2XX_write_cmos_sensor(0x6F12,0x03);        //                                
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0344);    //                                              
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0004);    //                                              
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0004);
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x1073);    //                                            
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0C35);    //                                    
    S5K3L2XX_write_cmos_sensor1(0x602A,0x3010);    //                                     
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0000);
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0001);    //                                     
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0386);    //                                      
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0003);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0382);    //                                      
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0003);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0900);    //                            
    S5K3L2XX_write_cmos_sensor(0x6F12,0x01);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0901);    //                            
    S5K3L2XX_write_cmos_sensor(0x6F12,0x22);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0400);    //                                      
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0000);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0404);    //                                 
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0010);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0111);    //                                                   
    S5K3L2XX_write_cmos_sensor(0x6F12,0x02);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0112);    //                                                         
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0A0A);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x302A);    //                                                   
    S5K3L2XX_write_cmos_sensor(0x6F12,0x00);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0500);    //                                              
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0000);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x30DE);    //                                                 
    S5K3L2XX_write_cmos_sensor(0x6F12,0x01);    //                           
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0100);
    S5K3L2XX_write_cmos_sensor(0x6F12,0x01);
...
void S5K3L2XXCaptureSetting(void)
{
    ...
    S5K3L2XX_write_cmos_sensor(0x6F12,0x01);
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0342);
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x2292);   //                                           
    S5K3L2XX_write_cmos_sensor1(0x602A,0x0340);
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x0cb6);   //                  
    S5K3L2XX_write_cmos_sensor1(0x602A,0x034C);
    S5K3L2XX_write_cmos_sensor1(0x6F12,0x1070);   //                                                            
...
UINT32 S5K3L2XXGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
    ...
    pSensorResolution->SensorVideoWidth        = s5k3l2xx_preview_width; //                     
    pSensorResolution->SensorVideoHeight    = s5k3l2xx_preview_height;//                      
