...
#define OV5648MIPI_MIN_ANALOG_GAIN                  1   /*    */
#define OV5648MIPI_MAX_ANALOG_GAIN                  32  /*     */
...
/*                                         */
#define OV5648MIPI_FULL_PERIOD_PIXEL_NUMS          (2816) /*        */
#define OV5648MIPI_FULL_PERIOD_LINE_NUMS           (1984)

#define OV5648MIPI_PV_PERIOD_PIXEL_NUMS            (2816) /*        */
#define OV5648MIPI_PV_PERIOD_LINE_NUMS             (992)

#define OV5648MIPI_VIDEO_PERIOD_PIXEL_NUMS         (2816) /*        */
