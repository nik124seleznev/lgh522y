...
#define IMX091MIPI_MIN_ANALOG_GAIN                1    /*    */
#define IMX091MIPI_MAX_ANALOG_GAIN                8    /*     */
...
#define IMX091MIPI_PREVIEW_CLK 97200000  //        
#define IMX091MIPI_CAPTURE_CLK 168000000  //                     
#define IMX091MIPI_ZSD_PRE_CLK 97200000 //         
#define IMX091MIPI_VIDEO_CLK   97200000 //         
#else
#define IMX091MIPI_PREVIEW_CLK 225600000  //        
//                                                                  
//                                                    
//                                                                  
//                                                    
...
#if 0//                         
#define IMX091MIPI_CAPTURE_CLK 259200000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 259200000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          (5208)//                                                                     
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           (3316)//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         4208//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        3120//                                                                              
#endif
#ifdef PCLK_259200000
#define IMX091MIPI_CAPTURE_CLK 259200000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 259200000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          (5420)//                                                                     
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           (3146)//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         (4208-8)//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        (3120-4)//                                                                              
#endif

#ifdef PCLK_244800000
#define IMX091MIPI_CAPTURE_CLK 240000000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 240000000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          5220//                                                                                 
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           3146//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         (4208)//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        (3120)//                                                                              
#endif
...
#define IMX091MIPI_CAPTURE_CLK 240000000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 240000000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          5580//                                                                                 
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           3212//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         4208//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        3120//                                                                              
#endif
#if 0//                       
#define IMX091MIPI_CAPTURE_CLK 240000000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 240000000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          5020//                                                                                 
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           3146//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         4208//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        3120//                                                                              
#endif
...
#define IMX091MIPI_CAPTURE_CLK 240000000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 240000000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          5120//                                                                                 
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           3146//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         (4208-16)//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        (3120-12)//                                                                              
#endif
#ifdef PCLK_225600000//     
#define IMX091MIPI_CAPTURE_CLK 225600000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 225600000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          (4620)//                                                                     
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           (3212)//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         (4208-8)//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        (3120-4)//                                                                              
#endif
...
#define IMX091MIPI_CAPTURE_CLK 220800000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 220800000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          (4620)//                                                                     
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           (3212)//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         4208//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        3120//                                                                              
...
#define IMX091MIPI_CAPTURE_CLK 163200000  //                      
#define IMX091MIPI_ZSD_PRE_CLK 163200000 //         
#define IMX091MIPI_FULL_PERIOD_PIXEL_NUMS          (4620)//                                                                     
#define IMX091MIPI_FULL_PERIOD_LINE_NUMS           (3212)//                           
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         4208//                                                                                   
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        3120//                                                                              
#endif
#define IMX091MIPI_VIDEO_CLK   225600000 //         
#endif
...
#define IMX091MIPI_PV_PERIOD_PIXEL_NUMS            4620 //                 
#define IMX091MIPI_PV_PERIOD_LINE_NUMS             1610//          

#define IMX091MIPI_VIDEO_PERIOD_PIXEL_NUMS         4620 //                 
#define IMX091MIPI_VIDEO_PERIOD_LINE_NUMS          1370//          
...
#define IMX091MIPI_PV_PERIOD_PIXEL_NUMS            4620 //                 
#define IMX091MIPI_PV_PERIOD_LINE_NUMS             1606//          

#define IMX091MIPI_VIDEO_PERIOD_PIXEL_NUMS         4620 //                 
#define IMX091MIPI_VIDEO_PERIOD_LINE_NUMS          1606//          
#endif
...
#define IMX091MIPI_FULL_Y_START                    (2+16)    //                                                        
#define IMX091MIPI_IMAGE_SENSOR_FULL_WIDTH         (4208 - 208) /*      */
#define IMX091MIPI_IMAGE_SENSOR_FULL_HEIGHT        (3120 - 120) /*      */
#define IMX091MIPI_PV_X_START                      2

#define IMX091MIPI_PV_Y_START                      (2+8)    //                                                      
#define IMX091MIPI_IMAGE_SENSOR_PV_WIDTH           (2104 - 104)  //                          
#define IMX091MIPI_IMAGE_SENSOR_PV_HEIGHT          (1560 - 60)  //                    

#define IMX091MIPI_VIDEO_X_START                   2
#define IMX091MIPI_VIDEO_Y_START                   (2+8)
#define IMX091MIPI_IMAGE_SENSOR_VIDEO_WIDTH        (2104 - 104)//                      
#define IMX091MIPI_IMAGE_SENSOR_VIDEO_HEIGHT       (1184 - 60)//                      

#else

#define IMX091MIPI_FULL_X_START                    (0)//
#define IMX091MIPI_FULL_Y_START                    (0)//                                                                                      
//                                                                                                                  
//                                                                                                             
//                                                                                                                  
//                                                                                                             
...
#define IMX091MIPI_PV_Y_START                      (0)    //                                                      
#define IMX091MIPI_IMAGE_SENSOR_PV_WIDTH           (2104-8)  //                          
#define IMX091MIPI_IMAGE_SENSOR_PV_HEIGHT          (1560-4)  //                    


#define IMX091MIPI_VIDEO_X_START                      (0)
#define IMX091MIPI_VIDEO_Y_START                      (0)    //                                                      
#define IMX091MIPI_IMAGE_SENSOR_VIDEO_WIDTH           (2104-8)  //                          
#define IMX091MIPI_IMAGE_SENSOR_VIDEO_HEIGHT          (1560-4)  //                    
#if 0
#define IMX091MIPI_VIDEO_X_START                   (0)
#define IMX091MIPI_VIDEO_Y_START                   (0)
#define IMX091MIPI_IMAGE_SENSOR_VIDEO_WIDTH        (2104-8)//                      
#define IMX091MIPI_IMAGE_SENSOR_VIDEO_HEIGHT       (1184-8)//                      
#endif
#endif
...
#define IMX091MIPI_WRITE_ID   (0x20)  //      
#define IMX091MIPI_READ_ID    (0x21)  //      
