...
#define OV5645MIPI_MAX_AXD_GAIN (32) //             
#define OV5645MIPI_MAX_EXPOSURE_TIME (1968) //                          
static struct
{
	//                    
	kal_bool	  NightMode;
...
static BOOL AE_2_ARRAY[AE_HORIZONTAL_BLOCKS][AE_VERTICAL_BLOCKS] = {{FALSE},{FALSE},{FALSE},{FALSE}};//           
//                                                               
...
static void OV5645MIPIWriteShutter(kal_uint32 shutter)
{
	...
	if (shutter > OV5645MIPI_FULL_EXPOSURE_LIMITATION) 
	{
		...
		OV5645MIPI_write_cmos_sensor(0x380f, extra_exposure_vts & 0xFF);          //             
		OV5645MIPI_write_cmos_sensor(0x380e, (extra_exposure_vts & 0xFF00) >> 8); //              
...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x302c, 0x02);//             
	...
	OV5645MIPI_write_cmos_sensor(0x4800, 0x04);//                         
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x4202, 0x0f);//                   
	OV5645MIPI_write_cmos_sensor(0x300e, 0x45);//              
	OV5645MIPI_write_cmos_sensor(0x3034, 0x18);//                     
	OV5645MIPI_write_cmos_sensor(0x3035, 0x21);//    
	OV5645MIPI_write_cmos_sensor(0x3036, 0x70);//    
	...
	OV5645MIPI_write_cmos_sensor(0x380c, 0x07);//             
	OV5645MIPI_write_cmos_sensor(0x380d, 0x68);//      
	OV5645MIPI_write_cmos_sensor(0x380e, 0x06);//                  
	OV5645MIPI_write_cmos_sensor(0x380f, 0xEA);//      
	OV5645MIPI_write_cmos_sensor(0x3810, 0x00); //           
	OV5645MIPI_write_cmos_sensor(0x3811, 0x10); //      
	OV5645MIPI_write_cmos_sensor(0x3812, 0x00); //          
	OV5645MIPI_write_cmos_sensor(0x3813, 0x06);//        
	...
	OV5645MIPI_write_cmos_sensor(0x3a1e, 0x28);//                 
	OV5645MIPI_write_cmos_sensor(0x3a1f, 0x14);//                   
	OV5645MIPI_write_cmos_sensor(0x5302, 0x08);//                  
	OV5645MIPI_write_cmos_sensor(0x5303, 0x18);//              
	OV5645MIPI_write_cmos_sensor(0x5306, 0x18);//                 
	OV5645MIPI_write_cmos_sensor(0x5307, 0x10);//             
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x380d, 0xec);//      
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x20);//              
	OV5645MIPI_write_cmos_sensor(0x5306, 0x18);//                 
	OV5645MIPI_write_cmos_sensor(0x5307, 0x10);//            
	OV5645MIPI_write_cmos_sensor(0x4202, 0x00);//                   
	spin_lock(&ov5645mipi_drv_lock);
...
static void OV5645MIPIFullSizeZSDSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3a14, 0x12);//                   
	...
	OV5645MIPI_write_cmos_sensor(0x380c, 0x0b);//             
	OV5645MIPI_write_cmos_sensor(0x380d, 0xec);//      
	OV5645MIPI_write_cmos_sensor(0x380e, 0x08);//             
	OV5645MIPI_write_cmos_sensor(0x380f, 0x11);//      
	OV5645MIPI_write_cmos_sensor(0x3810, 0x00); //          
	OV5645MIPI_write_cmos_sensor(0x3811, 0x10); //     
	OV5645MIPI_write_cmos_sensor(0x3812, 0x00); //         
	OV5645MIPI_write_cmos_sensor(0x3813, 0x06);//         
...
UINT32 OV5645MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	switch (ScenarioId)
	{
		case MSDK_SCENARIO_ID_CAMERA_ZSD:
			pSensorInfo->SensorPreviewResolutionX=OV5645MIPI_IMAGE_SENSOR_SVGA_WIDTH-2*OV5645MIPI_FULL_GRAB_START_X;//                                     
			pSensorInfo->SensorPreviewResolutionY=OV5645MIPI_IMAGE_SENSOR_SVGA_HEIGHT-2*OV5645MIPI_FULL_GRAB_START_Y;//                                      
...
BOOL OV5645MIPI_set_param_wb(UINT16 para)
{
	...
	switch (para)
    {
        ...
        case AWB_MODE_CLOUDY_DAYLIGHT: //      
							...
							OV5645MIPI_write_cmos_sensor(0x3404,0x03); //  
        ...
        case AWB_MODE_INCANDESCENT: //              
							...
							OV5645MIPI_write_cmos_sensor(0x3401,0x80); //  
							OV5645MIPI_write_cmos_sensor(0x3402,0x04); 
							OV5645MIPI_write_cmos_sensor(0x3403,0x00); 
							OV5645MIPI_write_cmos_sensor(0x3404,0x07); //    
		...
		case AWB_MODE_TUNGSTEN:
							...
							OV5645MIPI_write_cmos_sensor(0x3402,0x04); 
							OV5645MIPI_write_cmos_sensor(0x3403,0x00); 
							OV5645MIPI_write_cmos_sensor(0x3404,0x08); //  
        ...
        case AWB_MODE_FLUORESCENT:
							...
							OV5645MIPI_write_cmos_sensor(0x3402,0x04); 
							OV5645MIPI_write_cmos_sensor(0x3403,0x00); 
							OV5645MIPI_write_cmos_sensor(0x3404,0x09); //  
							OV5645MIPI_write_cmos_sensor(0x3405,0x40);                       
							OV5645MIPI_write_cmos_sensor(0x3212,0x13); 
        	    			OV5645MIPI_write_cmos_sensor(0x3212,0xa3);                        
							break;
...
BOOL OV5645MIPI_set_param_effect(UINT16 para)
{
	...
	switch (para)
    {
				...
				OV5645MIPI_write_cmos_sensor(0x3212,0x03);
				OV5645MIPI_write_cmos_sensor(0x5580,0x1e);             
				OV5645MIPI_write_cmos_sensor(0x5583,0xb8); //   
...
UINT32 OV5645MIPIFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId,UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
			...
			{
				case MSDK_SCENARIO_ID_CAMERA_ZSD:
					*pFeatureReturnPara32 = OV5645MIPISensor.ZsdturePclk * 1000 *100;	 //            
					*pFeatureParaLen=4;
					break;
				default:
					*pFeatureReturnPara32 = OV5645MIPISensor.PreviewPclk * 1000 *100;	 //        
					*pFeatureParaLen=4;
					break;
			}
			break;
