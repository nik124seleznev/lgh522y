...
#if 1
#define OV5647MIPI_COLOR_FORMAT                    SENSOR_OUTPUT_FORMAT_RAW_B //                          
#else
#define OV5647MIPI_COLOR_FORMAT                    SENSOR_OUTPUT_FORMAT_RAW_Gr
#endif

#define OV5647MIPI_MIN_ANALOG_GAIN				1	/*    */
#define OV5647MIPI_MAX_ANALOG_GAIN				32	/*     */
...
/*                                         */
//                                                                   
#define OV5647MIPI_FULL_PERIOD_PIXEL_NUMS          (2752+100) /*        */
#define OV5647MIPI_FULL_PERIOD_LINE_NUMS           1974
#define OV5647MIPI_PV_PERIOD_PIXEL_NUMS            1896 /*        */
#define OV5647MIPI_PV_PERIOD_LINE_NUMS             984
#define OV5647MIPI_VIDEO_PERIOD_PIXEL_NUMS         2416 /*        */
#define OV5647MIPI_VIDEO_PERIOD_LINE_NUMS          1104



#define OV5647MIPI_FULL_X_START                    4   //        
#define OV5647MIPI_FULL_Y_START                    4  //        
#define OV5647MIPI_IMAGE_SENSOR_FULL_WIDTH         (2560 - 32) //                      
#define OV5647MIPI_IMAGE_SENSOR_FULL_HEIGHT        (1920 - 24) //                      
#define OV5647MIPI_PV_X_START                      2
#define OV5647MIPI_PV_Y_START                      2
#define OV5647MIPI_IMAGE_SENSOR_PV_WIDTH           (1280 - 16) /*      */
#define OV5647MIPI_IMAGE_SENSOR_PV_HEIGHT          (960 - 12) /*     */
#define OV5647MIPI_VIDEO_X_START                      2
#define OV5647MIPI_VIDEO_Y_START                      2
#define OV5647MIPI_IMAGE_SENSOR_VIDEO_WIDTH           (1920 - 16) /*      */
#define OV5647MIPI_IMAGE_SENSOR_VIDEO_HEIGHT          (1080 - 12) /*     */


#define OV5647MIPI_3D_FULL_PERIOD_PIXEL_NUMS          2700 /*        */
#define OV5647MIPI_3D_FULL_PERIOD_LINE_NUMS           1974
#define OV5647MIPI_3D_PV_PERIOD_PIXEL_NUMS            1896 /*        */
#define OV5647MIPI_3D_PV_PERIOD_LINE_NUMS             984
#define OV5647MIPI_3D_VIDEO_PERIOD_PIXEL_NUMS         2416 /*        */
#define OV5647MIPI_3D_VIDEO_PERIOD_LINE_NUMS          1104



#define OV5647MIPI_3D_FULL_X_START                    4   //        
#define OV5647MIPI_3D_FULL_Y_START                    4  //        
#define OV5647MIPI_IMAGE_SENSOR_3D_FULL_WIDTH         (2560 - 32) //                      
#define OV5647MIPI_IMAGE_SENSOR_3D_FULL_HEIGHT        (1920 - 24) //                      
#define OV5647MIPI_3D_PV_X_START                      2
#define OV5647MIPI_3D_PV_Y_START                      2
#define OV5647MIPI_IMAGE_SENSOR_3D_PV_WIDTH           (1280 - 16) /*      */
#define OV5647MIPI_IMAGE_SENSOR_3D_PV_HEIGHT          (960 - 12) /*     */
#define OV5647MIPI_3D_VIDEO_X_START                      2
#define OV5647MIPI_3D_VIDEO_Y_START                      2
#define OV5647MIPI_IMAGE_SENSOR_3D_VIDEO_WIDTH           (1920 - 16) /*      */
#define OV5647MIPI_IMAGE_SENSOR_3D_VIDEO_HEIGHT          (1080 - 12) /*     */
...
#define RG_TYPICAL 0x5B  //                       
#define BG_TYPICAL 0x5F  //                       
