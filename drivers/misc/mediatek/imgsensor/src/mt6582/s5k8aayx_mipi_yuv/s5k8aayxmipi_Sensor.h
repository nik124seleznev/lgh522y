...
//                                                                  
	//                                  
	#define S5K8AAYX_MIPI_CAM_NOM_MAX_FPS				300		//      
	#define S5K8AAYX_MIPI_CAM_NOM_MIN_FPS				100		//        
	#define S5K8AAYX_MIPI_CAM_NIT_MAX_FPS				300		//      
	#define S5K8AAYX_MIPI_CAM_NIT_MIN_FPS				50		//       

#ifdef MIPI_INTERFACE
	#define S5K8AAYX_MIPI_VID_NOM_FIX_FPS			300		//      
#else
	#define S5K8AAYX_MIPI_VID_NOM_FIX_FPS			250//             
#endif

	#define S5K8AAYX_MIPI_VID_NIT_FIX_FPS			150		//      
...
/*                                         */
#define S5K8AAYX_MIPI_SXGA_PERIOD_PIXEL_NUMS               2175         /*      */
#define S5K8AAYX_MIPI_SXGA_PERIOD_LINE_NUMS                1607         /*      */
