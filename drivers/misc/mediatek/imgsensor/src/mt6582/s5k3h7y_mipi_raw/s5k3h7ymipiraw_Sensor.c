...
static inline kal_uint32 GetScenarioLinelength(void)
{
	...
	switch(s_S5K3H7YCurrentScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_CAMERA_ZSD:
			u4Linelength=S5K3H7Y_ZSD_PERIOD_PIXEL_NUMS; //                     
		break;
...
static inline kal_uint32 GetScenarioFramelength(void)
{
	...
	switch(s_S5K3H7YCurrentScenarioId)
	{
		...
		break;
		case MSDK_SCENARIO_ID_CAMERA_ZSD:
			u4Framelength=S5K3H7Y_ZSD_PERIOD_LINE_NUMS; //                     
		break;
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
...
static void S5K3H7YInitSetting(void)
{
  ...
  //         
	...
	S5K3H7Y_wordwrite_cmos_sensor(0x0114,0x01);	//                              
	#endif
	S5K3H7Y_wordwrite_cmos_sensor(0x0086,0x01FF);	//                       
	S5K3H7Y_wordwrite_cmos_sensor(0x0136,0x1800);	//                                          
	S5K3H7Y_wordwrite_cmos_sensor(0x0300,0x0002);	//                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x0302,0x0001);	//                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x0304,0x0006);	//                                   
    S5K3H7Y_wordwrite_cmos_sensor(0x0306,0x008C);    //                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x0308,0x0008);	//                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x030A,0x0001);	//                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x030C,0x0006);	//                                         
   	S5K3H7Y_wordwrite_cmos_sensor(0x030E,0x00A2);    //                                        
    S5K3H7Y_wordwrite_cmos_sensor(0x311C,0x0BB8);   //                                              
    S5K3H7Y_wordwrite_cmos_sensor(0x311E,0x0BB8);   //                                              
	S5K3H7Y_wordwrite_cmos_sensor(0x034C,0x0660);	//                                       
	S5K3H7Y_wordwrite_cmos_sensor(0x034E,0x04C8);	//                                       
	S5K3H7Y_wordwrite_cmos_sensor(0x0380,0x0001);	//                                   
	S5K3H7Y_wordwrite_cmos_sensor(0x0382,0x0003);	//                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x0384,0x0001);	//                                   
	S5K3H7Y_wordwrite_cmos_sensor(0x0386,0x0003);	//                                  

	S5K3H7Y_wordwrite_cmos_sensor(0x0112,0x0A0A);	  //             
	//                                                                                     
	S5K3H7Y_bytewrite_cmos_sensor(0x300D,0x02);	      //                     

	S5K3H7Y_bytewrite_cmos_sensor(0x0900,0x0001);	//                          
	S5K3H7Y_bytewrite_cmos_sensor(0x0901,0x0022);	//                          
	S5K3H7Y_bytewrite_cmos_sensor(0x0902,0x0001);	//                               
	S5K3H7Y_wordwrite_cmos_sensor(0x0342,S5K3H7Y_PV_PERIOD_PIXEL_NUMS);	//                                         
	S5K3H7Y_wordwrite_cmos_sensor(0x0340,S5K3H7Y_PV_PERIOD_LINE_NUMS);	//                                            
	S5K3H7Y_wordwrite_cmos_sensor(0x0200,0x0BEF);	  //                                                   
	S5K3H7Y_wordwrite_cmos_sensor(0x0202,0x09D9);	  //                                                     

	S5K3H7Y_bytewrite_cmos_sensor(0x37F8,0x0001);	  //                                                                       
	s5k3h7y.sensorBaseGain=64;

	S5K3H7Y_wordwrite_cmos_sensor(0x0204,0x0020);	//   
	S5K3H7Y_bytewrite_cmos_sensor(0x0B05,0x0001);	  //                                               
	S5K3H7Y_bytewrite_cmos_sensor(0x0B00,0x0000);	  //                                           
	S5K3H7Y_bytewrite_cmos_sensor(0x0100,0x0001);	  //                                      
	#if 0  //                             
...
void S5K3H7YPreviewSetting(void)
{
	//         
        ...
        S5K3H7Y_wordwrite_cmos_sensor(0x034C,0x0660);   //                                       
        S5K3H7Y_wordwrite_cmos_sensor(0x034E,0x04C8);   //                                       
        S5K3H7Y_wordwrite_cmos_sensor(0x0344,0x0004);   //                                      
        S5K3H7Y_wordwrite_cmos_sensor(0x0346,0x0004);   //                                      
        S5K3H7Y_wordwrite_cmos_sensor(0x0348,0x0CC3);   //                                    
        ...
        S5K3H7Y_wordwrite_cmos_sensor(0x0204,0x0020);   //   
        S5K3H7Y_bytewrite_cmos_sensor(0x0B05,0x01  ); //                                               
        S5K3H7Y_bytewrite_cmos_sensor(0x0B00,0x00  ); //                                           
        S5K3H7Y_wordwrite_cmos_sensor(0x0112,0x0A0A);     //             
		//                                                                                   
        S5K3H7Y_bytewrite_cmos_sensor(0x300D,0x02);        //                              
        S5K3H7Y_bytewrite_cmos_sensor(0x0100,0x01  ); //                                      
	#else 
			SENSORDB("preview stting enter\n");
	/*
...
void S5K3H7YCaptureSetting(void)
{
	...
	S5K3H7Y_wordwrite_cmos_sensor(0x0348,0x0CC3);	//                                    
	S5K3H7Y_wordwrite_cmos_sensor(0x034A,0x0993);	//                                    
	S5K3H7Y_wordwrite_cmos_sensor(0x0342,S5K3H7Y_FULL_PERIOD_PIXEL_NUMS);	//                                         
	S5K3H7Y_wordwrite_cmos_sensor(0x0340,S5K3H7Y_FULL_PERIOD_LINE_NUMS);	//                                            
	SENSORDB("[0x0342,%d],[0x0340,%d]\n",S5K3H7Y_read_cmos_sensor(0x0342),S5K3H7Y_read_cmos_sensor(0x0340));
	S5K3H7Y_wordwrite_cmos_sensor(0x0380,0x0001);	//                                   
	S5K3H7Y_wordwrite_cmos_sensor(0x0382,0x0001);	//                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x0384,0x0001);	//                                   
	S5K3H7Y_wordwrite_cmos_sensor(0x0386,0x0001);	//                                  
	S5K3H7Y_bytewrite_cmos_sensor(0x0900,0x0000);	//                          
	S5K3H7Y_bytewrite_cmos_sensor(0x0901,0x0000);	//                          
	S5K3H7Y_bytewrite_cmos_sensor(0x0902,0x0000);	//                               
...
void S5K3H7YVideoSetting(void)
{
	...
	#if 0
	S5K3H7Y_bytewrite_cmos_sensor(0x0100,0x00  ); //                                      
	S5K3H7Y_wordwrite_cmos_sensor(0x034C,S5K3H7Y_IMAGE_SENSOR_VIDEO_WIDTH_SETTING);	//                                       
	S5K3H7Y_wordwrite_cmos_sensor(0x034E,S5K3H7Y_IMAGE_SENSOR_VIDEO_HEIGHT_SETTING);	//                                       
	S5K3H7Y_wordwrite_cmos_sensor(0x0344,0x0004);	//                                      
	S5K3H7Y_wordwrite_cmos_sensor(0x0346,0x0136);	//                                      
	S5K3H7Y_wordwrite_cmos_sensor(0x0348,S5K3H7Y_IMAGE_SENSOR_VIDEO_WIDTH_SETTING+3);	//                                    
	S5K3H7Y_wordwrite_cmos_sensor(0x034A,S5K3H7Y_IMAGE_SENSOR_VIDEO_HEIGHT_SETTING+0x135);	//                                    
	S5K3H7Y_wordwrite_cmos_sensor(0x0342,S5K3H7Y_VIDEO_PERIOD_PIXEL_NUMS);	//                                         
	S5K3H7Y_wordwrite_cmos_sensor(0x0340,S5K3H7Y_VIDEO_PERIOD_LINE_NUMS);	//                                            
	SENSORDB("[0x0342,%d],[0x0340,%d]\n",S5K3H7Y_read_cmos_sensor(0x0342),S5K3H7Y_read_cmos_sensor(0x0340));
	S5K3H7Y_wordwrite_cmos_sensor(0x0380,0x0001);	//                                   
	S5K3H7Y_wordwrite_cmos_sensor(0x0382,0x0001);	//                                  
	S5K3H7Y_wordwrite_cmos_sensor(0x0384,0x0001);	//                                   
...
UINT32 S5K3H7YGetSensorID(UINT32 *sensorID)
{
	...
	s5k3h7y.sensorGain = 0x1f;//                                                   
	s5k3h7y.pvGain = 0x1f*3; //                           
