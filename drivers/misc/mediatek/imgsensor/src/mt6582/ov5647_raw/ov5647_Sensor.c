...
#define OV5647_TEST_PATTERN_CHECKSUM     (0x22204ce1)
//                           
//                    
...
static void OV5647_camera_para_to_sensor(void)
{
  ...
  OV5647_SetGain(OV5647_sensor.gain); /*             */
}
...
static void OV5647_Sensor_Init(void)
{
	...
	OV5647_write_cmos_sensor(0x3013, 0x08);//                                         
	...
	OV5647_write_cmos_sensor(0x5001, 0x01);  //                 
	...
	OV5647_write_cmos_sensor(0x3035, 0x21); /*             */
	OV5647_write_cmos_sensor(0x3036, 0x4a); /*       */
...
static void OV5647_Sensor_1M(void)
{
	...
	//                                                            
	//                                                               
			OV5647_write_cmos_sensor(0x4005, 0x18);//                                    
	...
	//                                                         
	//                                                             
    OV5647_write_cmos_sensor(0x3821, 0x00); /*                  */
    OV5647_write_cmos_sensor(0x3820, 0x47); /*                  */
	OV5647_write_cmos_sensor(0x370c, 0x03); /*          */
	OV5647_write_cmos_sensor(0x3612, 0x09); /*          */
	OV5647_write_cmos_sensor(0x3618, 0x00); /*          */
	OV5647_write_cmos_sensor(0x380c, 0x07); /*                   */
	OV5647_write_cmos_sensor(0x380d, 0x68); /*                 */
	OV5647_write_cmos_sensor(0x380e, 0x03); /*                   */
	OV5647_write_cmos_sensor(0x380f, 0xd8); /*                */
	OV5647_write_cmos_sensor(0x3814, 0x31); /*              */
	OV5647_write_cmos_sensor(0x3815, 0x31); /*              */
	OV5647_write_cmos_sensor(0x3708, 0x22); /*          */
	OV5647_write_cmos_sensor(0x3709, 0x52); /*          */
	OV5647_write_cmos_sensor(0x3815, 0x31); /*         */
	OV5647_write_cmos_sensor(0x3808, 0x05); /*                             */
	OV5647_write_cmos_sensor(0x3809, 0x10); /*                            */
	OV5647_write_cmos_sensor(0x380a, 0x03); /*                              */
	OV5647_write_cmos_sensor(0x380b, 0xcc); /*                           */
	OV5647_write_cmos_sensor(0x3800, 0x00); /*                     */
	OV5647_write_cmos_sensor(0x3801, 0x08); /*                     */
	OV5647_write_cmos_sensor(0x3802, 0x00); /*                     */
	OV5647_write_cmos_sensor(0x3803, 0x02); /*                     */
	OV5647_write_cmos_sensor(0x3804, 0x0a); /*                    */
	OV5647_write_cmos_sensor(0x3805, 0x37); /*                    */
	OV5647_write_cmos_sensor(0x3806, 0x07); /*                    */
	OV5647_write_cmos_sensor(0x3807, 0xa1); /*                    */
	...
	OV5647_write_cmos_sensor(0x4004, 0x02); /*             */
	//                                        
	...
	OV5647_write_cmos_sensor(0x3036, 0x3D); /*         */
	OV5647_write_cmos_sensor(0x3037, 0x03); /*           */
	...
	OV5647_write_cmos_sensor(0x3034, 0x1a); /*           */
	OV5647_write_cmos_sensor(0x3035, 0x11); /*             */
	OV5647_write_cmos_sensor(0x3036, 0x3F); /*        */
	OV5647_write_cmos_sensor(0x3037, 0x03); /*           */
	...
	OV5647_write_cmos_sensor(0x3034, 0x1a); /*           */
	OV5647_write_cmos_sensor(0x3035, 0x11); /*             */
	OV5647_write_cmos_sensor(0x3036, 0x41); /*         */
	OV5647_write_cmos_sensor(0x3037, 0x03); /*           */
...
static void OV5647_Sensor_5M(void)
{
	...
	//                                                               
	//                                                             
	OV5647_write_cmos_sensor(0x380c, 0x0b); /*                   */
	OV5647_write_cmos_sensor(0x380d, 0xef); /*                 */
	OV5647_write_cmos_sensor(0x380e, 0x07); /*                   */
	OV5647_write_cmos_sensor(0x380f, 0xb0); /*                 */	
	...
	OV5647_write_cmos_sensor(0x3808, 0x0a); /*                             */
	OV5647_write_cmos_sensor(0x3809, 0x00); /*                           */
	OV5647_write_cmos_sensor(0x380a, 0x07); /*                            */
	OV5647_write_cmos_sensor(0x380b, 0x80); /*                           */
	OV5647_write_cmos_sensor(0x3800, 0x00); /*                     */
	OV5647_write_cmos_sensor(0x3801, 0x20); /*                     */
	OV5647_write_cmos_sensor(0x3802, 0x00); /*                     */
	OV5647_write_cmos_sensor(0x3803, 0x12); /*                     */
	OV5647_write_cmos_sensor(0x3804, 0x0a); /*                    */
	OV5647_write_cmos_sensor(0x3805, 0x40); /*                    */
	OV5647_write_cmos_sensor(0x3806, 0x07); /*                    */
	OV5647_write_cmos_sensor(0x3807, 0xa4); /*                    */
...
static void OV5647_Sensor_5M_15fps(void)
{
	...
	//                                                          
	OV5647_write_cmos_sensor( 0x0100, 0x00); 	//     
	OV5647_write_cmos_sensor(0x4005, 0x1a); //                  
	...
	OV5647_write_cmos_sensor( 0x380d, 0x8c); //    
	OV5647_write_cmos_sensor( 0x380e, 0x07); 
	OV5647_write_cmos_sensor( 0x380f, 0xb0);//     
	OV5647_write_cmos_sensor( 0x3814, 0x11); 
	OV5647_write_cmos_sensor( 0x3815, 0x11); 
	...
	OV5647_write_cmos_sensor(0x3808, 0x0a); /*                             */
	OV5647_write_cmos_sensor(0x3809, 0x20); /*                           */
	OV5647_write_cmos_sensor(0x380a, 0x07); /*                            */
	OV5647_write_cmos_sensor(0x380b, 0x98); /*                           */
	OV5647_write_cmos_sensor(0x3800, 0x00); /*                     */
	OV5647_write_cmos_sensor(0x3801, 0x0c); /*                     */
	OV5647_write_cmos_sensor(0x3802, 0x00); /*                     */
	OV5647_write_cmos_sensor(0x3803, 0x04); /*                     */
	OV5647_write_cmos_sensor(0x3804, 0x0a); /*                    */
	OV5647_write_cmos_sensor(0x3805, 0x33); /*                    */
	OV5647_write_cmos_sensor(0x3806, 0x07); /*                    */
	OV5647_write_cmos_sensor(0x3807, 0xa3); /*                    */
...
UINT32 OV5647Open(void)
{
	...
	OV5647_sensor.Prv_line_length = OV5647_PV_PERIOD_PIXEL_NUMS;//       
	spin_unlock(&ov5647_drv_lock);
	return ERROR_NONE;
}   /*             */
