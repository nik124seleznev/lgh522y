...
#define OV8858S_write_cmos_sensor(addr, para) iWriteReg((u16) addr , (u32) para , 1, OV8858S.write_id) //                                                                                                 
//                                                        
...
kal_uint16 OV8858S_read_cmos_sensor(kal_uint32 addr)
{
	...
	iReadReg((u16) addr ,(u8*)&get_byte,OV8858S.write_id);   //                                                                                                 
    return get_byte;
}
...
//                                                          
kal_uint16 RG_Ratio_typical = 0x146; //          
kal_uint16 BG_Ratio_typical = 0x12a;//          
...
void OV8858S_Init_Para(void)
{
	...
	OV8858S.ispBaseGain = BASEGAIN;		//  
	OV8858S.sensorGlobalGain = 0x0200;  //   
...
UINT32 OV8858S_read_shutter(void)
{
	...
	UINT32 shutter =0;
	temp_reg1 = OV8858S_read_cmos_sensor(0x3500);    //             
	temp_reg2 = OV8858S_read_cmos_sensor(0x3501);    //            
	temp_reg3 = OV8858S_read_cmos_sensor(0x3502);    //           
...
void OV8858SSetFlipMirror(kal_int32 imgMirror)
{
    ...
    {
        case IMAGE_H_MIRROR://             
            OV8858S_write_cmos_sensor(0x3820, (mirror & (0xF9)));//          
            OV8858S_write_cmos_sensor(0x3821, (flip & (0xF9)));	//          
            break;
        case IMAGE_NORMAL://               
            OV8858S_write_cmos_sensor(0x3820, (mirror & (0xF9)));//        
            OV8858S_write_cmos_sensor(0x3821, (flip | (0x06)));	//        
            break;
        case IMAGE_HV_MIRROR://               
            OV8858S_write_cmos_sensor(0x3820, (mirror |(0x06)));	//          
            OV8858S_write_cmos_sensor(0x3821, (flip & (0xF9)));	//          
            break;
        case IMAGE_V_MIRROR://                
            OV8858S_write_cmos_sensor(0x3820, (mirror |(0x06)));	//                 
...
UINT32 OV8858SSetVideoMode(UINT16 u2FrameRate)
{
    ...
    if(OV8858S.sensorMode == SENSOR_MODE_VIDEO)//                          
    {
