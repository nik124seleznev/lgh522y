...
#define SENSORDB(x,...)
#endif
#define HI707_TEST_PATTERN_CHECKSUM (0x786a9657)//            
...
{
    HI707_write_cmos_sensor(0x03, 0x00);                        //      
    HI707_write_cmos_sensor(0x40,((dummy_pixels & 0x0F00))>>8);       //      
    HI707_write_cmos_sensor(0x41,(dummy_pixels & 0xFF));
    HI707_write_cmos_sensor(0x42,((dummy_lines & 0xFF00)>>8));       //                      
...
static void HI707_Cal_Min_Frame_Rate(kal_uint16 min_framerate)
{
    ...
    //                  
    HI707_write_cmos_sensor(0x01, HI707_read_cmos_sensor(0x01)|0x01);   //                    
    HI707_write_cmos_sensor(0x03, 0x00);
    HI707_write_cmos_sensor(0x11, HI707_read_cmos_sensor(0x11)&0xfb);

    HI707_write_cmos_sensor(0x03, 0x20);
    HI707_write_cmos_sensor(0x10, HI707_read_cmos_sensor(0x10)&0x7f);   //        

    HI707_write_cmos_sensor(0x11, 0x04);
    HI707_write_cmos_sensor(0x18, HI707_read_cmos_sensor(0x18)|0x08);   //        
    ...
    HI707_write_cmos_sensor(0x01, HI707_read_cmos_sensor(0x01)&0xfe);   //                         

    HI707_write_cmos_sensor(0x03, 0x20);
    HI707_write_cmos_sensor(0x10, HI707_read_cmos_sensor(0x10)|0x80);   //       
    HI707_write_cmos_sensor(0x18, HI707_read_cmos_sensor(0x18)&0xf7);   //        
}
...
static void HI707_Set_QVGA_mode(void)
{
    ...
    HI707_write_cmos_sensor(0x40, 0x01);        //                     
...
BOOL HI707_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
        ...
        HI707_write_cmos_sensor(0x80, 0x40); //    
        HI707_write_cmos_sensor(0x81, 0x20);
        HI707_write_cmos_sensor(0x82, 0x38); //    
        HI707_write_cmos_sensor(0x83, 0x59); //           
        HI707_write_cmos_sensor(0x84, 0x20); //    
        HI707_write_cmos_sensor(0x85, 0x53); //    
        HI707_write_cmos_sensor(0x86, 0x24); //    
        HI707_write_cmos_sensor(0x87, 0x49); //            
    ...
    case AWB_MODE_CLOUDY_DAYLIGHT:
        ...
        HI707_write_cmos_sensor(0x87, 0x60); //    
        HI707_write_cmos_sensor(0x88, 0x20); //    
        HI707_write_cmos_sensor(0x89, 0x60); //    
        HI707_write_cmos_sensor(0x8a, 0x20); //    
        HI707_write_cmos_sensor(0x8d, 0x00); //             
        HI707_write_cmos_sensor(0x8e, 0x00); //             
        HI707_write_cmos_sensor(0x10, 0xfb);
        }
        break;
                             ...
                             UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_PERIOD:
        *pFeatureReturnPara16++=HI707_IMAGE_SENSOR_PV_WIDTH;//                              
        *pFeatureReturnPara16=HI707_IMAGE_SENSOR_PV_HEIGHT;//                             
        *pFeatureParaLen=4;
        break;
