...
static kal_bool GC2035_VEDIO_encode_mode = KAL_FALSE; //                             
static kal_bool GC2035_sensor_cap_state = KAL_FALSE; //                  
...
#if defined(AGOLD_GC2035_YUV_HV_MIRROR) //             
	mirror = mirror ^ 0x03;
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x18 , 0x0e); //             
	...
	GC2035_write_cmos_sensor(0x1f , 0x08); //               
	...
	GC2035_write_cmos_sensor(0x24 , 0x17); //             
	...
	GC2035_write_cmos_sensor(0x86 , 0x06); //                  
...
//                        
 ...
 //                            
  ...
  GC2035_write_cmos_sensor(0x4f , 0x01);
	...
	GC2035_write_cmos_sensor(0x57 , 0x20); //          
	GC2035_write_cmos_sensor(0x58 , 0x01); 
	GC2035_write_cmos_sensor(0x5b , 0x0f); //              
#endif
	...
	//                       
	GC2035_write_cmos_sensor(0xd1 , 0x34);//                          
	...
	GC2035_write_cmos_sensor(0xdd , 0xb8);//           
	GC2035_write_cmos_sensor(0xfe , 0x00);
	//                    
	GC2035_write_cmos_sensor(0xfe , 0x02);
	...
	GC2035_write_cmos_sensor(0x97 , 0x45);//            
	//                          
	GC2035_write_cmos_sensor(0xfe , 0x02);
