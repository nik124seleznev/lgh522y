...
static struct IMX219MIPI_sensor_STRUCT IMX219MIPI_sensor={
    ...
    KAL_FALSE,//          
    KAL_FALSE,//           
    IMX219MIPI_PREVIEW_CLK,//       
    IMX219MIPI_VIDEO_CLK,//          
    IMX219MIPI_CAPTURE_CLK,//            
    0,//          
    0,//             
    0,//          
    IMX219MIPI_BASE_GAIN,//       
    IMX219MIPI_BASE_GAIN,//          
    IMX219MIPI_BASE_GAIN,//       
    IMX219MIPI_PV_LINE_LENGTH_PIXELS,//              
    IMX219MIPI_PV_FRAME_LENGTH_LINES,//               
    IMX219MIPI_VIDEO_LINE_LENGTH_PIXELS,//                 
    IMX219MIPI_VIDEO_FRAME_LENGTH_LINES,//                  
    IMX219MIPI_FULL_LINE_LENGTH_PIXELS,//              
    IMX219MIPI_FULL_FRAME_LENGTH_LINES,//               
    0,//               
    0,//              
    0,//                  
    0,//                 
...
void IMX219MIPISetFlipMirror(kal_int32 imgMirror)
{
    ...
    iTemp = IMX219MIPI_read_cmos_sensor(0x0172) & 0x03;    //                               
    switch (imgMirror)
    {
        case IMAGE_NORMAL:
            //                                                        
            IMX219MIPI_write_cmos_sensor(0x0172, 0x00);	//          
            break;
        case IMAGE_V_MIRROR:
            IMX219MIPI_write_cmos_sensor(0x0172, iTemp | 0x01);    //        
            break;
        case IMAGE_H_MIRROR:
            IMX219MIPI_write_cmos_sensor(0x0172, iTemp | 0x02);    //          
            break;
...
UINT32 IMX219MIPISetTestPatternMode(kal_bool bEnable)
{
    ...
    if(IMX219MIPI_sensor.capture_mode == KAL_FALSE)
    {
        if(bEnable)
        {
            ...
            IMX219MIPI_write_cmos_sensor(0x0624, 0x06); //          
            IMX219MIPI_write_cmos_sensor(0x0625, 0x68); //            
            IMX219MIPI_write_cmos_sensor(0x0626, 0x04); //          
            IMX219MIPI_write_cmos_sensor(0x0627, 0xd0); //            
            IMX219MIPI_write_cmos_sensor(0x6128, 0x00);
            IMX219MIPI_write_cmos_sensor(0x6129, 0x02);
            IMX219MIPI_write_cmos_sensor(0x613C, 0x06); //           
            IMX219MIPI_write_cmos_sensor(0x613D, 0x68); //             
            IMX219MIPI_write_cmos_sensor(0x613E, 0x04); //           
            IMX219MIPI_write_cmos_sensor(0x613F, 0xd0); //              
    ...
    else
    {
        if(bEnable)
        {
            ...
            IMX219MIPI_write_cmos_sensor(0x0600, 0x00);
            IMX219MIPI_write_cmos_sensor(0x0601, 0x02);
            IMX219MIPI_write_cmos_sensor(0x0624, 0x0C); //          
            IMX219MIPI_write_cmos_sensor(0x0625, 0xD0); //            
            IMX219MIPI_write_cmos_sensor(0x0626, 0x09); //          
            IMX219MIPI_write_cmos_sensor(0x0627, 0xA0); //            
            IMX219MIPI_write_cmos_sensor(0x6128, 0x00);
            IMX219MIPI_write_cmos_sensor(0x6129, 0x02);
            IMX219MIPI_write_cmos_sensor(0x613C, 0x0C); //           
            IMX219MIPI_write_cmos_sensor(0x613D, 0xD0); //             
            IMX219MIPI_write_cmos_sensor(0x613E, 0x09); //           
            IMX219MIPI_write_cmos_sensor(0x613F, 0xA0); //              
            IMX219MIPI_write_cmos_sensor(0x6506, 0x00);
            IMX219MIPI_write_cmos_sensor(0x6507, 0x00);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch (ScenarioId)
    {
        ...
        case MSDK_SCENARIO_ID_CAMERA_ZSD:
            ...
            pSensorInfo->SensorPixelClockCount= 3;
            pSensorInfo->SensorDataLatchCount= 2;
            pSensorInfo->SensorGrabStartX = IMX219MIPI_IMAGE_SENSOR_CAP_STARTX;    //                                    
            pSensorInfo->SensorGrabStartY = IMX219MIPI_IMAGE_SENSOR_CAP_STARTY;    //                                    
            pSensorInfo->SensorMIPILaneNumber = SENSOR_MIPI_4_LANE;
            pSensorInfo->MIPIDataLowPwr2HighSpeedTermDelayCount = 0;
            pSensorInfo->MIPIDataLowPwr2HighSpeedSettleDelayCount = 32;//   
            pSensorInfo->MIPICLKLowPwr2HighSpeedTermDelayCount = 0;
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch (ScenarioId)
    {
        ...
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
        case MSDK_SCENARIO_ID_CAMERA_ZSD:
            IMX219MIPICapture(pImageWindow, pSensorConfigData);//        
            break;
        default:
...
UINT32 IMX219MIPISetVideoMode(UINT16 u2FrameRate)
{
    ...
    if (IMX219MIPI_Video_Max_Expourse_Time > IMX219MIPI_VIDEO_FRAME_LENGTH_LINES/*                                 */)
    {
        spin_lock(&IMX219_drv_lock);
