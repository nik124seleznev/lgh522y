...
#define ClearInterrupt(x)       WriteByteTPI(0x3D, x)	/*                                  */
...
#define SIZE_AVI_INFOFRAME			0x0E	/*          */
#define SIZE_SPD_INFOFRAME			0x19	/*          */
#define SISE_AUDIO_INFOFRAME_IFORM  0x0A	/*          */
#define SIZE_AUDIO_INFOFRAME		0x0F	/*          */
#define SIZE_MPRG_HDMI_INFOFRAME    0x1B	/*          */
#define SIZE_MPEG_INFOFRAME		0x0A	/*          */
#define SIZE_GEN_1_INFOFRAME	0x1F	/*          */
#define SIZE_GEN_2_INFOFRAME	0x1F	/*          */
#define SIZE_HDMI_VISF_INFOFRAME    0x1E	/*          */
#define SIZE_GBD_INFOFRAME		0x1C	/*          */
