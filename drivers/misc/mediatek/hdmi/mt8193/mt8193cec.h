...
/*                                                                     */
#define Fld2Msk32(fld)	/*                 */ ((((u32)1<<Fld_wid(fld))-1)<<Fld_shft(fld))	/*              */
...
#define BYPASS Fld(1, 28, AC_MSKB3)	/*    */
#define TR_DEVICE_ADDR3 Fld(4, 24, AC_MSKB3)	/*       */
#define TR_DEVICE_ADDR2 Fld(4, 20, AC_MSKB2)	/*       */
#define DEVICE_ADDR Fld(4, 16, AC_MSKB2)	/*       */
#define TX_G_EN Fld(1, 13, AC_MSKB1)	/*    */
#define TX_EN Fld(1, 12, AC_MSKB1)	/*    */
#define RX_G_EN Fld(1, 9, AC_MSKB1)	/*   */
#define RX_EN Fld(1, 8, AC_MSKB1)	/*   */
#define CEC_ID_EN Fld(1, 1, AC_MSKB0)	/*   */
#define CEC_EN Fld(1, 0, AC_MSKB0)	/*   */

#define CEC_CKGEN 0x04


#define PDN Fld(1, 16, AC_MSKB2)	/*    */
#define DIV_SEL Fld(16, 0, AC_FULLW10)	/*      */

#define RX_T_START_R 0x08

#define RX_TIMER_START_R_MAX Fld(11, 16, AC_MSKW32)	/*       */
#define RX_TIMER_START_R_MIN Fld(11, 0, AC_MSKW10)	/*      */
#define RX_T_START_F 0x0c

#define RX_TIMER_START_F_MAX Fld(11, 16, AC_MSKW32)	/*       */
#define RX_TIMER_START_F_MIN Fld(11, 0, AC_MSKW10)	/*      */
#define RX_T_DATA 0x10

#define RX_TIMER_DATA_SAMPLE Fld(11, 16, AC_MSKW32)	/*       */
#define RX_TIMER_DATA_F_MIN Fld(11, 0, AC_MSKW10)	/*      */
#define RX_T_ACK 0x14

#define RX_TIMER_ACK_R Fld(11, 0, AC_MSKW10)	/*      */
#define RX_T_ERROR 0x18

#define RX_TIMER_ERROR_D Fld(11, 16, AC_MSKW32)	/*       */
#define RX_TIMER_ERROR_S Fld(11, 0, AC_MSKW10)	/*      */
#define TX_T_START 0x1c

#define TX_TIMER_START_F Fld(11, 16, AC_MSKW32)	/*       */
#define TX_TIMER_START_R Fld(11, 0, AC_MSKW10)	/*      */
#define TX_T_DATA_R 0x20

#define TX_TIMER_BIT1_R Fld(11, 16, AC_MSKW32)	/*       */
#define TX_TIMER_BIT0_R Fld(11, 0, AC_MSKW10)	/*      */
#define TX_T_DATA_F 0x24

#define TX_TIMER_DATA_N Fld(11, 16, AC_MSKW32)	/*       */
#define TX_TIMER_DATA_F Fld(11, 0, AC_MSKW10)	/*      */
#define TX_ARB 0x28

#define MAX_RETRANSMIT Fld(4, 12, AC_MSKB1)	/*       */
#define BCNT_RETRANSMIT_3_0 Fld(5, 7, AC_MSKW10)	/*      */
#define BCNT_NEW_MSG Fld(4, 4, AC_MSKB0)	/*     */
#define BCNT_NEW_INIT Fld(4, 0, AC_MSKB0)	/*     */
#define RX_HEADER 0x40

#define RXED_M3_DATA_MASK Fld(4, 24, AC_MSKB3)	/*       */
#define RXED_SRC Fld(4, 20, AC_MSKB2)	/*       */
#define RXED_DST Fld(4, 16, AC_MSKB2)	/*       */
#define RXED_H_EOM Fld(1, 15, AC_MSKB1)	/*    */
#define RXED_D_EOM Fld(1, 13, AC_MSKB1)	/*    */
#define RXED_M3_ID Fld(3, 8, AC_MSKB1)	/*      */
#define RXED_M1_DIR Fld(1, 7, AC_MSKB0)	/*   */
#define RXED_M1_PAS Fld(1, 6, AC_MSKB0)	/*   */
#define RXED_M1_NAS Fld(1, 5, AC_MSKB0)	/*   */
#define RXED_M1_DES Fld(1, 4, AC_MSKB0)	/*   */
#define RXED_MODE Fld(2, 0, AC_MSKB0)	/*     */
#define RX_DATA 0x44

#define RXED_DATA Fld(32, 0, AC_FULLDW)	/*      */
#define RX_HD_NEXT 0x48

#define RXING_M3_DATA_MASK Fld(4, 24, AC_MSKB3)	/*       */
#define RXING_SRC Fld(4, 20, AC_MSKB2)	/*       */
#define RXING_DST Fld(4, 16, AC_MSKB2)	/*       */
#define RXING_H_EOM Fld(1, 15, AC_MSKB1)	/*    */
#define RXING_H_ACK Fld(1, 14, AC_MSKB1)	/*    */
#define RXING_D_EOM Fld(1, 13, AC_MSKB1)	/*    */
#define RXING_D_ACK Fld(1, 12, AC_MSKB1)	/*    */
#define RXING_M3_ID Fld(3, 8, AC_MSKB1)	/*      */
#define RXING_M1_DIR Fld(1, 7, AC_MSKB0)	/*   */
#define RXING_M1_PAS Fld(1, 6, AC_MSKB0)	/*   */
#define RXING_M1_NAS Fld(1, 5, AC_MSKB0)	/*   */
#define RXING_M1_DES Fld(1, 4, AC_MSKB0)	/*   */
#define RXING_MODE Fld(2, 0, AC_MSKB0)	/*     */
#define RX_DATA_NEXT 0x4c

#define RXING_DATA Fld(32, 0, AC_FULLDW)	/*      */
#define RX_CAP_50 0x50

#define M1_CAP_50 Fld(6, 10, AC_MSKB1)	/*       */
#define RX_EVENT 0x54

#define DATA_RDY Fld(1, 23, AC_MSKB2)	/*    */
#define HEADER_RDY Fld(1, 22, AC_MSKB2)	/*    */
#define MODE_RDY Fld(1, 21, AC_MSKB2)	/*    */
#define OV Fld(1, 20, AC_MSKB2)	/*    */
#define BR_SB_RDY Fld(1, 18, AC_MSKB2)	/*    */
#define SB_RDY Fld(1, 17, AC_MSKB2)	/*    */
#define BR_RDY Fld(1, 16, AC_MSKB2)	/*    */
#define I_EN_DATA Fld(1, 7, AC_MSKB0)	/*   */
#define I_EN_HEADER Fld(1, 6, AC_MSKB0)	/*   */
#define I_EN_MODE Fld(1, 5, AC_MSKB0)	/*   */
#define I_EN_OV Fld(1, 4, AC_MSKB0)	/*   */
#define I_EN_PULSE Fld(1, 3, AC_MSKB0)	/*   */
#define I_EN_BR_SB Fld(1, 2, AC_MSKB0)	/*   */
#define I_EN_SB  Fld(1, 1, AC_MSKB0)	/*   */
#define I_EN_BR Fld(1, 0, AC_MSKB0)	/*   */
#define RX_GEN_WD 0x58

#define BUF1_WD Fld(16, 16, AC_FULLW32)	/*       */
#define BUF0_WD Fld(16, 0, AC_FULLW10)	/*      */
#define RX_GEN_MASK 0x5c

#define BUF1_MASK Fld(16, 16, AC_FULLW32)	/*       */
#define BUF0_MASK Fld(16, 0, AC_FULLW10)	/*      */
#define RX_GEN_RCVD 0x60

#define BUF1_RCVD Fld(16, 16, AC_FULLW32)	/*       */
#define BUF0_RCVD Fld(16, 0, AC_FULLW10)	/*      */
#define RX_GEN_INTR 0x64

#define BUF1_INTR Fld(16, 16, AC_FULLW32)	/*       */
#define BUF0_INTR Fld(16, 0, AC_FULLW10)	/*      */
#define RX_FAIL 0x68

#define ERR_ONCE Fld(1, 4, AC_MSKB0)	/*   */
#define ERR_H Fld(1, 0, AC_MSKB0)	/*   */
#define RX_STATUS 0x6c

#define RX_BIT_COUNTER Fld(4, 28, AC_MSKB3)	/*       */
#define RX_TIMER Fld(11, 16, AC_MSKW32)	/*       */
#define RX_G_PTR Fld(1, 15, AC_MSKB1)	/*    */
#define RX_FSM Fld(14, 0, AC_MSKW10)	/*      */
#define TX_HD_NEXT 0x80

#define WTX_M3_DATA_MASK Fld(4, 24, AC_MSKB3)	/*       */
#define WTX_SRC Fld(4, 20, AC_MSKB2)	/*       */
#define WTX_DST Fld(4, 16, AC_MSKB2)	/*       */
#define WTX_H_EOM Fld(1, 15, AC_MSKB1)	/*    */
#define WTX_D_EOM Fld(1, 13, AC_MSKB1)	/*    */
#define WTX_M3_ID Fld(3, 8, AC_MSKB1)	/*      */
#define WTX_M1_DIR Fld(1, 7, AC_MSKB0)	/*   */
#define WTX_M1_PAS Fld(1, 6, AC_MSKB0)	/*   */
#define WTX_M1_NAS Fld(1, 5, AC_MSKB0)	/*   */
#define WTX_M1_DES Fld(1, 4, AC_MSKB0)	/*   */
#define WTX_MODE Fld(2, 0, AC_MSKB0)	/*     */
#define TX_DATA_NEXT 0x84

#define WTX_DATA Fld(32, 0, AC_FULLDW)	/*      */
#define TX_HEADER 0x88

#define TXING_M3_DATA_SENT Fld(4, 28, AC_MSKB3)	/*       */
#define TXING_M3_DATA_MASK Fld(4, 24, AC_MSKB3)	/*       */
#define TXING_SRC Fld(4, 20, AC_MSKB2)	/*       */
#define TXING_DST Fld(4, 16, AC_MSKB2)	/*       */
#define TXING_H_EOM Fld(1, 15, AC_MSKB1)	/*    */
#define TXING_H_ACK Fld(1, 14, AC_MSKB1)	/*    */
#define TXING_D_EOM Fld(1, 13, AC_MSKB1)	/*    */
#define TXING_D_ACK Fld(1, 12, AC_MSKB1)	/*    */
#define TXING_M3_ID Fld(3, 8, AC_MSKB1)	/*      */
#define TXING_M1_DIR Fld(1, 7, AC_MSKB0)	/*   */
#define TXING_M1_PAS Fld(1, 6, AC_MSKB0)	/*   */
#define TXING_M1_NAS Fld(1, 5, AC_MSKB0)	/*   */
#define TXING_M1_DES Fld(1, 4, AC_MSKB0)	/*   */
#define TXING_MODE Fld(2, 0, AC_MSKB0)	/*     */
#define TX_DATA 0x8c

#define TXING_DATA Fld(32, 0, AC_FULLDW)	/*      */
#define RX_CAP_90 0x90

#define M1_CAP_90 Fld(6, 10, AC_MSKB1)	/*       */
#define TX_EVENT 0x94

#define UN Fld(1, 20, AC_MSKB2)	/*    */
#define FAIL Fld(1, 19, AC_MSKB2)	/*    */
#define LOWB Fld(1, 18, AC_MSKB2)	/*    */
#define BS Fld(1, 17, AC_MSKB2)	/*    */
#define RB_RDY Fld(1, 16, AC_MSKB2)	/*    */
#define I_EN_UN Fld(1, 4, AC_MSKB0)	/*   */
#define I_EN_FAIL Fld(1, 3, AC_MSKB0)	/*   */
#define I_EN_LOW Fld(1, 2, AC_MSKB0)	/*   */
#define I_EN_BS Fld(1, 1, AC_MSKB0)	/*   */
#define I_EN_RB Fld(1, 0, AC_MSKB0)	/*   */
#define TX_GEN_RD 0x98

#define BUF1_RD Fld(16, 16, AC_FULLW32)	/*       */
#define BUF0_RD Fld(16, 0, AC_FULLW10)	/*      */
...
#define BUF1_SENT Fld(16, 16, AC_FULLW32)	/*       */
#define BUF0_SENT Fld(16, 0, AC_FULLW10)	/*      */
...
#define RETX_MAX Fld(1, 28, AC_MSKB3)	/*    */
#define DATA Fld(1, 24, AC_MSKB3)	/*    */
#define CMD Fld(1, 20, AC_MSKB2)	/*    */
#define HEADER Fld(1, 16, AC_MSKB2)	/*    */
#define SOURCE Fld(1, 12, AC_MSKB1)	/*    */
#define ID Fld(1, 8, AC_MSKB1)	/*   */
#define FMODE Fld(1, 4, AC_MSKB0)	/*   */
#define FDIR Fld(1, 0, AC_MSKB0)	/*   */
#define TX_STATUS 0xac

#define TX_BIT_COUNTER Fld(4, 28, AC_MSKB3)	/*       */
#define TX_TIMER Fld(11, 16, AC_MSKW32)	/*       */
#define TX_G_PTR Fld(1, 15, AC_MSKB1)	/*    */
#define TX_FSM Fld(15, 0, AC_MSKW10)	/*      */
#define TR_TEST 0xbc

#define PAD_PULL_HIGH Fld(1, 31, AC_MSKB3)	/*    */
#define PAD_ENABLE Fld(1, 30, AC_MSKB3)	/*    */

#define RX_ADDR_CHECK Fld(1, 8, AC_MSKB1)	/*   */
#define TX_COMP_TIM Fld(5, 0, AC_MSKB0)	/*     */
