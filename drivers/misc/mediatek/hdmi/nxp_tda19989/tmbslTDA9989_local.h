...
#define RETIF(cond, rslt)       if ((cond)) {pr_debug("%s %d\n", __func__, __LINE__); return (rslt); }
#else
...
#define REGVFMT_INVALID 0xFF
	...
	enum _eRegVfmt {
		...
		E_REGVFMT_1440x576p_50Hz,	/*       */
		E_REGVFMT_1440x480p_60Hz,	/*       */
		E_REGVFMT_2880x480p_60Hz,	/*       */
		E_REGVFMT_2880x576p_50Hz,	/*       */
		E_REGVFMT_2880x480i_60Hz,	/*       */
		E_REGVFMT_2880x480i_60Hz_PR2,	/*       */
		E_REGVFMT_2880x480i_60Hz_PR4,	/*       */
		E_REGVFMT_2880x576i_50Hz,	/*       */
		E_REGVFMT_2880x576i_50Hz_PR2,	/*       */
		E_REGVFMT_720x480p_60Hz_FP,	/*        */
		E_REGVFMT_1280x720p_60Hz_FP,	/*      */
		E_REGVFMT_720x576p_50Hz_FP,	/*          */
	...
	enum _eRegVfmtExtra {
		...
		E_REGVFMT_1920x1080p_24Hz = E_REGVFMT_MAX_PREFETCH,	/*    */
		E_REGVFMT_1920x1080p_25Hz,	/*    */
#else
		E_REGVFMT_1920x1080p_25Hz = E_REGVFMT_MAX_PREFETCH,
#endif
		E_REGVFMT_1920x1080p_30Hz,	/*    */
		E_REGVFMT_1280x720p_24Hz,	/*    */
		E_REGVFMT_1280x720p_25Hz,	/*    */
		E_REGVFMT_1280x720p_30Hz,	/*    */
#ifndef TMFL_RGB_DDR_12BITS
		E_REGVFMT_1280x720p_60Hz_FP,
		E_REGVFMT_1920x1080i_60Hz_FP,
		E_REGVFMT_1280x720p_50Hz_FP,
...
#define PCFORMAT(fmt) ((fmt) >= E_REGVFMT_MAX_EXTRA)	/*              */
...
/*                                   */
	typedef enum {
		HDMITX_CS_RGB_FULL = 0,	    /*                 */
		HDMITX_CS_RGB_LIMITED = 1,  /*                    */
		HDMITX_CS_YUV_ITU_BT601 = 2,/*                       */
		HDMITX_CS_YUV_ITU_BT709 = 3,/*                       */
		HDMITX_CS_NUM = 4	    /*                             */
