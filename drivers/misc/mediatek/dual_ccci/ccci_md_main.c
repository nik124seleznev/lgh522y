...
{
    struct mutex        ccci_md_boot_mutex; //                  
                          ...
                          modem_runtime_info_tag_t *tag)
{
    ...
    {
        runtime->IPCShareMemBase = ctl_b->smem_table->ccci_ipc_smem_base_phy+offset_of(CCCI_IPC_MEM,buffer)- get_md2_ap_phy_addr_fixed(); //          
    ...
    platform_set_runtime_data(md_id, runtime); //                                        
