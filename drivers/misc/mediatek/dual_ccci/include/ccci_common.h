...
/*                                                                         */
/*                      */
#define CCCI_DBG_NONE        (0x00000000)    /*              */
#define CCCI_DBG_CTL        (0x00000001)    /*             */
#define CCCI_DBG_TTY        (0x00000002)    /*                 */
#define CCCI_DBG_FS            (0x00000004)    /*                */
#define CCCI_DBG_RPC        (0x00000008)    /*                 */
#define CCCI_DBG_IPC        (0x00000010)    /*                 */
#define CCCI_DBG_PMIC        (0x00000020)    /*                  */
#define CCCI_DBG_CCMNI        (0x00000040)    /*                   */
#define CCCI_DBG_FUNC        (0x00000080)    /*                     */
#define CCCI_DBG_MISC        (0x00000100)    /*          */
#define CCCI_DBG_CHR        (0x00000200)    /*              */
#define CCCI_DBG_CCIF        (0x00000400)    /*          */
