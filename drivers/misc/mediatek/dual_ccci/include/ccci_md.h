...
struct ccci_cores_exch_data
{
    ...
    unsigned int report_os_tick;        /*                                        */
                                        /*                 */
    unsigned int nr_eint_config;
    unsigned int eint_config_offset;    /*                                                        */
};
...
typedef struct _modem_runtime
{
    ...
    int NetPortNum;
    int NetULCtrlShareMemBase[NET_PORT_NUM]; //                              
