...
static int __init emi_bwl_mod_init(void)
{
  ...
  {
    //                    
    mt65xx_reg_sync_writel(0x0B0B0E17, EMI_CONB);	//                      
    mt65xx_reg_sync_writel(0x0B0B0B0B, EMI_CONC);	//                      
    mt65xx_reg_sync_writel(0x1012161E, EMI_COND);	//                      
    mt65xx_reg_sync_writel(0x0B0B0D0E, EMI_CONE);   //                      
  }
  else if(get_ddr_type() == DDR3_32)
  {
    /*                                 */
  ...
  {
    mt65xx_reg_sync_writel(0x2B2C2C2E, EMI_CONB);	//                      
    mt65xx_reg_sync_writel(0x2627292B, EMI_CONC);	//                      
    mt65xx_reg_sync_writel(0x2B2C2C2E, EMI_COND);	//                      
    mt65xx_reg_sync_writel(0x2627292B, EMI_CONE);       //                      
  }
#endif  
