...
enum {
	...
	FLAG_CSPI_READ = (1 << 22),	/*    */
	FLAG_SM_TUNE = (1 << FM_SOFT_MUTE_TUNE_OPCODE),	/*    */
	FLAG_HOST_READ = (1 << FM_HOST_READ_OPCODE),	/*    */
	FLAG_HOST_WRITE = (1 << FM_HOST_WRITE_OPCODE),	/*    */
	FLAG_CSPI_WRITE = (1 << 26),	/*    */
	FLAG_CQI_DONE = (1 << 27),
	FLAG_TUNE_DONE = (1 << 28),
	FLAG_SEEK_DONE = (1 << 29),
	FLAG_SCAN_DONE = (1 << 30),
