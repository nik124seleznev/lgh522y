...
typedef struct fm_priv_cb {
	...
	fm_s32(*hl_dese) (fm_u16 freq, void *arg);	/*                                                        */
	fm_s32(*fa_dese) (fm_u16 freq, void *arg);	/*                                                  */
	fm_s32(*mcu_dese) (fm_u16 freq, void *arg);	/*                                                             */
	fm_s32(*gps_dese) (fm_u16 freq, void *arg);	/*                                                            */
	fm_u16(*chan_para_get) (fm_u16 freq);	/*                                          */
} fm_priv_cb_t;
