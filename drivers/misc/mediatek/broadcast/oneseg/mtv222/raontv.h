...
#define RTV_INVAILD_SUB_CHANNEL_ID		-7 //                  
#define RTV_NO_MORE_SUB_CHANNEL			-8 //                  
#define RTV_ALREADY_OPENED_SUB_CHANNEL_ID	-9 //                  
#define RTV_NOT_OPENED_SUB_CHANNEL_ID		-10 //                  
