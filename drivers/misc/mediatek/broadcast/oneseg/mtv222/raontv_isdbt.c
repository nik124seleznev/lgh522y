...
UINT rtvISDBT_GetAntennaLevel(U32 dwCNR)
{
	...
	static const UINT aAntLvlTbl[ISDBT_MAX_NUM_ANTENNA_LEVEL-1]
		= {15*RTV_ISDBT_CNR_DIVIDER, /*   */
			12*RTV_ISDBT_CNR_DIVIDER, /*   */
			11*RTV_ISDBT_CNR_DIVIDER, /*   */
			9*RTV_ISDBT_CNR_DIVIDER, /*   */
			7*RTV_ISDBT_CNR_DIVIDER, /*   */
			4*RTV_ISDBT_CNR_DIVIDER /*   */
			};
...
void rtvISDBT_GetTMCC(RTV_ISDBT_TMCC_INFO *ptTmccInfo)
{
	...
	RTV_REG_MAP_SEL(FEC_PAGE);
	ptTmccInfo->fEWS = (RTV_REG_GET(0x7D)>>4)&0x01; //   
