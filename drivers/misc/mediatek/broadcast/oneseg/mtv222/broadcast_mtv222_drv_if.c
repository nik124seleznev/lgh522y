...
static void get_onseg_sig_info(struct broadcast_dmb_control_info *pInfo)
{
	...
	MTVMSG("lock(%d), bb_cnr(%u), cn(%d), ber(%d), per(%d), rssi(%d), ErrTSP(%d), TotalTSP(%d), antenna_level(%d)\n",
			...
			pInfo->sig_info.info.oneseg_info.rssi, pInfo->sig_info.info.oneseg_info.ErrTSP, pInfo->sig_info.info.oneseg_info.TotalTSP, pInfo->sig_info.info.mmb_info.antenna_level_oneseg /*                                              */);
