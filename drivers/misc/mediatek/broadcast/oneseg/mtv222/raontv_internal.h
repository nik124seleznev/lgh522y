...
typedef struct
{
	...
	U8	bVal;
...
#else
	#if defined(RTV_INTR_POLARITY_LOW_ACTIVE)
		#define I2C_INTR_POL_ACTIVE 0x08 /*           */
	#elif defined(RTV_INTR_POLARITY_HIGH_ACTIVE)
		#define I2C_INTR_POL_ACTIVE 0x18 /*            */
	#endif
#endif
		...
		#define RTV_SPI_INTR_DEACT_PRD_VAL	((7<<4)|2)/*          */
...
static INLINE void rtv_ConfigureTsifFormat(void)
{
   ...
   RTV_REG_SET(0xA6, 0x01); //          
   RTV_REG_SET(0x9A, 0x0x55/*           */); //          
#endif
}
