...
#if defined(RAONTV_CHIP_INTEGER_MODE_EN)
	RTV_REG_MASK_SET(0x2B, 0xF0, 4<<4); //    
	RTV_REG_MASK_SET(0x2E, 0x80, 0x00);//         

	RTV_REG_MASK_SET(0x52, 0x20, 0x00); //                   
	RTV_REG_MASK_SET(0x2B, 0x03, 0x02); //         
	RTV_REG_MASK_SET(0x2C, 0xF0, 0xF0); //         
	RTV_REG_MASK_SET(0x52, 0x0F, 0x09); //               
	RTV_REG_MASK_SET(0xB1, 0xE0, 0x60); //             
	RTV_REG_MASK_SET(0x2D, 0xF8, 0x00); //          
	RTV_REG_MASK_SET(0x56, 0x0C, 0x04); //                 
	RTV_REG_MASK_SET(0x88, 0xE0, 0x80); //           
	RTV_REG_MASK_SET(0x5D, 0xE0, 0x00); //             
...
#else
	RTV_REG_MASK_SET(0x2B, 0xF0, 1<<4); //    
	
	RTV_REG_MASK_SET(0x52, 0x20, 0x00); //                   
	RTV_REG_MASK_SET(0x2B, 0x03, 0x02); //         
	RTV_REG_MASK_SET(0x2C, 0xF0, 0x80); //         
	RTV_REG_MASK_SET(0x52, 0x0F, 0x09); //               
	RTV_REG_MASK_SET(0xB1, 0xE0, 0x60); //             
	RTV_REG_MASK_SET(0x2D, 0xF8, 0xF8); //           
	RTV_REG_MASK_SET(0x56, 0x0C, 0x04); //                 
	RTV_REG_MASK_SET(0x88, 0xE0, 0x80); //           
	RTV_REG_MASK_SET(0x5D, 0xE0, 0xC0); //             
...
#else
    RTV_REG_MASK_SET(0x2E, 0x80,0x80);//         
