...
static s16 s4BU6474AF_SrWriteReg( u8 u08_adr, u16 u16_dat) //              
{
...
{
    u16 temp=(a_u2Data<<4);
    u8 puSendCmd1[3] = {0x36, 0x19, (u8)((temp>>8)&0xFF) }; //                       
    u8 puSendCmd2[3] = {0x36, 0x18, (u8)(temp&0xFF)};   //                   
...
static s16 s4RUMBAAF_init(void)
{
    ...
    s4RUMBAAF_SrWriteReg(0x3104, 0x00);//                                               
    s4RUMBAAF_SrWriteReg(0x304F, 0x0D);//                                                        
    msleep(10);
    s4RUMBAAF_SrWriteReg(0x304F, 0x0E);//                                                           
    msleep(10);

    s4RUMBAAF_WriteReg(0x0061,0x02);//                                                                      
    s4RUMBAAF_WriteReg(0x0060,0x01);//                                
    return 0;
}
/*                                                          
...
static s16 s4RUMBAAF_uninit(void)
{
    ...
    //            
    s4RUMBAAF_WriteReg(0x0060,0x00);//                                
    s4RUMBAAF_WriteReg(0x0061,0x00);//                                                                  
    //             
    s4RUMBAAF_SrWriteReg(0x3104, 0x00);//                                               
    s4RUMBAAF_SrWriteReg(0x304F, 0x0D);//                                                            
    return 0;   
...
{    
    ...
    s4BU6474AF_SrWriteReg(0xFF,0x0000);     //                                          
    s4BU6474AF_SrWriteReg(0xFF,0x8000);     //                                      
    
    //                            
    s4BU6474AF_SrWriteReg(0x37,0x0008);     //                      
    s4BU6474AF_SrWriteReg(0x25,0x0003);     //                 
    s4BU6474AF_SrWriteReg(0x26,0x0100);     //                           
    s4BU6474AF_SrWriteReg(0x27,0x0200);     //                            
    s4BU6474AF_SrWriteReg(0x28,0x0200);     //                            
    s4BU6474AF_SrWriteReg(0x29,0x0200);     //                            
    s4BU6474AF_SrWriteReg(0x24,0x40F0);     //                       
    s4BU6474AF_SrWriteReg(0x22,0xC2F8);     //                       
    s4BU6474AF_SrWriteReg(0x23,0x0311);     //                   
    s4BU6474AF_CEFWriteReg(0x27,0x0000);   //       
    s4BU6474AF_CEFWriteReg(0x20,0x0000);   //       
    s4BU6474AF_CEFWriteReg(0x25,0xE000);    //        
    s4BU6474AF_CEFWriteReg(0x21,0xC000);    //       
    s4BU6474AF_CEFWriteReg(0x2D,0x8800);    //     
    s4BU6474AF_CEFWriteReg(0x00,0x7FFF);    //                    
    s4BU6474AF_CEFWriteReg(0x01,0x5000);    //     
    s4BU6474AF_CEFWriteReg(0x02,0x4000);    //     
    s4BU6474AF_CEFWriteReg(0x03,0x4000);    //     
    s4BU6474AF_CEFWriteReg(0x08,0x0000);    //                   
    s4BU6474AF_CEFWriteReg(0x09,0x6000);    //     
    s4BU6474AF_CEFWriteReg(0x0A,0x4000);    //     
    s4BU6474AF_CEFWriteReg(0x0B,0x4000);    //     
    s4BU6474AF_CEFWriteReg(0x10,0x0000);    //                   
    s4BU6474AF_CEFWriteReg(0x11,0x7FFE);    //     
    s4BU6474AF_CEFWriteReg(0x12,0x4000);    //     
    s4BU6474AF_CEFWriteReg(0x13,0xD000);    //     
    s4BU6474AF_CEFWriteReg(0x38,0x1000);    //         
    s4BU6474AF_CEFWriteReg(0x27,0x0000);   //         
    s4BU6474AF_CEFWriteReg(0x2B,0x0000);   //         
    s4BU6474AF_CEFWriteReg(0x04,0x0000);   //         
    s4BU6474AF_CEFWriteReg(0x0C,0x0000);   //         
    s4BU6474AF_CEFWriteReg(0x14,0x0000);   //         
    s4BU6474AF_CEFWriteReg(0x1D,0x0000);   //         
    s4BU6474AF_CEFWriteReg(0x1E,0x0000);   //         
    s4BU6474AF_CEFWriteReg(0x2A,0x0000);    //         
    s4BU6474AF_CEFWriteReg(0x18,0x7FFF);    //     
    s4BU6474AF_CEFWriteReg(0x19,0x0000);   //     
    s4BU6474AF_CEFWriteReg(0x1A,0x0000);   //     
    s4BU6474AF_CEFWriteReg(0x1B,0x0000);   //     
    s4BU6474AF_CEFWriteReg(0x1C,0x0000);   //     
    s4BU6474AF_CEFWriteReg(0x0E,0x1000);    //                   
    s4BU6474AF_CEFWriteReg(0x16,0x0000);   //              
    s4BU6474AF_CEFWriteReg(0x17,0x36E2);    //                                                      
    s4BU6474AF_CEFWriteReg(0x29,0x4000);    //                             
    s4BU6474AF_CEFWriteReg(0x31,0x0000);   //                                
    s4BU6474AF_CEFWriteReg(0x32,0x0800);    //                                    
    s4BU6474AF_CEFWriteReg(0x06,0x0000);   //       
    s4BU6474AF_CEFWriteReg(0x07,0x0000);   //     
    s4BU6474AF_CEFWriteReg(0x34,0x0002);    //                       
    s4BU6474AF_CEFWriteReg(0x35,0x0002);    //                       
    s4BU6474AF_CEFWriteReg(0x37,0x0008);    //                       
    s4BU6474AF_CEFWriteReg(0x36,0x0002);    //                       
    s4BU6474AF_SrWriteReg(0x60,0x0100);     //                       
    s4BU6474AF_NVLREAD(0x40,&dat_L);        //             
    if((dat_L==0xFF)||(dat_L==0)) return -1;

    s4BU6474AF_ReadReg(0x24,&dat_H);    dat_H &= 0x0FFF;
    s4BU6474AF_NVLREAD(0x41,&dat_L);    dat_H |= (dat_L<<8);
    s4BU6474AF_SrWriteReg(0x24,dat_H);  //                

    s4BU6474AF_NVLREAD(0x42,&dat_L);
    s4BU6474AF_SrWriteReg(0x27,dat_L<<2);  //               

    s4BU6474AF_NVLREAD(0x43,&dat_L);
    s4BU6474AF_SrWriteReg(0x28,dat_L<<2);  //               
    
    s4BU6474AF_NVLREAD(0x44,&dat_H);    s4BU6474AF_NVLREAD(0x45,&dat_L);
    s4BU6474AF_CEFWriteReg(0x20,(dat_H<<8)|dat_L);    //               
                                                
    s4BU6474AF_NVLREAD(0x46,&dat_H);    s4BU6474AF_NVLREAD(0x47,&dat_L);
    s4BU6474AF_CEFWriteReg(0x21,(dat_H<<8)|dat_L);  //                  
                                            
    s4BU6474AF_NVLREAD(0x48,&dat_H);    s4BU6474AF_NVLREAD(0x49,&dat_L);
    s4BU6474AF_CEFWriteReg(0x25,(dat_H<<8)|dat_L );    //                  
                                                
    s4BU6474AF_NVLREAD(0x4A,&dat_H);    s4BU6474AF_NVLREAD(0x4B,&dat_L);
    s4BU6474AF_CEFWriteReg(0x17,(dat_H<<8)|dat_L);    //                  
    
    s4BU6474AF_NVLREAD(0x4C,&dat_H);    s4BU6474AF_NVLREAD(0x4D,&dat_L);        //          
    s4BU6474AF_CEFWriteReg(0x16,(dat_H<<8)|dat_L);
    
    s4BU6474AF_NVLREAD(0x4E,&dat_H);    s4BU6474AF_NVLREAD(0x4F,&dat_L);            //         

    s4BU6474AF_SrWriteReg(0x7E,0);          //                                              
    s4BU6474AF_CEFWriteReg(0x30,0x0004);    //               
