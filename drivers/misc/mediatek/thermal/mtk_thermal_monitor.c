...
static struct cpu_index_st cpu_index_list[8];	/*                      */
...
#else
	    (&(thermal->last_temperature) == tz_last_values[MTK_THERMAL_SENSOR_BATTERY]))	/*                         */
#endif
	{
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 6, 0)
	tz = thermal_zone_device_register(type, trips,	/*                                */
					  0,	/*         */
					  /*                                                                 */
					  (void *)tzdata, &mtk_thermal_wrapper_dev_ops,	/*                     */
					  NULL,	/*        */
