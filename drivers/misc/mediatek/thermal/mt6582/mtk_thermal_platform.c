...
static struct cpu_index_st cpu_index_list[4];   //                     
...
#if defined(CONFIG_ARCH_MT6589) || defined(CONFIG_ARCH_MT6582)  
#if defined(CONFIG_MTK_FAN5405_SUPPORT) || defined(CONFIG_MTK_NCP1851_SUPPORT) || defined(CONFIG_MTK_BQ24196_SUPPORT) //                     
