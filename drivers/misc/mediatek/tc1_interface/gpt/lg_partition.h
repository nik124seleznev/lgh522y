...
#define LGE_FAC_BT_ADDR_LEN (0x6)   /*             */
#define LGE_FAC_IMEI_LEN (15)   /*         */
...
#define LGE_FAC_SLTYPE_MASK_RESERVED_1 0x40 /*       */
#define LGE_FAC_SLTYPE_MASK_RESERVED_2 0x80 /*       */
...
#define LGE_FAC_ACCELEROMETER_CALIBRATION_SIZE sizeof(unsigned int)*6 /* */ //                        
#endif  /*                                                                                    */
...
#define LGE_FAC_FIXED_SOFTWARE_VER_IDX 101 /*              */
#define LGE_FAC_FIXED_SOFTWARE_VER_SIZE 50 /*             */

#define LGE_FAC_IMEI_SVN_IDX 102 /*               */
#define LGE_FAC_IMEI_SVN_SIZE 10 /*              */

#define LGE_FAC_MAX_NTCODE_COUNT_SBP 16
/*               */

#define LGE_FAC_NETWORK_CODE_IDX01          46 /*                */
#define LGE_FAC_NETWORK_CODE_SIZE01         sizeof(FactoryNetworkCode)*16

#define LGE_FAC_NETWORK_CODE_IDX02          47 /*                */
#define LGE_FAC_NETWORK_CODE_SIZE02         sizeof(FactoryNetworkCode)*16

#define LGE_FAC_NETWORK_CODE_IDX03          48    /*                */
