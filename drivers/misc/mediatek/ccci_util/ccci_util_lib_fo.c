...
static void v1_layout_cal(void) //                                                  
{
	if( (md_usage_case&(MD1_EN|MD2_EN))==(MD1_EN|MD2_EN)) { //                    
	...
	} else if( (md_usage_case&(MD1_EN|MD2_EN))==(MD1_EN)) { //                
		modem_size_list[0] = md_resv_mem_size[MD_SYS1]+md_resv_smem_size[MD_SYS1];
		modem_size_list[1] = 0;
	} else if( (md_usage_case&(MD1_EN|MD2_EN))==(MD2_EN)) { //                
...
static void default_layout_cal(void) //                                                  
{
	if( (md_usage_case&(MD1_EN|MD2_EN))==(MD1_EN|MD2_EN)) { //                    
