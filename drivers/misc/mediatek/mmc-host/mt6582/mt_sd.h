...
#define MSDC_IOCON_DSPL         (0x1  << 2)     /*    */
#define MSDC_IOCON_DDLSEL       (0x1  << 3)     /*    */
#define MSDC_IOCON_DDR50CKD     (0x1  << 4)     /*    */
#define MSDC_IOCON_DSPLSEL      (0x1  << 5)     /*    */
#define MSDC_IOCON_RDSPLSEL     (0x1  << 5)     /*    */	/*                                        */
#define MSDC_IOCON_WDSPLSEL     (0x1  << 9)     /*    */	/*                                        */
#define MSDC_IOCON_W_DSPL       (0x1  << 8)     /*    */
#define MSDC_IOCON_WD0_SMPL     (0x1  << 10)    /*    */
#define MSDC_IOCON_WD1_SMPL     (0x1  << 11)    /*    */
#define MSDC_IOCON_WD2_SMPL     (0x1  << 12)    /*    */
#define MSDC_IOCON_WD3_SMPL     (0x1  << 13)    /*    */
#define MSDC_IOCON_D0SPL        (0x1  << 16)    /*    */
#define MSDC_IOCON_D1SPL        (0x1  << 17)    /*    */
#define MSDC_IOCON_D2SPL        (0x1  << 18)    /*    */
#define MSDC_IOCON_D3SPL        (0x1  << 19)    /*    */
#define MSDC_IOCON_D4SPL        (0x1  << 20)    /*    */
#define MSDC_IOCON_D5SPL        (0x1  << 21)    /*    */
#define MSDC_IOCON_D6SPL        (0x1  << 22)    /*    */
#define MSDC_IOCON_D7SPL        (0x1  << 23)    /*    */
...
#define MSDC_DMA_CTRL_XFERSZ    (0xffffUL << 16)/*    */

/*                   */
#define MSDC_DMA_CFG_STS        (0x1  << 0)     /*   */
#define MSDC_DMA_CFG_DECSEN     (0x1  << 1)     /*    */
#define MSDC_DMA_CFG_BDCSERR    (0x1  << 4)     /*   */
#define MSDC_DMA_CFG_GPDCSERR   (0x1  << 5)     /*   */
...
#define MSDC_PATCH_BIT_IODSSEL    (0x1  << 16)    /*    */
#define MSDC_PATCH_BIT_IOINTSEL   (0x1  << 17)    /*    */
#define MSDC_PATCH_BIT_BUSYDLY    (0xf  << 18)    /*    */
#define MSDC_PATCH_BIT_WDOD       (0xf  << 22)    /*    */
#define MSDC_PATCH_BIT_IDRTSEL    (0x1  << 26)    /*    */
#define MSDC_PATCH_BIT_CMDFSEL    (0x1  << 27)    /*    */
#define MSDC_PATCH_BIT_INTDLSEL   (0x1  << 28)    /*    */
...
#define MSDC_PATCH_BIT1_ECO_1     (0x1 << 6)    /*                                                                 */
#define MSDC_PATCH_BIT1_ECO_2     (0x1 << 7)    /*                                             */

/*                    */
#define MSDC_PAD_CTL0_CLKDRVN   (0x7  << 0)     /*    */
#define MSDC_PAD_CTL0_CLKDRVP   (0x7  << 4)     /*    */
#define MSDC_PAD_CTL0_CLKSR     (0x1  << 8)     /*    */
#define MSDC_PAD_CTL0_CLKPD     (0x1  << 16)    /*    */
#define MSDC_PAD_CTL0_CLKPU     (0x1  << 17)    /*    */
#define MSDC_PAD_CTL0_CLKSMT    (0x1  << 18)    /*    */
#define MSDC_PAD_CTL0_CLKIES    (0x1  << 19)    /*    */
#define MSDC_PAD_CTL0_CLKTDSEL  (0xf  << 20)    /*    */
#define MSDC_PAD_CTL0_CLKRDSEL  (0xffUL<< 24)   /*    */

/*                    */
#define MSDC_PAD_CTL1_CMDDRVN   (0x7  << 0)     /*    */
#define MSDC_PAD_CTL1_CMDDRVP   (0x7  << 4)     /*    */
#define MSDC_PAD_CTL1_CMDSR     (0x1  << 8)     /*    */
#define MSDC_PAD_CTL1_CMDPD     (0x1  << 16)    /*    */
#define MSDC_PAD_CTL1_CMDPU     (0x1  << 17)    /*    */
#define MSDC_PAD_CTL1_CMDSMT    (0x1  << 18)    /*    */
#define MSDC_PAD_CTL1_CMDIES    (0x1  << 19)    /*    */
#define MSDC_PAD_CTL1_CMDTDSEL  (0xf  << 20)    /*    */
#define MSDC_PAD_CTL1_CMDRDSEL  (0xffUL<< 24)   /*    */

/*                    */
#define MSDC_PAD_CTL2_DATDRVN   (0x7  << 0)     /*    */
#define MSDC_PAD_CTL2_DATDRVP   (0x7  << 4)     /*    */
#define MSDC_PAD_CTL2_DATSR     (0x1  << 8)     /*    */
#define MSDC_PAD_CTL2_DATPD     (0x1  << 16)    /*    */
#define MSDC_PAD_CTL2_DATPU     (0x1  << 17)    /*    */
#define MSDC_PAD_CTL2_DATIES    (0x1  << 19)    /*    */
#define MSDC_PAD_CTL2_DATSMT    (0x1  << 18)    /*    */
#define MSDC_PAD_CTL2_DATTDSEL  (0xf  << 20)    /*    */
#define MSDC_PAD_CTL2_DATRDSEL  (0xffUL<< 24)   /*    */
...
struct msdc_saved_para
{
	...
	u8							inten_sdio_irq;
	u8							write_timeout_eco1; /*                                                                 */
	u8							write_timeout_eco2; /*                                             */
};
