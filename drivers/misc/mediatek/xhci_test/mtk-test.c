...
#define DF_BURST_SIZE			1	//                  
#define DF_MULT_SIZE			1	//                  
...
static int t_u3auto_loopback_scan_sg(int argc, char** argv){
	...
	int sg_ss_intr_burst[SG_SS_INTR_BURST_SIZE] = {0/*    */};
	...
	int sg_hs_intr_maxp[SG_HS_INTR_MAXP_SIZE] = {1024};	//             
	...
	int sg_fs_intr_interval[SG_FS_INTR_INTERVAL_SIZE] = {1};//           
	int sg_fs_intr_maxp[SG_FS_INTR_MAXP_SIZE] = {32}; //         
...
static int t_u3auto_loopback_scan(int argc, char** argv){
	...
	int ss_isoc_maxp[SS_ISOC_MAXP_SIZE] = {/*         */64,1024};
	...
	int hs_intr_interval[HS_INTR_INTERVAL_SIZE] = {1/*  */,2}; //      
	int hs_intr_maxp[HS_INTR_MAXP_SIZE] = {6, 8, 30/*           */,1024}; //                              
	int hs_intr_out_ep[HS_INTR_OUT_EP_SIZE] = {1};
	int hs_intr_in_ep[HS_INTR_IN_EP_SIZE] = {1};

	int hs_hb_intr_interval[HS_HB_INTR_INTERVAL_SIZE] = {1/*  */,2}; //      
	int hs_hb_intr_maxp[HS_HB_INTR_MAXP_SIZE] = {1024}; //                              
	...
	int fs_bulk_maxp[FS_BULK_MAXP_SIZE] = {8/*   */,32,64}; //           
	int fs_bulk_out_ep[FS_BULK_OUT_EP_SIZE] = {1};
	int fs_bulk_in_ep[FS_BULK_IN_EP_SIZE] = {1};

	int fs_intr_interval[FS_INTR_INTERVAL_SIZE] = {1, 2}; //           
	int fs_intr_maxp[FS_INTR_MAXP_SIZE] = {6, 8, 30,/*   */64}; //        
	...
	int fs_isoc_maxp[FS_ISOC_MAXP_SIZE] = {/*     */128,1023};
...
static int t_hub_loop(int argc, char** argv){
	...
	for(i=0; i<round; i++){
		length = (get_random_int() % 3072/*                             */) + 1;
		start_add = (get_random_int() % 63) + 1;
		sg_len = (get_random_int() % 9) * 8/*                        */;
