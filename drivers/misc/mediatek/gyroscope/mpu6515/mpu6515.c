...
#define MPU6515_DEV_NAME        "MPU6515GY" /*                                          */
/*                                                                            */
...
struct mpu6515_i2c_data
{
    ...
    s16                     temperature;
    struct mutex            temperature_mutex;//                          
    struct mutex            raw_data_mutex;//                             
#endif
};
/*                                                                            */
...
static int gyroscope_init_flag =-1; //                     
...
static int MPU6515_PROCESS_SMT_DATA(struct i2c_client *client, short *data)
{
    ...
    int bias_thresh = 5242; //                         
    //                                                     
    long RMS_thresh = 68719; //                       
...
#ifdef MPU6515_ACCESS_BY_GSE_I2C
    obj->hw->addr = MPU6515_I2C_SLAVE_ADDR; /*                                             */
#endif
