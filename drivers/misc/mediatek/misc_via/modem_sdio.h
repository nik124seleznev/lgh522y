...
#define SDIO_BUF_IN_MAX_SIZE			64512     /*                        */
...
struct sdio_msg_head
{
	...
	unsigned char chanInfo;		/*          */
	unsigned char tranHi;           /*                            */
	unsigned char tranLow;          /*                           */
};
...
struct sdio_modem_port {
	...
	unsigned int		sdio_buf_in_num;			/*                  */
	unsigned int		sdio_buf_in_max_num;	/*                      */
	unsigned int		sdio_buf_in_size;			/*              */
