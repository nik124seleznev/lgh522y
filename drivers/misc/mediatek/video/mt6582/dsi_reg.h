...
typedef struct
{
    MIPITX_DSI0_CON_REG		MIPITX_DSI0_CON;		//     
    MIPITX_DSI0_CLOCK_LANE_REG		MIPITX_DSI0_CLOCK_LANE;		//     
    MIPITX_DSI0_DATA_LANE0_REG		MIPITX_DSI0_DATA_LANE0;		//     
    MIPITX_DSI0_DATA_LANE1_REG		MIPITX_DSI0_DATA_LANE1;		//     
    MIPITX_DSI0_DATA_LANE2_REG		MIPITX_DSI0_DATA_LANE2;		//         
    MIPITX_DSI0_DATA_LANE3_REG		MIPITX_DSI0_DATA_LANE3;		//         
    UINT32                  rsv_18[10];               //           
    ...
    MIPITX_DSI_GPIO_EN_REG		MIPITX_DSI_GPIO_EN;		//             
    MIPITX_DSI_GPIO_OUT_REG		MIPITX_DSI_GPIO_OUT;		//             
    UINT32                  rsv_7C;               //     
    MIPITX_DSI_SW_CTRL_REG		MIPITX_DSI_SW_CTRL;		//             
