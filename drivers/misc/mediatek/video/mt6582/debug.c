...
#include "disp_drv.h"
    ...
    size_t disp_drv_dbg_info_log = false;    //                      
    size_t disp_drv_dbg_func_log = false;    //                                
    size_t disp_drv_dbg_upd_log = false;    //                     
    size_t mtkfb_dbg_log = true;
    size_t mtkfb_dbg_fence_log = false;    //                       
    size_t mtkfb_dbg_func_log = false;    //                                
    size_t mtkfb_dbg_ioctl_log = false;    //                       
#else
