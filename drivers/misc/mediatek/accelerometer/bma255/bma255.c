...
static ssize_t bma255_SelfTest_store(struct device_driver *ddri, char *buf, size_t count)
{
    ...
    if(data == 1)//                        
    {
		...
		/*                      */
		bma255_set_selftest_st(obj->client, 1);/*            */
		bma255_set_selftest_stn(obj->client, 0);/*                  */
		mdelay(10);
		...
		bma255_set_selftest_stn(obj->client, 1);/*                  */
		mdelay(10);
		if(error = BMA255_ReadData(client, obj->data))
		{
			GSE_ERR("I2C error: ret value=%d", error);
		...
		/*                      */
		bma255_set_selftest_st(obj->client, 2);/*            */
		bma255_set_selftest_stn(obj->client, 0);/*                  */
		mdelay(10);
		if(error = BMA255_ReadData(client, obj->data))
		{
		...
		/*                      */
		bma255_set_selftest_st(obj->client, 3);/*            */
		bma255_set_selftest_stn(obj->client, 0);/*                  */
		mdelay(10);
		if(error = BMA255_ReadData(client, obj->data))
		{
...
#endif
#if 0
static DRIVER_ATTR(limit, S_IWUSR|S_IRUGO|S_IWGRP, show_limit_value, store_limit_value); //          
#endif
//                                                            
/*                                                                            */
