...
#define THRES_TOLERANCE		9	//                                                         
#define THRES_DEFAULT_DIFF	5 //       
       ...
       unsigned long arg)
{
	...
	switch (cmd)
	{
		...
		case ALSPS_SET_PS_THRESHOLD:
			...
			atomic_set(&obj->ps_thd_val_low,  (threshold[1]+obj->ps_cali_val));//               
