...
#define SWCR_READ 0
    ...
    if(ucArVer > 0) {
       ...
       nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,5,0,0));
    }
    else {
    ...
    nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,7,0,0));

    /*                        */
    nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA1),u2HtClrMask);
    nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,0x1c,0,0));

    /*                            */
    nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA1),u2LegacyClrMask);
    nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,0x1d,0,0));

#if 0
    if(ucArCheckWindow!=0) {
        /*                                          */
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA1),ucArCheckWindow);
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,0x14,0,0));
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA1),ucArCheckWindow);
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,0xc,0,0));
    }

    if(ucArPerForceRateDownPer !=0) {
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA1),ucArPerForceRateDownPer);
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,0x18,0,0));
    }
    if(ucArPerH !=0) {
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA1),ucArPerH);
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,0x1,0,0));
    }
    if(ucArPerL !=0) {
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA1),ucArPerL);
        nicWriteMcr (prAdapter, SWCR_DATA_ADDR(1/*   */,SWCR_DATA0),SWCR_DATA_CMD(0,SWCR_WRITE,0x2,0,0));
    }
#endif
