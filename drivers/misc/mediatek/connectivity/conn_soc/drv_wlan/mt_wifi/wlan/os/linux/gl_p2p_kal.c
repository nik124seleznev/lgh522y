    ...
    )
{
    ...
    if (pucSSID)
        snprintf(aucBuffer, IW_CUSTOM_MAX-1, "P2P_FORMATION_RST=%d%d%d%c%c", ucResult, ucRole, 1/*                    */, pucSSID[7], pucSSID[8]);
    else
        snprintf(aucBuffer, IW_CUSTOM_MAX-1, "P2P_FORMATION_RST=%d%d%d%c%c", ucResult, ucRole, 1/*                    */, '0', '0');
...
#else
        cfg80211_rx_mgmt(prGlueP2pInfo->prDevHandler, //                        
#endif /*                    */
                            i4Freq,
    ...
    )
{
    ...
    do {
        ...
        if (prP2pConnInfo) {
            ...
            /*                                          */
            cfg80211_disconnected(prGlueP2pInfo->prDevHandler, //                        
                                    u2StatusReason,
                                    pucRxIEBuf,
                                    u2RxIELen,
                                    GFP_KERNEL);
...
//                                                            
            ...
            cfg80211_new_sta(prGlueInfo->prP2PInfo->prDevHandler, //                        
            ...
            cfg80211_del_sta(prGlueInfo->prP2PInfo->prDevHandler, //                        
                            prCliStaRec->aucMacAddr,
                            GFP_KERNEL);
        }
