...
struct _WFD_CFG_SETTINGS_T {
    ...
    UINT_16  u2WfdLifetimeAc2; /*              */
    UINT_16  u2WfdLifetimeAc3; /*              */
    UINT_16  u2WfdCounterThreshold;  /*            */
...
#define P2P_ATTRI_LEN_NOTICE_OF_ABSENCE                 (P2P_ATTRI_HDR_LEN + 2) /*   */
