...
#define PLATFORM_SOC_CHIP 0x6582
...
/*       */
#define CONNSYS_CLK_GATE_STATUS_REG			(0xf8070100)
#define CONSYS_EMI_STATUS_REG			(0xf80703c0)
#define SYSRAM1_REG					(0xf8080000)
#define SYSRAM2_REG					(0xf8090004)
#define SYSRAM3_REG					(0xf80a0008)
