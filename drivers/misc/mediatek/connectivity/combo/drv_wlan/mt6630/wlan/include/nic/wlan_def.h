...
/*                          */
#define RATE_SET_BIT_1M         BIT(RATE_1M_SW_INDEX)		/*           */
#define RATE_SET_BIT_2M         BIT(RATE_2M_SW_INDEX)		/*           */
#define RATE_SET_BIT_5_5M       BIT(RATE_5_5M_SW_INDEX)		/*             */
#define RATE_SET_BIT_11M        BIT(RATE_11M_SW_INDEX)		/*            */
#define RATE_SET_BIT_22M        BIT(RATE_22M_SW_INDEX)		/*            */
#define RATE_SET_BIT_33M        BIT(RATE_33M_SW_INDEX)		/*            */
#define RATE_SET_BIT_6M         BIT(RATE_6M_SW_INDEX)		/*           */
#define RATE_SET_BIT_9M         BIT(RATE_9M_SW_INDEX)		/*           */
#define RATE_SET_BIT_12M        BIT(RATE_12M_SW_INDEX)		/*            */
#define RATE_SET_BIT_18M        BIT(RATE_18M_SW_INDEX)		/*            */
#define RATE_SET_BIT_24M        BIT(RATE_24M_SW_INDEX)		/*             */
#define RATE_SET_BIT_36M        BIT(RATE_36M_SW_INDEX)		/*             */
#define RATE_SET_BIT_48M        BIT(RATE_48M_SW_INDEX)		/*             */
#define RATE_SET_BIT_54M        BIT(RATE_54M_SW_INDEX)		/*             */
