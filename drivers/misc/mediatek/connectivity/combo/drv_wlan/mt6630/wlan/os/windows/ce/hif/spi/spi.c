...
NDIS_STATUS NdisMRegisterInterrupt(PVOID, UINT_32, UINT_32, UINT_32, BOOLEAN,	/*            */
				   BOOLEAN,	/*                 */
				   UINT_32);
...
NDIS_STATUS windowsRegisterIsrt(IN P_GLUE_INFO_T prGlueInfo)
{
	...
	rStatus = NdisMRegisterInterrupt(&prHifInfo->rInterrupt, prGlueInfo->rMiniportAdapterHandle, (UINT) prHifInfo->u4InterruptVector, (UINT) prHifInfo->u4InterruptLevel, TRUE,	/*            */
					 FALSE,	/*                 */
					 NIC_INTERRUPT_MODE);
