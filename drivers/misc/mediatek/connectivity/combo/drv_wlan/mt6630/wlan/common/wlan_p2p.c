		    ...
		    IN PVOID pvSetBuffer, IN UINT_32 u4SetBufferLen, OUT PUINT_32 pu4SetInfoLen)
{
	...
	*pu4SetInfoLen = u4SetBufferLen;
	...
	if (prNewKey->u4KeyLength == CCMP_KEY_LEN)
		...
		rCmdKey.ucAlgorithmId = CIPHER_SUITE_WEP40;	/*        */
	else if (prNewKey->u4KeyLength == WEP_104_LEN)
		rCmdKey.ucAlgorithmId = CIPHER_SUITE_WEP104;	/*         */
	else
		ASSERT(FALSE);
			      ...
			      IN UINT_32 u4SetBufferLen, OUT PUINT_32 pu4SetInfoLen)
{
	...
	*pu4SetInfoLen = sizeof(PARAM_POWER_MODE);
	...
	status = nicConfigPowerSaveProfile(prAdapter, P2P_DEV_BSS_INDEX,	/*             */
					   ePowerMode, TRUE);
	return status;
}				/*                                        */
			   ...
			   IN UINT_32 u4SetBufferLen, OUT PUINT_32 pu4SetInfoLen)
{
  ...
  */
	...
	rCmdMacMcastAddr.ucBssIndex = P2P_DEV_BSS_INDEX;	/*       */
		    ...
		    IN UINT_32 u4QueryBufferLen, OUT PUINT_32 pu4QueryInfoLen)
{
	...
	*pu4QueryInfoLen = sizeof(PARAM_RSSI);
	...
	if (prAdapter->fgIsP2pLinkQualityValid == TRUE &&
		...
		rRssi = (PARAM_RSSI) prAdapter->rP2pLinkQuality.cRssi;	/*                                        */
