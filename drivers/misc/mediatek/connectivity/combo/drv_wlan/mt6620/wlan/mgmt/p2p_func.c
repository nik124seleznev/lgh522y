...
APPEND_VAR_ATTRI_ENTRY_T txAssocRspAttributesTable[] = {
	{(P2P_ATTRI_HDR_LEN + P2P_ATTRI_MAX_LEN_STATUS), NULL, p2pFuncAppendAttriStatusForAssocRsp}	/*   */* / Status */
  ...
  */
	...
	do {
		...
		*pu2StatusCode = STATUS_CODE_REQ_DECLINED;
		...
		DBGLOG(P2P, INFO, ("Current WfdCfgSettings wfd_en %u wfd_info 0x%x  wfd_policy 0x%x wfd_flag 0x%x\n", prWfdCfgSettings->ucWfdEnable, prWfdCfgSettings->u2WfdDevInfo, prWfdCfgSettings->u4WfdPolicy, prWfdCfgSettings->u4WfdFlag));	/*       */
