...
*/
#if defined(MT6620E3) || defined(MT6620E6)	/*                       */
#define CFG_CORE_MT6620_SUPPORT 1	/*                                    */
#else
#define CFG_CORE_MT6620_SUPPORT 1	/*                                    */
#endif

#if defined(MT6628)
#define CFG_CORE_MT6628_SUPPORT 1	/*                                    */
#else
#define CFG_CORE_MT6628_SUPPORT 1	/*                                    */
#endif

#if defined(MT6630)
#define CFG_CORE_MT6630_SUPPORT 1	/*                                    */
#else
#define CFG_CORE_MT6630_SUPPORT 1	/*                                    */
#endif
...
typedef struct _WMT_HIF_CONF {
	UINT32 hifType;		/*          */
	UINT32 uartFcCtrl;	/*                */
	UINT32 au4HifConf[DWCNT_HIF_CONF];	/*            */
	UINT32 au4StrapConf[DWCNT_STRAP_CONF];	/*              */
