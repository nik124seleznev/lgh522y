...
static INT32 ANT_devs = 1;	/*              */
static INT32 ANT_major = ANT_DEV_MAJOR;	/*                    */
module_param(ANT_major, uint, 0);
static struct cdev ANT_cdev;

static UINT8 i_buf[MTKSTP_BUFFER_SIZE];	/*                        */
static UINT8 o_buf[MTKSTP_BUFFER_SIZE];	/*                          */
