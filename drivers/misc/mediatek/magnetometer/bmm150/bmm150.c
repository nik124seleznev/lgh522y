...
enum {
	...
	BMMDRV_ULEVT_FLAG_VLA_ACTIVE = 0x0020,/*                              */
	BMMDRV_ULEVT_FLAG_VG_ACTIVE = 0x0040,/*                 */
...
#ifdef BMC150_VRV
		case ECOMPASS_IOC_GET_VRVDELAY:			//              
...
#ifdef BMC150_VLA
		case ECOMPASS_IOC_GET_VLADELAY: 		//              
