...
#define LSM303M_MAG_FS_2G	(0x00)	/*                    */
#define LSM303M_MAG_FS_4G	(0x20)	/*                    */
#define LSM303M_MAG_FS_8G	(0x40)	/*                    */
#define LSM303M_MAG_FS_12G	(0x60)	/*                     */
...
#define LSM303M_MAG_POWER_ON	  (0x00)  /*          */
#define LSM303M_MAG_POWER_OFF	  (0x02)  /*          */


#define ODR_MAG_MASK		  (0X1C)	/*                            */
#define LSM303M_MAG_ODR3_125  (0x00)  /*                         */
#define LSM303M_MAG_ODR6_25	  (0x04)  /*                         */
#define LSM303M_MAG_ODR12_5	  (0x08)  /*                         */
#define LSM303M_MAG_ODR25	  (0x0C)  /*                       */
#define LSM303M_MAG_ODR50	  (0x10)  /*                       */
#define LSM303M_MAG_ODR100	  (0x14)  /*                        */
