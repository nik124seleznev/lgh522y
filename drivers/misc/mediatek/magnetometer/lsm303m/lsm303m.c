	...
	switch (command)
	{
		case SENSOR_DELAY:
			...
			else
			{
				...
				lsm303mmid_data.controldata[0] = value;  //           
			}	
			break;
	...
	switch (command)
	{
		case SENSOR_DELAY:
			...
			else
			{
				...
				lsm303mmid_data.controldata[0] = sample_delay;  //           
			}	
			break;
