...
#define LSM303C_M_NEW_ARCH   //                           

#ifdef LSM303C_M_NEW_ARCH
#include "mag.h"

static int lsm303c_init_flag =-1; //                     
...
static int lsm303c_set_delay(u64 delay)
{
	...
	lsm303cmid_data.controldata[0] = value;  //           
