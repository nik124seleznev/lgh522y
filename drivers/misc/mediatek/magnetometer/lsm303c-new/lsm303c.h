...
#define SENSITIVITY_MAG_16G	480	/*             */

#define LSM303C_MAG_POWER_ON	  (0x00)  /*          */
#define LSM303C_MAG_POWER_OFF	  (0x02)  /*          */


#define ODR_MAG_MASK		  (0X1C)	/*                            */
//                                                                   
#define LSM303C_MAG_ODR_625	  (0x00)  /*                          */
#define LSM303C_MAG_ODR1_25	  (0x04)  /*                         */
#define LSM303C_MAG_ODR2_5	  (0x08)  /*                        */
#define LSM303C_MAG_ODR5	  (0x0c)  /*                      */
#define LSM303C_MAG_ODR10	  (0x10)  /*                       */
#define LSM303C_MAG_ODR20	  (0x14)  /*                       */
#define LSM303C_MAG_ODR40	  (0x18)  /*                       */
#define LSM303C_MAG_ODR80	  (0x1c)  /*                       */
