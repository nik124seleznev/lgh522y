...
static struct s3c_irq_data init_eint[32] = {
	...
	{ .type = S3C_IRQTYPE_NONE, }, /*          */
	{ .type = S3C_IRQTYPE_NONE, }, /*          */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 5 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 5 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 5 }, /*        */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 5 }, /*        */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 5 }, /*        */
...
static struct s3c_irq_data init_s3c2410base[32] = {
	{ .type = S3C_IRQTYPE_EINT, }, /*       */
	{ .type = S3C_IRQTYPE_EINT, }, /*       */
	{ .type = S3C_IRQTYPE_EINT, }, /*       */
	{ .type = S3C_IRQTYPE_EINT, }, /*       */
	{ .type = S3C_IRQTYPE_LEVEL, }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, }, /*           */
	{ .type = S3C_IRQTYPE_NONE, }, /*          */
	{ .type = S3C_IRQTYPE_EDGE, }, /*           */
	{ .type = S3C_IRQTYPE_EDGE, }, /*      */
	{ .type = S3C_IRQTYPE_EDGE, }, /*     */
	{ .type = S3C_IRQTYPE_EDGE, }, /*        */
	{ .type = S3C_IRQTYPE_EDGE, }, /*        */
...
static struct s3c_irq_data init_s3c2410subint[32] = {
	...
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 28 }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 28 }, /*           */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 23 }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 23 }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 23 }, /*           */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 15 }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 15 }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 15 }, /*           */
	{ .type = S3C_IRQTYPE_EDGE, .parent_irq = 31 }, /*    */
	{ .type = S3C_IRQTYPE_EDGE, .parent_irq = 31 }, /*     */
};
...
static struct s3c_irq_data init_s3c2412eint[32] = {
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 0 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 1 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 2 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 3 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
	{ .type = S3C_IRQTYPE_EINT, .parent_irq = 4 }, /*       */
...
static struct s3c_irq_data init_s3c2412subint[32] = {
	...
	{ .type = S3C_IRQTYPE_NONE, },
	{ .type = S3C_IRQTYPE_NONE, },
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 21 }, /*     */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 21 }, /*    */
};
...
static struct s3c_irq_data init_s3c2416subint[32] = {
	...
	{ .type = S3C_IRQTYPE_NONE }, /*          */
	{ .type = S3C_IRQTYPE_NONE }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 16 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 16 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 16 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 17 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 17 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 17 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 17 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 17 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 17 }, /*      */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 18 }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 18 }, /*          */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 18 }, /*           */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 9 }, /*     */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 9 }, /*      */
};
...
static struct s3c_irq_data init_s3c2440subint[32] = {
	...
	{ .type = S3C_IRQTYPE_EDGE, .parent_irq = 31 }, /*    */
	{ .type = S3C_IRQTYPE_EDGE, .parent_irq = 31 }, /*     */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 6 }, /*       */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 6 }, /*       */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 9 }, /*     */
	{ .type = S3C_IRQTYPE_LEVEL, .parent_irq = 9 }, /*      */
};
