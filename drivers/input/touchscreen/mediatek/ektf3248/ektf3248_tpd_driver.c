...
#ifdef ELAN_3K_IC_SOLUTION
uint8_t I2C_DATA[3] = {0x10, 0x20, 0x21};/*                   */  
#else
uint8_t I2C_DATA[3] = {0x15, 0x20, 0x21};/*                   */  
#endif
...
static int __fw_packet_handler(struct i2c_client *client)
{
         ...
         //                                                                          
         uint8_t cmd_bc[] = {CMD_R_PKT, 0x10, 0x00, 0x01};/*                     */
         uint8_t buf_recv[8] = {0};
