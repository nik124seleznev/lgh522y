...
#define FW_LINK_LENGTH               0x3000                    //    
#define FW_APP_CODE_LENGTH           (4 * FW_SECTION_LENGTH)   //    
...
static u8 gup_burn_dsp_isp(struct i2c_client *client)
{
    ...
    gup_show_elements(update_msg.fw_total_len + FW_HEAD_LENGTH - FW_DSP_ISP_LENGTH, fw_dsp_isp, 10); //         
...
static u8 gup_burn_fw_boot_isp(struct i2c_client *client)
{
    ...
    gup_show_elements((4*FW_SECTION_LENGTH+FW_DSP_LENGTH+FW_BOOT_LENGTH+FW_DSP_ISP_LENGTH), fw_boot_isp, 10); //         
    //                     
...
static u8 gup_burn_fw_link(struct i2c_client *client)
{
    ...
    gup_show_elements((update_msg.fw_burned_len - FW_DSP_ISP_LENGTH), fw_link, 10); //         
...
static u8 gup_burn_fw_app_code(struct i2c_client *client)
{
    ...
    gup_show_elements(start_index, fw_app_code, 10);   //         
    //                                      
    ...
    gup_show_elements(start_index+FW_SECTION_LENGTH, fw_app_code, 10);   //         
    //                                      
    ...
    gup_show_elements(start_index+2*FW_SECTION_LENGTH, fw_app_code, 10);   //         
    //                                      
    ...
    gup_show_elements(start_index + 3*FW_SECTION_LENGTH, fw_app_code, 10 );   //         
    //                                       
...
static u8 gup_download_fw_ss51(struct i2c_client *client, u8 dwn_mode)
{
    ...
    ret = i2c_write_bytes(client, 0xC000, &gtp_default_FW_fl[FW_HEAD_LENGTH+FW_DOWNLOAD_LENGTH],FW_DOWNLOAD_LENGTH);  //                      
