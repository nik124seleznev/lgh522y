...
#define CY_CMD_LDR_SEND_DATA_CMD_SIZE			4 /*                */
#define CY_CMD_LDR_SEND_DATA_STAT_SIZE			8
#define CY_CMD_LDR_PROG_ROW				0x39
#define CY_CMD_LDR_PROG_ROW_CMD_SIZE			7 /*                */
	...
	struct cyttsp4_hex_image *row_image)
{
	...
	ldr_verify_row_cmd[i++] = 0x03;	/*              */
	ldr_verify_row_cmd[i++] = 0x00;	/*              */
