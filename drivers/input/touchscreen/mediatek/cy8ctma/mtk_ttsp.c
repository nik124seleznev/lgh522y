...
#define CYTTSP4_I2C_IRQ_GPIO 70	/*                        */
#define CYTTSP4_I2C_RST_GPIO 10	/*                        */
...
extern void printGPIO_Status(int gpioIdx);  //                        

/*               */
#define GPIO_CTP_EINT_PIN         GPIO5 //             
	...
	if (on) {
		...
		if(1/*                                            */)
		{
			...
			hwPowerOn(MT6323_POWER_LDO_VGP3, VOL_1800, "TP");
    			//                                                   
    			pmic_config_interface(0x0534, 0xb, 0xf, 8);	//      
#else
			//    
#endif
