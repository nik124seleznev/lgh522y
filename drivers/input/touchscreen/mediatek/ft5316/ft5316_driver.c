...
//       
	...
	if(tpd_halt) 
		...
		queue_delayed_work(ctp_read_id_workqueue, &ctp_read_id_work,400); //                                            
...
reset_proc:   
	...
	ret = queue_delayed_work(ctp_read_id_workqueue, &ctp_read_id_work,400); //                                            
    	printk("[TSP] ret =%d\n",ret);
#endif		
