...
#define DCS_CMD_DATA_REG		0x40 /*        */
#define DCS_CMD_SEND_REG		0x46 /*        */
#define DISPLAY_OFF_VAL			0x28 /*        */
#define DISPLAY_ON_VAL			0x29 /*        */
#define SLEEP_IN_VAL			0x01 /*        */
#define SLEEP_OUT_VAL			0x11 /*        */
...
static int lpwg_control(struct i2c_client *client)
{
	...
	switch (ts->currState)
	{
		...
		case STATE_KNOCK_ON_ONLY:					//           
			...
			tci_control(client, MIN_INTERTAP_CTRL, 6);		//                     
