...
#define MELFAS_DOWNLOAD 1 //           
#define MELFAS_CE_PIN_CONTROL 0//        
...
#define TS_READ_HW_VER_ADDR 0xC1 //               
#define TS_READ_SW_VER_ADDR 0xC0 //               
#define MELFAS_FW_VERSION   0xC3 //               
#define MELFAS_CHIP_FW_VERSION   0xC4 //               
...
static int __init melfas_tpd_driver_init(void)
{
    ...
    mt_set_gpio_mode(GPIO_GPS_SYNC_PIN, 1); //         
