...
#define THERMAL_HIGH_FINGER_AMPLITUDE		0x80	/*                              */
 ...
 */
	...
	buf =0;
	DO_SAFE(synaptics_ts_read(client, INTERRUPT_STATUS_REG, 1, &buf), error);//                                                       
