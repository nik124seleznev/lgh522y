...
enum {
	...
	SYNAPTICS_RMI4_I2C_DEBUG_FUNC_TRACE			= 1U << 0,	/*   */
	SYNAPTICS_RMI4_I2C_DEBUG_INT_STATUS			= 1U << 1,	/*   */
	SYNAPTICS_RMI4_I2C_DEBUG_FINGER_STATUS		= 1U << 2,	/*   */
	SYNAPTICS_RMI4_I2C_DEBUG_FINGER_POSITION	= 1U << 3,	/*   */
	SYNAPTICS_RMI4_I2C_DEBUG_FINGER_REG			= 1U << 4,	/*    */
	SYNAPTICS_RMI4_I2C_DEBUG_BUTTON_STATUS		= 1U << 5,	/*    */
	SYNAPTICS_RMI4_I2C_DEBUG_BUTTON_REG			= 1U << 6,	/*    */
	SYNAPTICS_RMI4_I2C_DEBUG_INT_INTERVAL		= 1U << 7,	/*     */
	SYNAPTICS_RMI4_I2C_DEBUG_INT_ISR_DELAY		= 1U << 8,	/*     */
	SYNAPTICS_RMI4_I2C_DEBUG_FINGER_HANDLE_TIME	= 1U << 9,	/*     */
	SYNAPTICS_RMI4_I2C_DEBUG_BUTTON_HANDLE_TIME	= 1U << 10,	/*      */
	SYNAPTICS_RMI4_I2C_DEBUG_UPGRADE_DELAY		= 1U << 11,	/*      */
};
