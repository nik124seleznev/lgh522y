...
nv30_graph_sclass[] = {
	...
	{ 0x0362, &nv04_graph_ofuncs, NULL }, /*               */
	{ 0x0389, &nv04_graph_ofuncs, NULL }, /*             */
	{ 0x038a, &nv04_graph_ofuncs, NULL }, /*            */
	{ 0x039e, &nv04_graph_ofuncs, NULL }, /*                */
	{ 0x0397, &nv04_graph_ofuncs, NULL }, /*         */
	{},
};
...
nv30_graph_init(struct nouveau_object *object)
{
	...
	nv_wr32(priv, 0x400B88, 0x62ff00ff); /*                                  */
