...
#define AD7923_WRITE_CR		(1 << 11)	/*                        */
#define AD7923_RANGE		(1 << 1)	/*                */
#define AD7923_CODING		(1 << 0)	/*                           */
#define AD7923_PM_MODE_AS	(1)		/*               */
#define AD7923_PM_MODE_FS	(2)		/*               */
#define AD7923_PM_MODE_OPS	(3)		/*                  */
#define AD7923_CHANNEL_0	(0)		/*                */
#define AD7923_CHANNEL_1	(1)		/*                */
#define AD7923_CHANNEL_2	(2)		/*                */
#define AD7923_CHANNEL_3	(3)		/*                */
