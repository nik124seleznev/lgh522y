...
static struct intc_group groups[] __initdata = {
	...
	/*            */
	INTC_GROUP(STIF_M, STIF0, STIF1), /*    */
	INTC_GROUP(GPIO_M, GPIO0_3, GPIO4_5), /*    */
	INTC_GROUP(HPBDMAC_M, HPBDMAC0_3, HPBDMAC4_10, HPBDMAC11_18,
			HPBDMAC19_22, HPBDMAC23_25_27_28), /*    */
	INTC_GROUP(LBSCDMAC_M, LBSCDMAC0, LBSCDMAC1, LBSCDMAC2), /*    */
	INTC_GROUP(RCAN_M, RCAN0, RCAN1, IEBUS), /*    */
	INTC_GROUP(SRC_M, SRC0, SRC1), /*    */
	INTC_GROUP(SCIF_M, SCIF0, SCIF1, SCIF2, SCIF3, SCIF4, SCIF5,
			HSCIF), /*    */
	INTC_GROUP(LCDC_M, LCDC, MIMLB), /*    */
	INTC_GROUP(_2DG_M, _2DG, RGPVG), /*    */
	INTC_GROUP(VIN_M, VIN0, VIN1), /*    */
	INTC_GROUP(TMU_3_M, TMU30, TMU40, TMU50, TMU51,
			TMU60, TMU60, TMU70, TMU80), /*   */
	INTC_GROUP(TMU_0_M, TMU00, TMU10, TMU20, TMU21), /*   */

	/*               */
	INTC_GROUP(RCAN_P, RCAN0, RCAN1), /*          */
	INTC_GROUP(LBSCDMAC_P, LBSCDMAC0, LBSCDMAC1), /*          */
};

static struct intc_mask_reg mask_registers[] __initdata = {
	{ 0xFF804040, 0xFF804044, 32, /*                       */
	  { 0,
		VEU3F_VE3,
		SDHI, /*          */
		ADMAC,
