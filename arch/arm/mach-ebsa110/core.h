...
/*                   */
#define PIT_BASE		IOMEM(0xfc000000)	/*         */
#define SOFT_BASE		IOMEM(0xfd000000)	/*         */
#define IRQ_MASK		IOMEM(0xfe000000)	/*                */
#define IRQ_MSET		IOMEM(0xfe000000)	/*                 */
#define IRQ_STAT		IOMEM(0xff000000)	/*                */
#define IRQ_MCLR		IOMEM(0xff000000)	/*                 */
