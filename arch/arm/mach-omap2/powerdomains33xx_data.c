...
static struct powerdomain gfx_33xx_pwrdm = {
	...
	.mem_on_mask		= {
		[0]		= AM33XX_GFX_MEM_ONSTATE_MASK,	/*         */
	},
	.mem_ret_mask		= {
		[0]		= AM33XX_GFX_MEM_RETSTATE_MASK,	/*         */
	},
	.mem_pwrst_mask		= {
		[0]		= AM33XX_GFX_MEM_STATEST_MASK,	/*         */
	},
	.mem_retst_mask		= {
		[0]		= AM33XX_GFX_MEM_RETSTATE_MASK,	/*         */
	},
...
static struct powerdomain per_33xx_pwrdm = {
	...
	.logicretstate_mask	= AM33XX_LOGICRETSTATE_3_3_MASK,
	.mem_on_mask		= {
		[0]		= AM33XX_PRUSS_MEM_ONSTATE_MASK, /*           */
		[1]		= AM33XX_PER_MEM_ONSTATE_MASK,	/*         */
		[2]		= AM33XX_RAM_MEM_ONSTATE_MASK,	/*         */
	},
	.mem_ret_mask		= {
		[0]		= AM33XX_PRUSS_MEM_RETSTATE_MASK, /*           */
		[1]		= AM33XX_PER_MEM_RETSTATE_MASK,	/*         */
		[2]		= AM33XX_RAM_MEM_RETSTATE_MASK,	/*         */
	},
	.mem_pwrst_mask		= {
		[0]		= AM33XX_PRUSS_MEM_STATEST_MASK, /*           */
		[1]		= AM33XX_PER_MEM_STATEST_MASK,	/*         */
		[2]		= AM33XX_RAM_MEM_STATEST_MASK,	/*         */
	},
	.mem_retst_mask		= {
		[0]		= AM33XX_PRUSS_MEM_RETSTATE_MASK, /*           */
		[1]		= AM33XX_PER_MEM_RETSTATE_MASK,	/*         */
...
static struct powerdomain mpu_33xx_pwrdm = {
	...
	.logicretstate_mask	= AM33XX_LOGICRETSTATE_MASK,
	.mem_on_mask		= {
		[0]		= AM33XX_MPU_L1_ONSTATE_MASK,	/*        */
		[1]		= AM33XX_MPU_L2_ONSTATE_MASK,	/*        */
		[2]		= AM33XX_MPU_RAM_ONSTATE_MASK,	/*         */
	},
	.mem_ret_mask		= {
		[0]		= AM33XX_MPU_L1_RETSTATE_MASK,	/*        */
		[1]		= AM33XX_MPU_L2_RETSTATE_MASK,	/*        */
		[2]		= AM33XX_MPU_RAM_RETSTATE_MASK,	/*         */
	},
	.mem_pwrst_mask		= {
		[0]		= AM33XX_MPU_L1_STATEST_MASK,	/*        */
		[1]		= AM33XX_MPU_L2_STATEST_MASK,	/*        */
		[2]		= AM33XX_MPU_RAM_STATEST_MASK,	/*         */
	},
	.mem_retst_mask		= {
		[0]		= AM33XX_MPU_L1_RETSTATE_MASK,	/*        */
		[1]		= AM33XX_MPU_L2_RETSTATE_MASK,	/*        */
