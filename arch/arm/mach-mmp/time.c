...
static void __init timer_config(void)
{
	...
	__raw_writel(0x0, mmp_timer_base + TMR_CER); /*         */
	...
	__raw_writel(0x1, mmp_timer_base + TMR_PLCR(0)); /*          */
	__raw_writel(0x7, mmp_timer_base + TMR_ICR(0));  /*              */
	__raw_writel(0x0, mmp_timer_base + TMR_IER(0));

	__raw_writel(0x0, mmp_timer_base + TMR_PLCR(1)); /*              */
	__raw_writel(0x7, mmp_timer_base + TMR_ICR(1));  /*              */
