...
static const pcm_desc_t pcm_suspend = {
    ...
    .vec1   = EVENT_VEC(12, 1, 0, 28),      /*                 */
    .vec2   = EVENT_VEC(30, 1, 0, 59),      /*                  */
    .vec3   = EVENT_VEC(31, 1, 0, 103),     /*                   */
};
...
static const pcm_desc_t pcm_dpidle = {
    ...
    .sess   = 2,
    .vec0   = EVENT_VEC(11, 1, 0, 0),       /*                */
    .vec1   = EVENT_VEC(12, 1, 0, 11),      /*                 */
    .vec2   = EVENT_VEC(30, 1, 0, 32),      /*                  */
    .vec3   = EVENT_VEC(31, 1, 0, 72),      /*                   */
};
#else
static const u32 __pcm_dpidle[] = {
...
static const pcm_desc_t pcm_dpidle = {
    ...
    .sess   = 2,
    .vec0   = EVENT_VEC(11, 1, 0, 0),       /*                */
    .vec1   = EVENT_VEC(12, 1, 0, 9),       /*                 */
    .vec2   = EVENT_VEC(30, 1, 0, 28),      /*                  */
    .vec3   = EVENT_VEC(31, 1, 0, 68),      /*                   */
};
#endif
...
static void spm_set_pwrctl_for_sleep(void)
{
    ...
    spm_write(SPM_AP_STANBY_CON, (0x3 << 19) |  /*                    */
                                 (0 << 16) |    /*                   */
                                 (0 << 6) |     /*                */
                                 (0 << 5) |     /*                */
                                 (1U << 4));    /*            */
...
static void spm_trigger_wfi_for_sleep(bool cpu_pdn, bool infra_pdn)
{
    ...
    spm_write(PERI_PDN0_CLR, pdn0);     /*               */
    spm_write(0xF1008010, 0);           /*                   */
    spm_write(0xF1008018, 0x1);         /*                       */
    spm_write(0xF1008028, 0x1800);      /*                    */
    spm_write(0xF1008040, 0x3);         /*                     */
    spm_write(0xF1008048, 0x102);       /*              */
#endif
