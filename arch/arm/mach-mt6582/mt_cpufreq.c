...
#define FHCTL_CHANGE_FREQ (1000000) //                                                 
...
#define DVFS_F0_1   (1690000)   //    
#define DVFS_F0_2   (1599000)   //    
#define DVFS_F0_3   (1495000)   //    
#define DVFS_F0_4   (1391000)   //    
#define DVFS_F0     (1300000)   //    
#define DVFS_F1     (1196000)   //    
#define DVFS_F1_1   (1092000)   //    
#define DVFS_F2     (1040000)   //    
#define DVFS_F2_1   (1001000)   //    
#define DVFS_F3     ( 747500)   //    
#define DVFS_F4     ( 598000)   //    
...
/*                                        
                                         ...
                                         */
#define PMIC_SETTLE_TIME (40) //   

/*                                        
                                        
                                         */
#define PLL_SETTLE_TIME (30) //   
...
#define P_MCL99_105C_L  (658)   //                           
#define P_MCL99_25C_L   (93)    //                          
#define P_MCL50_105C_L  (316)   //                           
...
#define P_MCU_D ((P_MCU_T - P_MCU_L) - 4 * (P_CA7_T - P_CA7_L)) //                                      

#define P_TOTAL_CORE_L ((P_MCL99_105C_L  * 42165) / 100000) //                      
...
static void mt_setup_power_table(int num)
{
    ...
    for (i = 0; i < num; i++)
    {
        for (j = 0; j < possiblecpu; j++)
        {
            ...
            g_cpu_power_table_num = num * possiblecpu - 2; /*                                        */
        }
    }
...
{
#if 0
    mt_cpufreq_reg_write(0x50, PMIC_WRAP_DVFS_WDATA0); //            
    mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA1); //            
    #ifdef MT_DVFS_LOW_VOLTAGE_SUPPORT
    mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA2); //            
    #else
    mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA2); //            
    #endif
    mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA3); //            
    mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA4); //            
    mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA5); //                                          
    mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA6); //                                          
    mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA7); //                                          
    ...
    #endif
    mt_cpufreq_pmic_volt[3] = 0x48; //            
    mt_cpufreq_pmic_volt[4] = 0x48; //            
    mt_cpufreq_pmic_volt[5] = 0x48; //                                          
    mt_cpufreq_pmic_volt[6] = 0x38; //                                          
    mt_cpufreq_pmic_volt[7] = 0x48; //                                          
    ...
    if((g_cpufreq_get_ptp_level >= 0) && (g_cpufreq_get_ptp_level <= 4))
    {
            ...
            mt_cpufreq_reg_write(0x50, PMIC_WRAP_DVFS_WDATA0); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA1); //            
            mt_cpufreq_reg_write(0x3D, PMIC_WRAP_DVFS_WDATA2); //            
            mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA3); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA4); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA5); //                                          
            mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA6); //                                          
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA7); //                                          
            ...
            mt_cpufreq_pmic_volt[7] = 0x48; //                                          
        #elif defined(HQA_NV_1_15V)
            mt_cpufreq_reg_write(0x5A, PMIC_WRAP_DVFS_WDATA0); //            
            mt_cpufreq_reg_write(0x50, PMIC_WRAP_DVFS_WDATA1); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA2); //            
            mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA3); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA4); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA5); //                                          
            ...
            mt_cpufreq_pmic_volt[7] = 0x48; //                                          
        #elif defined(HQA_HV_1_21V)
            mt_cpufreq_reg_write(0x64, PMIC_WRAP_DVFS_WDATA0); //            
            mt_cpufreq_reg_write(0x52, PMIC_WRAP_DVFS_WDATA1); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA2); //            
            mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA3); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA4); //            
            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA5); //                                          
            ...
            /*            */
            mt_cpufreq_pmic_volt[0] = 0x64; //            
            mt_cpufreq_pmic_volt[1] = 0x52; //            
            mt_cpufreq_pmic_volt[2] = 0x48; //            
            mt_cpufreq_pmic_volt[3] = 0x38; //            
            mt_cpufreq_pmic_volt[4] = 0x48; //            
            mt_cpufreq_pmic_volt[5] = 0x48; //                                          
			...
			if(g_cpufreq_get_vcore_corner == false)
			{
	            mt_cpufreq_reg_write(0x58, PMIC_WRAP_DVFS_WDATA0); //            
	            mt_cpufreq_reg_write(0x50, PMIC_WRAP_DVFS_WDATA1); //            
	            mt_cpufreq_reg_write(0x48, PMIC_WRAP_DVFS_WDATA2); //            
				#ifdef MT_DVFS_LOW_VOLTAGE_SUPPORT
	            mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA3); //            
			...
			else
			{
	            mt_cpufreq_reg_write(0x58, PMIC_WRAP_DVFS_WDATA0); //            
	            mt_cpufreq_reg_write(0x50, PMIC_WRAP_DVFS_WDATA1); //            
	            mt_cpufreq_reg_write(0x4E, PMIC_WRAP_DVFS_WDATA2); //                       
				#ifdef MT_DVFS_LOW_VOLTAGE_SUPPORT
	            mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA3); //            
				#else
	            mt_cpufreq_reg_write(0x4E, PMIC_WRAP_DVFS_WDATA3); //             
				#endif
	            mt_cpufreq_reg_write(0x4E, PMIC_WRAP_DVFS_WDATA4); //             
	            mt_cpufreq_reg_write(0x4E, PMIC_WRAP_DVFS_WDATA5); //                                           
	            mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA6); //                                          
	            mt_cpufreq_reg_write(0x4E, PMIC_WRAP_DVFS_WDATA7); //                                           
			
	            /*            */
	            mt_cpufreq_pmic_volt[0] = 0x58; //            
	            mt_cpufreq_pmic_volt[1] = 0x50; //            
	            mt_cpufreq_pmic_volt[2] = 0x4E; //                       
				#ifdef MT_DVFS_LOW_VOLTAGE_SUPPORT
	            mt_cpufreq_pmic_volt[3] = 0x38; //            
				#else
	            mt_cpufreq_pmic_volt[3] = 0x4E; //             
				#endif
	            mt_cpufreq_pmic_volt[4] = 0x4E; //             
	            mt_cpufreq_pmic_volt[5] = 0x4E; //                                           
	            mt_cpufreq_pmic_volt[6] = 0x38; //                                          
	            mt_cpufreq_pmic_volt[7] = 0x4E; //                                           
			}
    ...
    else if((g_cpufreq_get_ptp_level >= 5) && (g_cpufreq_get_ptp_level <= 6))
    {
		...
		{
	        mt_cpufreq_reg_write(0x50, PMIC_WRAP_DVFS_WDATA0); //            
	        mt_cpufreq_reg_write(0x4E, PMIC_WRAP_DVFS_WDATA1); //                       
			#ifdef MT_DVFS_LOW_VOLTAGE_SUPPORT
	        mt_cpufreq_reg_write(0x38, PMIC_WRAP_DVFS_WDATA2); //            
			#else
	        mt_cpufreq_reg_write(0x4E, PMIC_WRAP_DVFS_WDATA2); //             
...
static ssize_t mt_cpufreq_ptpod_test_write(struct file *file, const char *buffer, unsigned long count, void *data)
{
    ...
    if (sscanf(buffer, "%d", &enable) == 1)
    {
        if (enable == 0) 
        {
            mt_cpufreq_ptpod_test[0] = 0x58; //            
            mt_cpufreq_ptpod_test[1] = 0x50; //            
            mt_cpufreq_ptpod_test[2] = 0x48; //            
            #ifdef MT_DVFS_LOW_VOLTAGE_SUPPORT
            mt_cpufreq_ptpod_test[3] = 0x38; //            
            #else
            mt_cpufreq_ptpod_test[3] = 0x48; //            
            #endif
            mt_cpufreq_ptpod_test[4] = 0x48; //            
            mt_cpufreq_ptpod_test[5] = 0x48; //                                          
            mt_cpufreq_ptpod_test[6] = 0x38; //                                          
            mt_cpufreq_ptpod_test[7] = 0x48; //                                          
        ...
        {
            mt_cpufreq_ptpod_test[0] = 0x57; //            
            mt_cpufreq_ptpod_test[1] = 0x4F; //            
            mt_cpufreq_ptpod_test[2] = 0x47; //            
            #ifdef MT_DVFS_LOW_VOLTAGE_SUPPORT
            mt_cpufreq_ptpod_test[3] = 0x37; //            
            #else
            mt_cpufreq_ptpod_test[3] = 0x47; //            
            #endif
            mt_cpufreq_ptpod_test[4] = 0x47; //            
            mt_cpufreq_ptpod_test[5] = 0x47; //                                          
            mt_cpufreq_ptpod_test[6] = 0x37; //                                          
            mt_cpufreq_ptpod_test[7] = 0x47; //                                          
