...
static int ts_tran_count(void){
    ...
    *((unsigned int *) MCU_BIU_EVENT0_SEL) = 0x2; //                                     
    //                                                          
    *((unsigned int *) MCU_BIU_EVENT1_SEL) = 0x0; //         
    *((unsigned int *) MCU_BIU_EVENT0_CON) = 0x1; //                  
    *((unsigned int *) MCU_BIU_EVENT1_CON) = 0x1; //                 
    *((unsigned int *) MCU_BIU_PMCR) |= 0x2; //                    
    *((unsigned int *) MCU_BIU_PMCR) &= ~0x2; //                          
#endif
