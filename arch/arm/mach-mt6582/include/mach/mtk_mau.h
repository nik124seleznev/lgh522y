...
typedef enum {
    ...
    MAU0_MASK_JPGDMA_R,  //   
    MAU0_MASK_JPGDMA_W,  //   
    MAU0_MASK_ROT_DMA0_OUT1,//   
    MAU0_MASK_ROT_DMA0_OUT2,//   
    MAU0_MASK_ROT_DMA1_OUT1,//   
    MAU0_MASK_ROT_DMA1_OUT2,//   
    MAU0_MASK_TV_ROT_OUT1,  //       
    MAU0_MASK_TV_ROT_OUT2,  //       
    MAU0_MASK_R_DMA0_OUT3, //       
    MAU0_MASK_JPG_DEC1,    //   
...
typedef enum {
    ...
    MAU1_MASK_DPI_HWC,
    MAU1_MASK_VRZ,            //  
    MAU1_MASK_ROT_DMA2_OUT1,  //  
    MAU1_MASK_ROT_DMA2_OUT2,  //  
    MAU1_MASK_ROT_DMA3_OUT1,  //  
    MAU1_MASK_ROT_DMA3_OUT2,  //  
    MAU1_MASK_ROT_DMA4_OUT1,  //  
    MAU1_MASK_ROT_DMA4_OUT2,  //  
    MAU1_MASK_GREQ_BLKW,      //  
    MAU1_MASK_GREQ_BLKR,      //  
    MAU1_MASK_TVC_PFH,      //      
    MAU1_MASK_TVC_RESZ,      //      
    MAU1_MASK_R_DMA1_OUT3,      //      
    MAU1_MASK_EIS,          //  
...
typedef struct
{
    MTK_MAU_ENTRY   EntryID;						    //             
    bool            Enable;
    MTK_MAU_MODE    Mode;
    unsigned int    InvalidMasterLARB0;	//                                                                         
	unsigned int    InvalidMasterLARB1;    //                                                                       
