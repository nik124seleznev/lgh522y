...
/*                    
                     ...
                     */
#define GPU_DVFS_F1     (476666)   //    
#define GPU_DVFS_F2     (403000)   //    
#define GPU_DVFS_F3     (357500)   //    
#define GPU_DVFS_F4     (312000)   //    
#define GPU_DVFS_F5     (286000)   //    
#define GPU_DVFS_F6     (268666)   //    
#define GPU_DVFS_F7     (238333)   //    
#define GPU_DVFS_F8     (156000)   //    
...
#define GPU_COUNT_OVERFLOW 1000000 //      
#endif
...
enum mt_gpufreq_clock_ratio {
	GPU_DVFS_CLOCK_RATIO_OFF = 0,  /*                      */
	GPU_DVFS_CLOCK_RATIO_ON	    ,  /*                     */
	GPU_DVFS_CLOCK_RATIO_GET       /*                                         */
};
#endif
