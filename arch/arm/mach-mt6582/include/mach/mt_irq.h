...
#undef X_DEFINE_IRQ
#define MT6582_AHB_SLAVE_HIF_IRQ_ID         WF_HIF_IRQ_ID /*       */
...
#if 1 //     
#define MT6582_GPT_IRQ_ID                   (GIC_PRIVATE_SIGNALS + 112)//           
#define MT_EINT_IRQ_ID                      (GIC_PRIVATE_SIGNALS + 113)//           
#else
#define MT6582_GPT_IRQ_ID                   (GIC_PRIVATE_SIGNALS + 113)//           
#define MT_EINT_IRQ_ID                      (GIC_PRIVATE_SIGNALS + 116)//           
#endif
#define MT6582_PMIC_WRAP_IRQ_ID             (GIC_PRIVATE_SIGNALS + 115)//    
