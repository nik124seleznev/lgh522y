...
#define SENINF_REG_RANGE    (0x1000)   //                                                              
//                                                                                                   
//                                                                                                     
...
#define MIPIRX_ANALOG_ADDR   0x10010000 //                                                         
...
//              
#define ISP_REG_MASK_DMAB_INT_ERR       //                                 
...
//              
#define ISP_REG_MASK_DMAC_INT_ERR       //                                 
...
{
//                                                                
    MUINT32               CAM_CTL_START;           //                                    
    MUINT32                 CAM_CTL_EN1;           //     
    MUINT32                 CAM_CTL_EN2;           //     
    MUINT32              CAM_CTL_DMA_EN;           //     
    MUINT32             CAM_CTL_FMT_SEL;           //     
    MUINT32                    rsv_4014;           //     
    MUINT32                 CAM_CTL_SEL;           //     
    MUINT32              CAM_CTL_PIX_ID;           //     
    MUINT32              CAM_CTL_INT_EN;           //     
    MUINT32          CAM_CTL_INT_STATUS;           //     
    MUINT32             CAM_CTL_DMA_INT;           //     
    MUINT32             CAM_CTL_INTB_EN;           //     
    MUINT32         CAM_CTL_INTB_STATUS;           //     
    MUINT32            CAM_CTL_DMAB_INT;           //     
    MUINT32             CAM_CTL_INTC_EN;           //     
    MUINT32         CAM_CTL_INTC_STATUS;           //     
    MUINT32            CAM_CTL_DMAC_INT;           //     
    MUINT32         CAM_CTL_INT_STATUSX;           //     
    MUINT32            CAM_CTL_DMA_INTX;           //     
    MUINT32                    rsv_404C;           //     
    MUINT32                CAM_CTL_TILE;           //     
    MUINT32              CAM_CTL_TCM_EN;           //     
    MUINT32            CAM_CTL_SRAM_CFG;           //     
    MUINT32              CAM_CTL_SW_CTL;           //     
    MUINT32              CAM_CTL_SPARE0;           //     
    MUINT32              CAM_CTL_SPARE1;           //     
    MUINT32              CAM_CTL_SPARE2;           //     
    MUINT32              CAM_CTL_SPARE3;           //     
    MUINT32                    rsv_4070;           //     
    MUINT32             CAM_CTL_MUX_SEL;           //     
    MUINT32            CAM_CTL_MUX_SEL2;           //     
    MUINT32        CAM_CTL_SRAM_MUX_CFG;           //     
    MUINT32             CAM_CTL_EN1_SET;           //     
    MUINT32             CAM_CTL_EN1_CLR;           //     
    MUINT32             CAM_CTL_EN2_SET;           //     
    MUINT32             CAM_CTL_EN2_CLR;           //     
    MUINT32          CAM_CTL_DMA_EN_SET;           //     
    MUINT32          CAM_CTL_DMA_EN_CLR;           //     
    MUINT32         CAM_CTL_FMT_SEL_SET;           //     
    MUINT32         CAM_CTL_FMT_SEL_CLR;           //     
    MUINT32             CAM_CTL_SEL_SET;           //     
    MUINT32             CAM_CTL_SEL_CLR;           //     
    MUINT32        CAM_CTL_CQ0_BASEADDR;           //     
    MUINT32        CAM_CTL_CQ1_BASEADDR;           //     
    MUINT32        CAM_CTL_CQ2_BASEADDR;           //     
    MUINT32        CAM_CTL_CQ3_BASEADDR;           //     
    MUINT32       CAM_CTL_CQ0B_BASEADDR;           //     
    MUINT32       CAM_CTL_CQ0C_BASEADDR;           //     
    MUINT32         CAM_CTL_MUX_SEL_SET;           //     
    MUINT32         CAM_CTL_MUX_SEL_CLR;           //     
    MUINT32        CAM_CTL_MUX_SEL2_SET;           //     
    MUINT32        CAM_CTL_MUX_SEL2_CLR;           //     
    MUINT32    CAM_CTL_SRAM_MUX_CFG_SET;           //     
    MUINT32    CAM_CTL_SRAM_MUX_CFG_CLR;           //     
    MUINT32          CAM_CTL_PIX_ID_SET;           //     
    MUINT32          CAM_CTL_PIX_ID_CLR;           //     
    MUINT32          CAM_CTL_SPARE0_SET;           //     
    MUINT32          CAM_CTL_SPARE0_CLR;           //     
    MUINT32    CAM_CTL_CUR_CQ0_BASEADDR;           //     
    MUINT32   CAM_CTL_CUR_CQ0B_BASEADDR;           //     
    MUINT32   CAM_CTL_CUR_CQ0C_BASEADDR;           //     
    MUINT32            CAM_CTL_IMGO_FBC;           //     
    MUINT32           CAM_CTL_IMG2O_FBC;           //     
    MUINT32             CAM_CTL_FBC_INT;           //     
    MUINT32                 rsv_4100[4];           //           
    MUINT32              CAM_CTL_CROP_X;           //     
    MUINT32              CAM_CTL_CROP_Y;           //     
    MUINT32                 rsv_4118[8];           //           
    MUINT32          CAM_CTL_IMG2O_SIZE;           //     
    MUINT32           CAM_CTL_IMGI_SIZE;           //     
    MUINT32                    rsv_4140;           //     
    MUINT32           CAM_CTL_VIDO_SIZE;           //     
    MUINT32          CAM_CTL_DISPO_SIZE;           //     
    MUINT32           CAM_CTL_IMGO_SIZE;           //     
    MUINT32              CAM_CTL_CLK_EN;           //     
    MUINT32                 rsv_4154[3];           //           
    MUINT32             CAM_CTL_DBG_SET;           //     
    MUINT32            CAM_CTL_DBG_PORT;           //     
    MUINT32          CAM_CTL_IMGI_CHECK;           //     
    MUINT32          CAM_CTL_IMGO_CHECK;           //     
    MUINT32                 rsv_4170[4];           //           
    MUINT32           CAM_CTL_DATE_CODE;           //     
    MUINT32           CAM_CTL_PROJ_CODE;           //     
    MUINT32                 rsv_4188[2];           //           
    MUINT32         CAM_CTL_RAW_DCM_DIS;           //     
    MUINT32         CAM_CTL_RGB_DCM_DIS;           //     
    MUINT32         CAM_CTL_YUV_DCM_DIS;           //     
    MUINT32         CAM_CTL_CDP_DCM_DIS;           //     
    MUINT32      CAM_CTL_RAW_DCM_STATUS;           //     
    MUINT32      CAM_CTL_RGB_DCM_STATUS;           //     
    MUINT32      CAM_CTL_YUV_DCM_STATUS;           //     
    MUINT32      CAM_CTL_CDP_DCM_STATUS;           //     
    MUINT32         CAM_CTL_DMA_DCM_DIS;           //     
    MUINT32      CAM_CTL_DMA_DCM_STATUS;           //     
    MUINT32                rsv_41B8[18];           //           
    MUINT32        CAM_DMA_SOFT_RSTSTAT;           //     
    MUINT32          CAM_TDRI_BASE_ADDR;           //     
    MUINT32          CAM_TDRI_OFST_ADDR;           //     
    MUINT32              CAM_TDRI_XSIZE;           //     
    MUINT32          CAM_CQ0I_BASE_ADDR;           //     
    MUINT32              CAM_CQ0I_XSIZE;           //     
    MUINT32                 rsv_4218[5];           //           
    MUINT32          CAM_IMGI_SLOW_DOWN;           //     
    MUINT32          CAM_IMGI_BASE_ADDR;           //     
    MUINT32          CAM_IMGI_OFST_ADDR;           //     
    MUINT32              CAM_IMGI_XSIZE;           //     
    MUINT32              CAM_IMGI_YSIZE;           //     
    MUINT32             CAM_IMGI_STRIDE;           //     
    MUINT32                    rsv_4244;           //     
    MUINT32                CAM_IMGI_CON;           //     
    MUINT32               CAM_IMGI_CON2;           //     
    MUINT32                 rsv_4250[7];           //           
    MUINT32          CAM_LSCI_BASE_ADDR;           //     
    MUINT32          CAM_LSCI_OFST_ADDR;           //     
    MUINT32              CAM_LSCI_XSIZE;           //     
    MUINT32              CAM_LSCI_YSIZE;           //     
    MUINT32             CAM_LSCI_STRIDE;           //     
    MUINT32                CAM_LSCI_CON;           //     
    MUINT32               CAM_LSCI_CON2;           //     
    MUINT32                rsv_4288[30];           //           
    MUINT32          CAM_IMGO_BASE_ADDR;           //     
    MUINT32          CAM_IMGO_OFST_ADDR;           //     
    MUINT32              CAM_IMGO_XSIZE;           //     
    MUINT32              CAM_IMGO_YSIZE;           //     
    MUINT32             CAM_IMGO_STRIDE;           //     
    MUINT32                CAM_IMGO_CON;           //     
    MUINT32               CAM_IMGO_CON2;           //     
    MUINT32               CAM_IMGO_CROP;           //     
    MUINT32         CAM_IMG2O_BASE_ADDR;           //     
    MUINT32         CAM_IMG2O_OFST_ADDR;           //     
    MUINT32             CAM_IMG2O_XSIZE;           //     
    MUINT32             CAM_IMG2O_YSIZE;           //     
    MUINT32            CAM_IMG2O_STRIDE;           //     
    MUINT32               CAM_IMG2O_CON;           //     
    MUINT32              CAM_IMG2O_CON2;           //     
    MUINT32              CAM_IMG2O_CROP;           //     
    MUINT32                 rsv_4340[7];           //           
    MUINT32          CAM_EISO_BASE_ADDR;           //     
    MUINT32              CAM_EISO_XSIZE;           //     
    MUINT32           CAM_AFO_BASE_ADDR;           //     
    MUINT32               CAM_AFO_XSIZE;           //     
    MUINT32         CAM_ESFKO_BASE_ADDR;           //     
    MUINT32             CAM_ESFKO_XSIZE;           //     
    MUINT32         CAM_ESFKO_OFST_ADDR;           //     
    MUINT32             CAM_ESFKO_YSIZE;           //     
    MUINT32            CAM_ESFKO_STRIDE;           //     
    MUINT32               CAM_ESFKO_CON;           //     
    MUINT32              CAM_ESFKO_CON2;           //     
    MUINT32           CAM_AAO_BASE_ADDR;           //     
    MUINT32           CAM_AAO_OFST_ADDR;           //     
    MUINT32               CAM_AAO_XSIZE;           //     
    MUINT32               CAM_AAO_YSIZE;           //     
    MUINT32              CAM_AAO_STRIDE;           //     
    MUINT32                 CAM_AAO_CON;           //     
    MUINT32                CAM_AAO_CON2;           //     
    MUINT32            CAM_DMA_ERR_CTRL;           //     
    MUINT32           CAM_IMGI_ERR_STAT;           //     
    MUINT32                    rsv_43AC;           //     
    MUINT32           CAM_LSCI_ERR_STAT;           //     
    MUINT32                 rsv_43B4[4];           //           
    MUINT32           CAM_IMGO_ERR_STAT;           //     
    MUINT32          CAM_IMG2O_ERR_STAT;           //     
    MUINT32                    rsv_43CC;           //     
    MUINT32          CAM_ESFKO_ERR_STAT;           //     
    MUINT32            CAM_AAO_ERR_STAT;           //     
    MUINT32          CAM_DMA_DEBUG_ADDR;           //     
    MUINT32                CAM_DMA_RSV1;           //     
    MUINT32                CAM_DMA_RSV2;           //     
    MUINT32                CAM_DMA_RSV3;           //     
    MUINT32                CAM_DMA_RSV4;           //     
    MUINT32                CAM_DMA_RSV5;           //     
    MUINT32                CAM_DMA_RSV6;           //     
    MUINT32                 rsv_43F4[7];           //           
    MUINT32             CAM_TG_SEN_MODE;           //                                   
    MUINT32               CAM_TG_VF_CON;           //     
    MUINT32         CAM_TG_SEN_GRAB_PXL;           //     
    MUINT32         CAM_TG_SEN_GRAB_LIN;           //     
    MUINT32             CAM_TG_PATH_CFG;           //     
    MUINT32            CAM_TG_MEMIN_CTL;           //     
    MUINT32                 CAM_TG_INT1;           //     
    MUINT32                 CAM_TG_INT2;           //     
    MUINT32              CAM_TG_SOF_CNT;           //     
    MUINT32              CAM_TG_SOT_CNT;           //     
    MUINT32              CAM_TG_EOT_CNT;           //     
    MUINT32              CAM_TG_ERR_CTL;           //     
    MUINT32               CAM_TG_DAT_NO;           //     
    MUINT32           CAM_TG_FRM_CNT_ST;           //     
    MUINT32           CAM_TG_FRMSIZE_ST;           //     
    UINT32             CAM_TG_INTER_ST;           //     
    UINT32                 rsv_4450[4];           //           
    UINT32           CAM_TG_FLASHA_CTL;           //     
    UINT32      CAM_TG_FLASHA_LINE_CNT;           //     
    UINT32           CAM_TG_FLASHA_POS;           //     
    UINT32           CAM_TG_FLASHB_CTL;           //     
    UINT32      CAM_TG_FLASHB_LINE_CNT;           //     
    UINT32           CAM_TG_FLASHB_POS;           //     
    UINT32          CAM_TG_FLASHB_POS1;           //     
    UINT32           CAM_TG_GSCTRL_CTL;           //     
    UINT32          CAM_TG_GSCTRL_TIME;           //     
    UINT32             CAM_TG_MS_PHASE;           //     
    UINT32           CAM_TG_MS_CL_TIME;           //     
    UINT32           CAM_TG_MS_OP_TIME;           //     
    UINT32         CAM_TG_MS_CLPH_TIME;           //     
    UINT32         CAM_TG_MS_OPPH_TIME;           //     
    UINT32                rsv_4498[22];           //           
    UINT32                CAM_BIN_SIZE;           //                                    
    UINT32                CAM_BIN_MODE;           //     
    UINT32                 rsv_44F8[2];           //           
    ...
    UINT32           CAM_LSC_TILE_OFST;           //     
    UINT32           CAM_LSC_TILE_SIZE;           //     
    ...
    UINT32           CAM_AWB_WIN_PITCH;           //     
    UINT32             CAM_AWB_WIN_NUM;           //     
    UINT32       CAM_AWB_RAWPREGAIN1_0;           //     
    UINT32       CAM_AWB_RAWPREGAIN1_1;           //     
    UINT32         CAM_AWB_RAWLIMIT1_0;           //     
    UINT32         CAM_AWB_RAWLIMIT1_1;           //     
    ...
    UINT32        CAM_AE_RAWPREGAIN2_0;           //     
    UINT32        CAM_AE_RAWPREGAIN2_1;           //     
    UINT32          CAM_AE_RAWLIMIT2_0;           //     
    UINT32          CAM_AE_RAWLIMIT2_1;           //     
    UINT32         CAM_AE_MATRIX_COEF0;           //     
    UINT32         CAM_AE_MATRIX_COEF1;           //     
    UINT32         CAM_AE_MATRIX_COEF2;           //     
    UINT32         CAM_AE_MATRIX_COEF3;           //     
    UINT32         CAM_AE_MATRIX_COEF4;           //     
    ...
    UINT32                 rsv_46A8[2];           //           
    UINT32                  CAM_AF_CON;           //     
    UINT32               CAM_AF_WINX01;           //     
    UINT32               CAM_AF_WINX23;           //     
    UINT32               CAM_AF_WINX45;           //     
    UINT32               CAM_AF_WINY01;           //     
    UINT32               CAM_AF_WINY23;           //     
    UINT32               CAM_AF_WINY45;           //     
    UINT32                 CAM_AF_SIZE;           //     
    UINT32                    rsv_46D0;           //     
    UINT32            CAM_AF_FILT1_P14;           //     
    UINT32            CAM_AF_FILT1_P58;           //     
    UINT32           CAM_AF_FILT1_P912;           //     
    UINT32                   CAM_AF_TH;           //     
    UINT32                CAM_AF_WIN_E;           //     
    UINT32               CAM_AF_SIZE_E;           //     
    UINT32                 CAM_AF_TH_E;           //     
    UINT32              CAM_AF_IN_SIZE;           //     
    UINT32            CAM_AF_VFILT_X01;           //     
    UINT32            CAM_AF_VFILT_X23;           //     
    UINT32               CAM_AF_STAT_L;           //     
    UINT32               CAM_AF_STAT_H;           //     
    UINT32              CAM_AF_STAT_EL;           //     
    UINT32              CAM_AF_STAT_EH;           //     
    UINT32                rsv_470C[25];           //           
    UINT32                 CAM_FLK_CON;           //     
    UINT32               CAM_FLK_SOFST;           //     
    UINT32               CAM_FLK_WSIZE;           //     
    UINT32                CAM_FLK_WNUM;           //     
    UINT32                rsv_4780[32];           //           
    UINT32                 CAM_BPC_CON;           //     
    UINT32               CAM_BPC_CD1_1;           //     
    UINT32               CAM_BPC_CD1_2;           //     
    UINT32               CAM_BPC_CD1_3;           //     
    UINT32               CAM_BPC_CD1_4;           //     
    UINT32               CAM_BPC_CD1_5;           //     
    UINT32               CAM_BPC_CD1_6;           //     
    UINT32               CAM_BPC_CD2_1;           //     
    UINT32               CAM_BPC_CD2_2;           //     
    UINT32               CAM_BPC_CD2_3;           //     
    UINT32                 CAM_BPC_CD0;           //     
    UINT32                    rsv_482C;           //     
    UINT32                 CAM_BPC_COR;           //     
    UINT32                 rsv_4834[3];           //           
    ...
    UINT32                CAM_BNR_RSV2;           //     
    UINT32                rsv_4850[12];           //           
    UINT32              CAM_PGN_SATU01;           //     
    UINT32              CAM_PGN_SATU23;           //     
    UINT32              CAM_PGN_GAIN01;           //     
    UINT32              CAM_PGN_GAIN23;           //     
    UINT32              CAM_PGN_OFFS01;           //     
    UINT32              CAM_PGN_OFFS23;           //     
    UINT32                 rsv_4898[2];           //           
    UINT32              CAM_CFA_BYPASS;           //     
    UINT32                CAM_CFA_ED_F;           //     
    UINT32              CAM_CFA_ED_NYQ;           //     
    UINT32             CAM_CFA_ED_STEP;           //     
    UINT32              CAM_CFA_RGB_HF;           //     
    UINT32                  CAM_CFA_BW;           //     
    UINT32              CAM_CFA_F1_ACT;           //     
    UINT32              CAM_CFA_F2_ACT;           //     
    UINT32              CAM_CFA_F3_ACT;           //     
    UINT32              CAM_CFA_F4_ACT;           //     
    UINT32                CAM_CFA_F1_L;           //     
    UINT32                CAM_CFA_F2_L;           //     
    UINT32                CAM_CFA_F3_L;           //     
    UINT32                CAM_CFA_F4_L;           //     
    UINT32               CAM_CFA_HF_RB;           //     
    UINT32             CAM_CFA_HF_GAIN;           //     
    UINT32             CAM_CFA_HF_COMP;           //     
    UINT32        CAM_CFA_HF_CORING_TH;           //     
    UINT32             CAM_CFA_ACT_LUT;           //     
    UINT32                    rsv_48EC;           //     
    UINT32               CAM_CFA_SPARE;           //     
    UINT32                  CAM_CFA_BB;           //     
    UINT32                 rsv_48F8[6];           //           
    UINT32                 CAM_CCL_GTC;           //     
    UINT32                 CAM_CCL_ADC;           //     
    UINT32                 CAM_CCL_BAC;           //     
    UINT32                    rsv_491C;           //     
    UINT32              CAM_G2G_CONV0A;           //     
    UINT32              CAM_G2G_CONV0B;           //     
    UINT32              CAM_G2G_CONV1A;           //     
    UINT32              CAM_G2G_CONV1B;           //     
    UINT32              CAM_G2G_CONV2A;           //     
    UINT32              CAM_G2G_CONV2B;           //     
    UINT32                 CAM_G2G_ACC;           //     
    UINT32                 rsv_493C[3];           //           
    UINT32                CAM_UNP_OFST;           //     
    UINT32                rsv_494C[45];           //           
    ...
    UINT32           CAM_SEEE_HP_CTRL1;           //     
    UINT32           CAM_SEEE_HP_CTRL2;           //     
    UINT32           CAM_SEEE_ED_CTRL1;           //     
    UINT32           CAM_SEEE_ED_CTRL2;           //     
    UINT32           CAM_SEEE_ED_CTRL3;           //     
    UINT32           CAM_SEEE_ED_CTRL4;           //     
    UINT32           CAM_SEEE_ED_CTRL5;           //     
    UINT32           CAM_SEEE_ED_CTRL6;           //     
    UINT32           CAM_SEEE_ED_CTRL7;           //     
    UINT32          CAM_SEEE_EDGE_CTRL;           //     
    UINT32             CAM_SEEE_Y_CTRL;           //     
    UINT32         CAM_SEEE_EDGE_CTRL1;           //     
    UINT32         CAM_SEEE_EDGE_CTRL2;           //     
    UINT32         CAM_SEEE_EDGE_CTRL3;           //     
    UINT32       CAM_SEEE_SPECIAL_CTRL;           //     
    UINT32         CAM_SEEE_CORE_CTRL1;           //     
    UINT32         CAM_SEEE_CORE_CTRL2;           //     
    UINT32           CAM_SEEE_EE_LINK1;           //     
    UINT32           CAM_SEEE_EE_LINK2;           //     
    UINT32           CAM_SEEE_EE_LINK3;           //     
    UINT32           CAM_SEEE_EE_LINK4;           //     
    UINT32           CAM_SEEE_EE_LINK5;           //     
    UINT32            CAM_CDRZ_CONTROL;           //                                      
    UINT32        CAM_CDRZ_INPUT_IMAGE;           //     
    UINT32       CAM_CDRZ_OUTPUT_IMAGE;           //     
    UINT32 CAM_CDRZ_HORIZONTAL_COEFF_STEP;        //     
    UINT32 CAM_CDRZ_VERTICAL_COEFF_STEP;              //     
    UINT32 CAM_CDRZ_LUMA_HORIZONTAL_INTEGER_OFFSET;   //     
    UINT32 CAM_CDRZ_LUMA_HORIZONTAL_SUBPIXEL_OFFSET;  //     
    UINT32 CAM_CDRZ_LUMA_VERTICAL_INTEGER_OFFSET;     //     
    UINT32 CAM_CDRZ_LUMA_VERTICAL_SUBPIXEL_OFFSET;    //     
    UINT32 CAM_CDRZ_CHROMA_HORIZONTAL_INTEGER_OFFSET; //     
    UINT32 CAM_CDRZ_CHROMA_HORIZONTAL_SUBPIXEL_OFFSET;//     
    UINT32 CAM_CDRZ_CHROMA_VERTICAL_INTEGER_OFFSET;   //     
    UINT32 CAM_CDRZ_CHROMA_VERTICAL_SUBPIXEL_OFFSET;  //     
    UINT32           CAM_CDRZ_DERING_1;           //     
    UINT32           CAM_CDRZ_DERING_2;           //     
    UINT32              rsv_4B3C[161];            //           
    ...
    UINT32            CAM_SL2_HRZ_COMP;           //     
    UINT32                CAM_SL2_XOFF;           //     
    UINT32                CAM_SL2_YOFF;           //     
    UINT32                rsv_4F5C[41];           //           
    UINT32         CAM_GGM_RB_GMT[144];           //           
    UINT32                rsv_5240[48];           //           
    UINT32          CAM_GGM_G_GMT[144];           //           
    UINT32                rsv_5540[48];           //           
    UINT32                CAM_GGM_CTRL;           //     
    UINT32               rsv_5604[127];           //           
    UINT32            CAM_PCA_TBL[360];           //           
    UINT32                rsv_5DA0[24];           //           
    UINT32                CAM_PCA_CON1;           //     
    UINT32                CAM_PCA_CON2;           //     
}_isp_backup_reg_t;
...
//                                                                           
    ...
    UINT32                          rsv_8004[3];              //           
    UINT32                          SENINF1_CTRL;             //                                    
    UINT32                          SENINF1_INTEN;            //     
    UINT32                          SENINF1_INTSTA;           //     
    UINT32                          SENINF1_SIZE;             //     
    UINT32                          SENINF1_DEBUG_1;          //     
    UINT32                          SENINF1_DEBUG_2;          //     
    UINT32                          SENINF1_DEBUG_3;          //     
    UINT32                          SENINF1_DEBUG_4;          //     
    UINT32                          SENINF1_DEBUG_5;          //     
    UINT32                          SENINF1_DEBUG_6;          //     
    UINT32                          SENINF1_DEBUG_7;          //     
    UINT32                          SENINF1_SPARE;            //     
    UINT32                          SENINF1_DATA;             //     
    UINT32                          rsv_8044[47];             //           
    ...
    UINT32                          CCIR656_CTL;              //                                            
    UINT32                          CCIR656_H;                //     
    UINT32                          CCIR656_PTGEN_H_1;        //     
    UINT32                          CCIR656_PTGEN_H_2;        //     
    UINT32                          CCIR656_PTGEN_V_1;        //     
    UINT32                          CCIR656_PTGEN_V_2;        //     
    UINT32                          CCIR656_PTGEN_CTL1;       //     
    UINT32                          CCIR656_PTGEN_CTL2;       //     
    UINT32                          CCIR656_PTGEN_CTL3;       //     
    UINT32                          CCIR656_STATUS;           //     
    UINT32                          rsv_8428[118];            //           
    UINT32                          SENINF1_NCSI2_CTL;        //     
    UINT32                          SENINF1_NCSI2_LNRC_TIMING; //     
    UINT32                          SENINF1_NCSI2_LNRD_TIMING; //     
    UINT32                          SENINF1_NCSI2_DPCM;       //     
    UINT32                          SENINF1_NCSI2_VC;         //     
...
static MINT32 ISP_DumpReg(MVOID)
{
    ...
    //   
    for( i = 0x248; i <= 0x24C; i += 4)//    
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
    for( i = 0x280; i <= 0x284; i += 4)//    
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
    for( i = 0x29C; i <= 0x2A0; i += 4)//    
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
    for( i = 0x2D8; i <= 0x2DC; i += 4)//    
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
    for( i = 0x2F8; i <= 0x2FC; i += 4)//     
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
    ...
    for( i = 0x334; i <= 0x338; i += 4)//     
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
    for( i = 0x380; i <= 0x384; i += 4)//     
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
    for( i = 0x39C; i <= 0x3A0; i += 4)//     
    {
        LOG_DBG("0x%08X %08X ", ISP_ADDR + i, ISP_RD32((void *)(ISP_ADDR + i)));
    }
 ...
 */
    ...
    ISP_WR32((void *)ISP_REG_ADDR_SW_CTL, ISP_REG_SW_CTL_SW_RST_TRIG|ISP_REG_SW_CTL_HW_RST); //   
    ISP_WR32((void *)ISP_REG_ADDR_SW_CTL, ISP_REG_SW_CTL_HW_RST); //   
...
static MINT32 ISP_SOF_Buf_Get(unsigned long long sec,unsigned long usec)
{
    ...
    if(0 == g_pstRTBuf->dropCnt) 
    {
        ...
        //                        
        curr_imgo = imgo_fbc.Bits.WCNT - 1; //           
        //                                                   
...
static __tcmfunc irqreturn_t ISP_Irq(MINT32  Irq, MVOID *DeviceId)
{
    ...
    //                                                                              
    if(IrqStatus[ISP_IRQ_TYPE_INT] & (ISP_IRQ_INT_STATUS_EXPDON1_ST))//                                
    {
