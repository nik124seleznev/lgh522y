...
//                                                                                     
#define AGC_FIXED_GAIN_AUDIO        0x12 //     
#define AGC_FIXED_GAIN_VOICE        0x12 //     
//                                                                                                         
#define AGC_FIXED_GAIN_COMBO_RING   0x1C //     
...
static int tpa2028d_poweron(void)
{
	...
	fail |= I2CWrite(IC_CONTROL, 0xE3); /*       */
	fail |= I2CWrite(AGC_ATTACK_CONTROL, 0x05); /*       */
	fail |= I2CWrite(AGC_RELEASE_CONTROL, 0x0B); /*       */
	fail |= I2CWrite(AGC_HOLD_TIME_CONTROL, 0x00); /*       */
/*                                               */
	fail |= I2CWrite(AGC_FIXED_GAIN_CONTROL, register_setting_mode ? register_setting_mode:agc_fixed_gain); /*       */
/*                                               */
	fail |= I2CWrite(AGC1_CONTROL, 0x3A|agc_output_limiter_disable); /*       */
	fail |= I2CWrite(AGC2_CONTROL, 0xC0|agc_compression_rate); /*       */
	fail |= I2CWrite(IC_CONTROL, 0xC3); /*       */
