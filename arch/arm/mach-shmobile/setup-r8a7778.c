...
static struct resource irqpin_resources[] = {
	DEFINE_RES_MEM(0xfe78001c, 4), /*      */
	DEFINE_RES_MEM(0xfe780010, 4), /*        */
	DEFINE_RES_MEM(0xfe780024, 4), /*        */
	DEFINE_RES_MEM(0xfe780044, 4), /*         */
	DEFINE_RES_MEM(0xfe780064, 4), /*            */
	DEFINE_RES_IRQ(gic_iid(0x3b)), /*      */
	DEFINE_RES_IRQ(gic_iid(0x3c)), /*      */
	DEFINE_RES_IRQ(gic_iid(0x3d)), /*      */
	DEFINE_RES_IRQ(gic_iid(0x3e)), /*      */
};
