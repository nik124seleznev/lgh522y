...
static struct gpio_keys_button gpio_buttons[] = {
	GPIO_KEY(KEY_VOLUMEUP, 56, "+"), /*                 */
	GPIO_KEY(KEY_VOLUMEDOWN, 54, "-"), /*                  */
	GPIO_KEY(KEY_MENU, 27, "Menu"), /*                  */
	GPIO_KEY(KEY_HOMEPAGE, 26, "Home"), /*                  */
	GPIO_KEY(KEY_BACK, 11, "Back"), /*                 */
	GPIO_KEY(KEY_PHONE, 238, "Tel"), /*                 */
	GPIO_KEY(KEY_POWER, 239, "C1"), /*                 */
	GPIO_KEY(KEY_MAIL, 224, "Mail"), /*                 */
	/*                                              */
	GPIO_KEY(KEY_CAMERA, 164, "C2"), /*                       */
	/*                                                  */
};
