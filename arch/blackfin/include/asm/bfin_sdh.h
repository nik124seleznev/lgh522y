...
#define CMD_E              (1 << 10)   /*                */
#ifdef RSI_BLKSZ
#define CMD_CRC_CHECK_D    (1 << 11)   /*                       */
#define CMD_DATA0_BUSY     (1 << 12)   /*                                       */
#endif
...
#define BUS_MODE_MASK      0x1800      /*               */
#define STD_BUS_1          0x000       /*                         */
#define WIDE_BUS_4         0x800       /*                     */
#define BYTE_BUS_8         0x1000      /*                     */
...
#define SD_CARD_BUSYMODE   (1 << 31)   /*                      */
#define SD_CARD_SLPMODE    (1 << 30)   /*                    */
#define SD_CARD_READY      (1 << 17)   /*            */

/*                     */
#define SDIO_MSK           (1 << 1)    /*                        */
#define SCD_MSK            (1 << 4)    /*                  */
#define CARD_READY_MSK     (1 << 16)   /*                 */
...
#else
#define PWR_ON             0x600       /*          */
#define SD_CMD_OD          (1 << 11)   /*                   */
#define BOOT_EN            (1 << 12)   /*             */
#define BOOT_MODE          (1 << 13)   /*                     */
#define BOOT_ACK_EN        (1 << 14)   /*                      */
#endif
