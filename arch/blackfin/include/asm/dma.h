...
struct dma_register {
	...
	unsigned long curr_x_count;	/*                              */

	unsigned long curr_y_count;	/*                              */

	unsigned long reserved3;

	unsigned long bw_limit_count;	/*                                     */
	unsigned long curr_bw_limit_count;	/*                             
                      */
	unsigned long bw_monitor_count;	/*                                     */
	unsigned long curr_bw_monitor_count;	/*                             
                      */
#else
	unsigned short cfg;	/*                            */
