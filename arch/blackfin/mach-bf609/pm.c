...
/*                                                         */
/*                                                         */
#define BITP_ROM_SYSCTRL_CGU_LOCKINGEN  28    /*                          */
#define BITP_ROM_SYSCTRL_WUA_OVERRIDE   24
#define BITP_ROM_SYSCTRL_WUA_DDRDLLEN   20    /*                                                           */
#define BITP_ROM_SYSCTRL_WUA_DDR        19    /*                                              */
#define BITP_ROM_SYSCTRL_WUA_CGU        18    /*                                            */
#define BITP_ROM_SYSCTRL_WUA_DPMWRITE   17    /*                                                                      */
#define BITP_ROM_SYSCTRL_WUA_EN         16    /*                                                        */
#define BITP_ROM_SYSCTRL_DDR_WRITE      13    /*                                                                                     */
#define BITP_ROM_SYSCTRL_DDR_READ       12    /*                                                                                     */
#define BITP_ROM_SYSCTRL_CGU_AUTODIS    11    /*                                                */
#define BITP_ROM_SYSCTRL_CGU_CLKOUTSEL  7    /*                               */
#define BITP_ROM_SYSCTRL_CGU_DIV        6    /*                         */
#define BITP_ROM_SYSCTRL_CGU_STAT       5    /*                          */
#define BITP_ROM_SYSCTRL_CGU_CTL        4    /*                         */
#define BITP_ROM_SYSCTRL_CGU_RTNSTAT    2    /*                                        */
#define BITP_ROM_SYSCTRL_WRITE          1    /*                 */
#define BITP_ROM_SYSCTRL_READ           0    /*                */

#define BITM_ROM_SYSCTRL_CGU_READ       (0x00000001)    /*                    */
#define BITM_ROM_SYSCTRL_CGU_WRITE      (0x00000002)    /*                 */
#define BITM_ROM_SYSCTRL_CGU_RTNSTAT    (0x00000004)    /*                                                                   */
#define BITM_ROM_SYSCTRL_CGU_CTL        (0x00000010)    /*                         */
#define BITM_ROM_SYSCTRL_CGU_STAT       (0x00000020)    /*                          */
#define BITM_ROM_SYSCTRL_CGU_DIV        (0x00000040)    /*                         */
#define BITM_ROM_SYSCTRL_CGU_CLKOUTSEL  (0x00000080)    /*                               */
#define BITM_ROM_SYSCTRL_CGU_AUTODIS    (0x00000800)    /*                                                */
#define BITM_ROM_SYSCTRL_DDR_READ       (0x00001000)    /*                                                                            */
#define BITM_ROM_SYSCTRL_DDR_WRITE      (0x00002000)    /*                                                                                                                               */
#define BITM_ROM_SYSCTRL_WUA_EN         (0x00010000)    /*                                        */
#define BITM_ROM_SYSCTRL_WUA_DPMWRITE   (0x00020000)    /*                                                                                                 */
#define BITM_ROM_SYSCTRL_WUA_CGU        (0x00040000)    /*                                                                                                                                            */
#define BITM_ROM_SYSCTRL_WUA_DDR        (0x00080000)    /*                                                                                                                                            */
#define BITM_ROM_SYSCTRL_WUA_DDRDLLEN   (0x00100000)    /*                                                     */
#define BITM_ROM_SYSCTRL_WUA_OVERRIDE   (0x01000000)
#define BITM_ROM_SYSCTRL_CGU_LOCKINGEN  (0x10000000)    /*                              */
