...
static const struct mips_perf_event xlp_event_map[PERF_COUNT_HW_MAX] = {
	[PERF_COUNT_HW_CPU_CYCLES] = { 0x01, CNTR_ALL },
	[PERF_COUNT_HW_INSTRUCTIONS] = { 0x18, CNTR_ALL }, /*              */
	[PERF_COUNT_HW_CACHE_REFERENCES] = { 0x04, CNTR_ALL }, /*             */
	[PERF_COUNT_HW_CACHE_MISSES] = { 0x07, CNTR_ALL }, /*             */
	[PERF_COUNT_HW_BRANCH_INSTRUCTIONS] = { 0x1b, CNTR_ALL }, /*            */
	[PERF_COUNT_HW_BRANCH_MISSES] = { 0x1c, CNTR_ALL }, /*             */
};
...
[C(L1D)] = {
	[C(OP_READ)] = {
		[C(RESULT_ACCESS)]	= { 0x31, CNTR_ALL }, /*             */
		[C(RESULT_MISS)]	= { 0x30, CNTR_ALL }, /*             */
	},
	[C(OP_WRITE)] = {
		[C(RESULT_ACCESS)]	= { 0x2f, CNTR_ALL }, /*             */
		[C(RESULT_MISS)]	= { 0x2e, CNTR_ALL }, /*             */
	},
},
[C(L1I)] = {
	[C(OP_READ)] = {
		[C(RESULT_ACCESS)]	= { 0x04, CNTR_ALL }, /*             */
		[C(RESULT_MISS)]	= { 0x07, CNTR_ALL }, /*             */
	},
},
[C(LL)] = {
	[C(OP_READ)] = {
		[C(RESULT_ACCESS)]	= { 0x35, CNTR_ALL }, /*             */
		[C(RESULT_MISS)]	= { 0x37, CNTR_ALL }, /*             */
	},
	[C(OP_WRITE)] = {
		[C(RESULT_ACCESS)]	= { 0x34, CNTR_ALL }, /*             */
		[C(RESULT_MISS)]	= { 0x36, CNTR_ALL }, /*             */
	},
},
[C(DTLB)] = {
	/*
